...
meta:
  ...
  description: Learn the core concepts and principles behind Khulnasoft's Serverless Functions.
content:
  h1: Functions - Concepts
  paragraph: Learn the core concepts and principles behind Khulnasoft's Serverless Functions.
...
A function's privacy policy defines whether a function may be executed anonymously (**public**) or only via an authentication mechanism provided by the [Khulnasoft API](https://www.khulnasoft.com/en/developers/api/serverless-functions/#authentication) (**private**).
