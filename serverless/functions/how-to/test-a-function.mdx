...
meta:
  ...
  description: Instructions for testing your Serverless Functions on Khulnasoft.
content:
  h1: How to test a function
  paragraph: Instructions for testing your Serverless Functions on Khulnasoft.
...
This page shows you how to execute Serverless Functions from the [Khulnasoft console](https://console.khulnasoft.com). The **Test** feature of a function allows you to run your code using a selection of methods to make sure it behaves as expected.
