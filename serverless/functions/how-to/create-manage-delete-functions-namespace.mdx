...
meta:
  ...
  description: Step-by-step process for creating, managing, and deleting a Serverless Functions namespace in Khulnasoft.
content:
  h1: How to create, manage, and delete a Functions Namespace
  paragraph: Step-by-step process for creating, managing, and deleting a Serverless Functions namespace in Khulnasoft.
...
This page shows you how to create, manage, and delete a Functions namespace using the Khulnasoft console.
...
The Khulnasoft console allows you to generate authentication tokens to grant users and applications access to the functions present in your namespace.
...
The Khulnasoft console allows you to define environment variables and secrets at the namespace-level to pass to the functions present in the namespace.
