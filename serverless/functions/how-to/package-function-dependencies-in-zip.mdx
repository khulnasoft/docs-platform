...
meta:
  ...
  description: Package function dependencies in a ZIP file for Khulnasoft Serverless Functions.
content:
  h1: How to package your function and dependencies to a zip file and upload it
  paragraph: Package function dependencies in a ZIP file for Khulnasoft Serverless Functions.
...
This page explains how to upload your functions and their dependencies as a zip file using the Khulnasoft console.
...
To match the Khulnasoft build pipelines requirements, functions zip files must contain the content of the root folder you want to publish.
...
<Tabs id="tab1">
  <TabsTab label="Khulnasoft Console">
    ...
    3. Go to the [Functions](https://console.khulnasoft.com/functions/namespaces) section of the Khulnasoft console and click on the functions namespace you want to configure.
  ...
  <TabsTab label="Khulnasoft API">
    ...
    5. Get the presigned URL from the API.
        ...
        "https://api.khulnasoft.com/functions/v1beta1/regions/$SCW_DEFAULT_REGION/functions/$SCW_FUNCTION_ID/upload-url?content_length=$ARCHIVE_SIZE" | jq ."url")
        ```
