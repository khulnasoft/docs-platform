...
meta:
  ...
  description: Generate an authentication token from the Khulnasoft console for Serverless Functions.
content:
  h1: How to create and manage an authentication token from the console
  paragraph: Generate an authentication token from the Khulnasoft console for Serverless Functions.
