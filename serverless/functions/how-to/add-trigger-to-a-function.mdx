...
meta:
  ...
  description: Learn how to add triggers to your Serverless Functions in Khulnasoft.
content:
  h1: How to add a trigger to a function
  paragraph: Learn how to add triggers to your Serverless Functions in Khulnasoft.
tags: functions
dates:
...
SQS queues of the [Khulnasoft Messaging and Queuing](/serverless/messaging/quickstart/) product are compatible with Serverless Functions.
...
NATS subjects of the [Khulnasoft Messaging and Queuing](/serverless/messaging/quickstart/) product are compatible with Serverless Functions.
