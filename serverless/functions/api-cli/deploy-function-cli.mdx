---
meta:
  title: How to create and deploy a function with the Khulnasoft CLI
  description: Deploy Serverless Functions using Khulnasoft's CLI with this detailed guide.
content:
  h1: How to create and deploy a function with the Khulnasoft CLI
  paragraph: Deploy Serverless Functions using Khulnasoft's CLI with this detailed guide.
