...
meta:
  ...
  description: Configure trigger inputs for Khulnasoft Serverless Functions to automate executions.
content:
  h1: Considerations to configure event retention for SQS trigger inputs
  paragraph: Configure trigger inputs for Khulnasoft Serverless Functions to automate executions.
tags: functions
dates:
