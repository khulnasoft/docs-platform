...
meta:
  ...
  description: Explore code examples for creating and deploying Serverless Functions in Khulnasoft.
content:
  h1: Code examples for Serverless Functions
  paragraph: Explore code examples for creating and deploying Serverless Functions in Khulnasoft.
...
<Message type="tip">
  You can find many more advanced examples and real-life use cases using Serverless products in our [Serverless Examples repository](https://github.com/khulnasoft/serverless-examples).
</Message>
...
You might need to get information or transmit data to an external service. The Khulnasoft Python runtime includes the `urllib` library which enables you to connect to HTTP services without adding external libraries.
...
To find advanced and real-world examples for Serverless Functions, take a look at our [dedicated repository](https://github.com/khulnasoft/serverless-examples).
...
Node has two module systems: `CommonJS` modules and `ECMAScript` (`ES`) modules. By default, Node treats your code files as CommonJS modules, however [ES modules](https://nodejs.org/api/esm.html) are also available on Khulnasoft Serverless Functions. ES modules give you a more modern way to reuse your code.
...
Check out our [dedicated examples repository](https://github.com/khulnasoft/serverless-examples) for advanced examples and real-life use cases using Serverless products.
...
You can find our Go library [here](https://github.com/khulnasoft/serverless-functions-go).
...
Check our [dedicated examples repository](https://github.com/khulnasoft/serverless-examples) for advanced examples and real-life use cases using Serverless products.
