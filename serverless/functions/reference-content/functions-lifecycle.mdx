...
meta:
  ...
  description: Understand the lifecycle of Serverless Functions on Khulnasoft, from creation to deletion.
content:
  h1: Functions lifecycle
  paragraph: Understand the lifecycle of Serverless Functions on Khulnasoft, from creation to deletion.
