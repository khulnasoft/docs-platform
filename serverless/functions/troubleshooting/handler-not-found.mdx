...
meta:
  ...
  description: Troubleshoot problems with finding the handler when using Khulnasoft Serverless Functions.
content:
  h1: Unable to find the function handler
  paragraph: Troubleshoot problems with finding the handler when using Khulnasoft Serverless Functions.
