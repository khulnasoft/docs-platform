...
meta:
  ...
  description: Learn about the current limitations of Khulnasoft Messaging and Queuing
content:
  h1: Limitations
  paragraph: Learn about the current limitations of Khulnasoft Messaging and Queuing
...
Messaging and Queuing is not currently compatible with [Khulnasoft VPC](/network/vpc/quickstart/).