...
meta:
  ...
  description: Discover which SQS AWS API actions are supported by Khulnasoft Messaging and Queuing
content:
  h1: SQS - Supported Actions
  paragraph: Discover which SQS AWS API actions are supported by Khulnasoft Messaging and Queuing
...
This page lists all actions described in the AWS SQS documentation, and states whether they are supported by Khulnasoft Messaging and Queuing.
