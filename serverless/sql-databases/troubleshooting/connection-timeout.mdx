...
meta:
  ...
  description: Learn to troubleshoot connection timeout issues in Khulnasoft serverless SQL databases.
content:
  h1: Solving Serverless SQL Databases connection timeouts
  paragraph: Learn to troubleshoot connection timeout issues in Khulnasoft serverless SQL databases.
