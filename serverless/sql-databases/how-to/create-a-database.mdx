...
meta:
  ...
  description: Learn how to create a Khulnasoft serverless SQL database from scratch.
content:
  h1: How to create a database
  paragraph: Learn how to create a Khulnasoft serverless SQL database from scratch.
...
This page shows you how to create a Serverless SQL Database using the Khulnasoft console.
