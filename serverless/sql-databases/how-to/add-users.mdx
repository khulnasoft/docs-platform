...
meta:
  ...
  description: Learn how to add users to your Khulnasoft serverless SQL database.
content:
  h1: How to add users to a Serverless SQL Database
  paragraph: Learn how to add users to your Khulnasoft serverless SQL database.
