...
meta:
  ...
  description: Guide to configure autoscaling for Khulnasoft serverless SQL databases.
content:
  h1: How to edit a Serverless SQL Database's autoscaling
  paragraph: Guide to configure autoscaling for Khulnasoft serverless SQL databases.
...
This page shows you how to edit the autoscaling of a Serverless SQL Database using the Khulnasoft console.
