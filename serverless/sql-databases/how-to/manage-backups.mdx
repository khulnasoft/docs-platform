...
meta:
  ...
  description: Instructions for managing backups in Khulnasoft serverless SQL databases.
content:
  h1: How to manage backups for Serverless SQL Databases
  paragraph: Instructions for managing backups in Khulnasoft serverless SQL databases.
