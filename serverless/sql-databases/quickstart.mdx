...
meta:
  ...
  description: Quickstart guide for setting up Khulnasoft serverless SQL databases.
content:
  h1: SQL Databases - Quickstart
  paragraph: Quickstart guide for setting up Khulnasoft serverless SQL databases.
...
Khulnasoft Serverless SQL Databases are fully managed databases that automatically scale in storage and compute according to your workloads.

This page explains how to create, access, and delete a Serverless SQL Database using the Khulnasoft console.
