...
meta:
  ...
  description: Detailed explanation of concepts and architecture behind Khulnasoft's serverless SQL databases.
content:
  h1: Serverless SQL Databases - Concepts
  paragraph: Detailed explanation of concepts and architecture behind Khulnasoft's serverless SQL databases.
...
Credentials are the login and password (also called "username" and "password" in PostgreSQL vocabulary) used by a user, or an application to connect to a database. With Khulnasoft Serverless SQL Databases, logins are [IAM principal IDs](/identity-and-access-management/iam/concepts/#principal) and passwords are [IAM secret keys](/identity-and-access-management/iam/concepts/#api-key).
