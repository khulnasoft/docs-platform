---
meta:
  title: How to create and deploy a container with the Khulnasoft API
  description: Deploy containers using the Khulnasoft API.
content:
  h1: How to create and deploy a container with the Khulnasoft API
  paragraph: Deploy containers using the Khulnasoft API.
...
The Khulnasoft API allows you to create and manage all your Khulnasoft resources programmatically. Anything you can do through the [Khulnasoft console](https://www.console.khulnasoft.com) can also be done through the API.
...
1. Run the following command in your terminal to create a containers namespace:
    ...
    "https://api.khulnasoft.com/containers/v1beta1/regions/fr-par/namespaces"
    ```
...
2. Run the following command to create a container:
    ...
    "https://api.khulnasoft.com/containers/v1beta1/regions/fr-par/containers"
    ```
...
3. Run the following command to deploy your container:
    ...
    curl -X POST \
      ...
      -H "Content-Type: application/json" \
      -d '{}' \
      "https://api.khulnasoft.com/containers/v1beta1/regions/fr-par/containers/<YOUR_CONTAINER_ID>/deploy"
    ```
