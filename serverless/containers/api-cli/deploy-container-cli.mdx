---
meta:
  title: How to create and deploy a container with the Khulnasoft CLI
  description: Deploy containers using the Khulnasoft CLI.
content:
  h1: How to create and deploy a container with the Khulnasoft CLI
  paragraph: Deploy containers using the Khulnasoft CLI.
