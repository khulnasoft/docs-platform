...
meta:
  ...
  description: Quickstart guide for Khulnasoft Serverless Containers.
content:
  h1: Containers - Quickstart
  paragraph: Quickstart guide for Khulnasoft Serverless Containers.
...
Khulnasoft Serverless Containers provides you with containerized stateless web applications deployed in the cloud. They are designed for short-lived, event-driven tasks.

Containers rely on the HTTP protocol, and must therefore include a web server to work properly. Refer to the [differences between Containers, Jobs, and Functions](/serverless/containers/reference-content/difference-jobs-functions-containers/) for more information on Khulnasoft's different Serverless products.

This page explains how to deploy a basic NGINX image in a Serverless Container using the Khulnasoft console.
...
You can deploy a container from the Khulnasoft Container Registry or any other public container registry, such as Docker Hub, AWS Container registries, GitLab container registry, etc.
...
5. Complete the following steps in the wizard:
    ...
    <Message type="note">
      Refer to [How to deploy a Container from the Khulnasoft Registry](/serverless/containers/how-to/deploy-container/) for more information on the different parameters.
    </Message>
...
Check out our [GitHub repository](https://github.com/khulnasoft/serverless-examples) for real-world examples.