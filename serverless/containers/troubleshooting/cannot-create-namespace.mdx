...
meta:
  ...
  description: Troubleshoot problems encountered while creating namespaces for Khulnasoft Serverless Containers.
content:
  h1: I am unable to create a Serverless Containers namespace
  paragraph: Troubleshoot problems encountered while creating namespaces for Khulnasoft Serverless Containers.
...
Make sure that you have not exceeded the maximum number of allowed namespaces with the [Khulnasoft console](https://console.khulnasoft.com/) or with the [API](https://www.khulnasoft.com/en/developers/api/serverless-containers/#path-namespaces-list-all-your-namespaces).