...
meta:
  ...
  description: Troubleshoot issues with secrets and environment variables while using Khulnasoft Serverless Containers.
content:
  h1: My secrets and variables are not injected properly in my container
  paragraph: Troubleshoot issues with secrets and environment variables while using Khulnasoft Serverless Containers.
