...
meta:
  ...
  description: Manage your Khulnasoft Serverless Containers effectively.
content:
  h1: How to manage a container
  paragraph: Manage your Khulnasoft Serverless Containers effectively.
...
This page shows you how to manage a container, should you need to verify or edit its deployment parameters after creation. You can deploy a container from the [Khulnasoft Container Registry](/containers/container-registry/quickstart/) or any other public container registry, such as Docker Hub, AWS Container registries, GitLab container registry, etc.
...
### Manage a deployment from the Khulnasoft Container Registry
...
4. Check or edit any of the following information as required, on the **Deployment** tab:
    ...
    - Set your **scaling** preferences, or leave them at default values. The Khulnasoft platform autoscales the number of available instances of your container to match the incoming load, depending on the settings you define here.
    ...
    - Add **secrets** for your container. Secrets are environment variables which are injected into your container, but the values are not retained or displayed by Khulnasoft after initial validation.
    - Set the desired **privacy policy** for your container. This defines whether container invocation may be done anonymously (**public**) or only via an authentication mechanism provided by the [Khulnasoft API](https://www.khulnasoft.com/en/developers/api/serverless-containers/#authentication) (**private**).
