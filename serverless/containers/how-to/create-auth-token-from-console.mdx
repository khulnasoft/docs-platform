...
meta:
  ...
  description: How to create an auth token from the Khulnasoft console.
content:
  h1: How to create and manage an authentication token from the console
  paragraph: How to create an auth token from the Khulnasoft console.
...
This page shows you how to create and manage an authentication token from the Khulnasoft console.
...
## Creating authentication tokens from the Khulnasoft console
