...
meta:
  ...
  description: Create, manage, and delete namespaces in Khulnasoft Serverless Containers.
content:
  h1: How to create, manage, and delete a Containers namespace
  paragraph: Create, manage, and delete namespaces in Khulnasoft Serverless Containers.
...
The Khulnasoft console allows you to generate authentication tokens to grant users and applications access to the containers present in your namespace.
...
The Khulnasoft console allows you to define environment variables and secrets at the namespace-level to pass to the containers present in the namespace.
