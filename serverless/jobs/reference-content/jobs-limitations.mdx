...
meta:
  ...
  description: Learn the limitations of Khulnasoft Serverless Jobs.
content:
  h1: Jobs limitations
  paragraph: Learn the limitations of Khulnasoft Serverless Jobs.
...
Khulnasoft Serverless Jobs only supports `amd64` [architecture](https://github.com/docker-library/official-images?tab=readme-ov-file#architectures-other-than-amd64) for
images.
