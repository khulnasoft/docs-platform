...
meta:
  ...
  description: Learn how to run jobs in Khulnasoft Serverless platform efficiently.
content:
  h1: How to run a Serverless Job
  paragraph: Learn how to run jobs in Khulnasoft Serverless platform efficiently.
  tags: run execute start serverless job khulnasoft contextual-options parameters
dates:
...
This page shows you how to manually run a Serverless Job from the Khulnasoft console. You can also run a Serverless Job with contextual options that only apply to one run.
