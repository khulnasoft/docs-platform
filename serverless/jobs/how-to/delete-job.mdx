...
meta:
  ...
  description: Learn to delete jobs effectively on Khulnasoft Serverless platform.
content:
  h1: How to delete a Serverless Job
  paragraph: Learn to delete jobs effectively on Khulnasoft Serverless platform.
  tags: delete serverless job khulnasoft
dates:
