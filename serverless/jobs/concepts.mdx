...
meta:
  title: Jobs - Concepts
  description: Key concepts of Khulnasoft Serverless Jobs.
content:
  h1: Jobs - Concepts
  paragraph: Key concepts of Khulnasoft Serverless Jobs.
...
When running a job, the selected image will be pulled to execute your workload. Images can come from public external registries or from the [Khulnasoft Container Registry](/containers/container-registry/concepts/#container-registry).
