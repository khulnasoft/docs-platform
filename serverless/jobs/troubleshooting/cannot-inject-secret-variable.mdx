...
meta:
  ...
  description: Troubleshoot issues with secrets and environment variables while using Khulnasoft Serverless Jobs.
content:
  h1: My secrets and variables are not injected properly in my job
  paragraph: Troubleshoot issues with secrets and environment variables while using Khulnasoft Serverless Jobs.
