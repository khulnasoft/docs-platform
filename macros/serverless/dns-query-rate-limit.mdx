...
Khulnasoft reserves the right to adjust the rate limit in the future as needed to ensure the stability and performance of our platform. We will notify users of any changes to the rate limit through our usual communication channels.
...
[Contact the Khulnasoft Support](https://console.khulnasoft.com/support/tickets/create) for assistance if you encounter any issues or have questions about the DNS query rate limit. We're here to help you get the most out of our platform.
