---
macro: khulnasoft-configuration-file
---

## Configuration file Overview

The Khulnasoft configuration file is a `config.yaml` file shared between the majority of the [Khulnasoft developer tools](https://www.khulnasoft.com/en/developers/#official-repos). It allows you to authenticate, and to determine the default values to use when creating resources with the developer tools.

The configuration file contains the following elements:

**access_key**
: Your [Khulnasoft API access key](/identity-and-access-management/iam/how-to/create-api-keys/)

**secret_key**
: Your [Khulnasoft API secret key](/identity-and-access-management/iam/how-to/create-api-keys/)

**default_organization_id**
: The ID of the Khulnasoft Organization to use by default

**default_project_id**
: The ID of the Khulnasoft Project to use by default
...
**api_url**
: The API URL to use (`https://api.khulnasoft.com` by default)
...
You can set up the Khulnasoft configuration file using several methods. However, we recommend that you use [The Khulnasoft CLI](/developer-tools/khulnasoft-cli/quickstart/). The `scw init` command allows you to initialize your configuration in just a few minutes.

To initialize the configuration without the Khulnasoft CLI, you can simply create a `config.yaml` file in the appropriate folder:
...
api_url: https://api.khulnasoft.com
```
