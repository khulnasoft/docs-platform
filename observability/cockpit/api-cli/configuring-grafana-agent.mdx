...
This page explains how to configure the Grafana agent and the Zipkin collector to push your metrics, logs, and traces. You can use it to **push your data from Khulnasoft resources or external resources**.
...
5. Enter `1860`, which is the ID of the [Node Exporter Full](https://grafana.com/grafana/dashboards/1860-node-exporter-full/) dashboard, in the **Import via grafana.com** field and click **Load**.
    <Lightbox src="khulnasoft_obs_import_dashboard.webp" alt="" />
...
1. [Log into Grafana](/observability/cockpit/how-to/access-grafana-and-managed-dashboards/) using your [Grafana credentials](/observability/cockpit/how-to/retrieve-grafana-credentials/).
2. Click **Explore**.
    <Lightbox src="khulnasoft_obs_logs_compass.webp" alt="" />
3. Select the **Khulnasoft logs** data source in the drop-down.
