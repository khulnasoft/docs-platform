...
You can use the CLI to specify your cluster type of choice when [creating a new cluster](https://github.com/khulnasoft/khulnasoft-cli/blob/master/docs/commands/k8s.md#create-a-new-cluster), as well as changing the cluster type once the cluster has already been created.

In this tutorial, we show you how to change your cluster type using the Khulnasoft CLI (v2).
...
- Downloaded and installed the most recent version of the [Khulnasoft CLI](https://github.com/khulnasoft/khulnasoft-cli#khulnasoft-cli-v2)
