...
content:
  h1: Introduction to Kubernetes - Understanding K8s concepts
  paragraph: Explore the basics of Kubernetes (K8s), an open-source platform for managing containerized workloads and services.
...
<Lightbox src="khulnasoft-deployment_evo.webp" alt="" />
...
* [Discover how to deploy your first Kapsule on Khulnasoft](/containers/kubernetes/how-to/create-cluster/)
* [Deploy your first Kapsule on Khulnasoft](https://console.khulnasoft.com/kapsule/)
