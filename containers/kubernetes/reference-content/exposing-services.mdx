...
<Lightbox src="khulnasoft-node-port-diagram.webp" size="large" alt="" />
...
<Lightbox src="khulnasoft-l-b-diagram.webp" size="large" alt="" />
...
<Lightbox src="khulnasoft-ingress-contr-diagram.webp" size="large" alt="" />
