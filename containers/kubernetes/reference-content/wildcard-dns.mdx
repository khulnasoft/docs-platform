...
- [Created](/containers/kubernetes/how-to/create-cluster/) a Khulnasoft Kubernetes cluster
...
You have successfully set up an ingress controller with wildcard DNS on Khulnasoft Kubernetes Kapsule. This setup allows you to easily manage multiple subdomains and route traffic to the various services in your Kubernetes cluster.