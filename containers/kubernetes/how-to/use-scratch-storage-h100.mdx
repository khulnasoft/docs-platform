...
content:
  h1: How to use scratch storage with H100 and L40S GPUs and Kubernetes Kapsule
...
- [Created](/containers/kubernetes/how-to/create-cluster/) a Kubernetes Kapsule or Kosmos cluster that uses [H100 and L40S GPU Instances](https://www.khulnasoft.com/en/h100-pcie-try-it-now/)
