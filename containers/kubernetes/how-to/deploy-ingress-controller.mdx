---
meta:
  title: How to deploy an ingress controller on Khulnasoft
  description: This page explains how to deploy an ingress controller on a Khulnasoft Kubernetes Kapsule or Kosmos cluster.
content:
  h1: How to deploy an ingress controller on Khulnasoft
  paragraph: This page explains how to deploy an ingress controller on a Khulnasoft Kubernetes Kapsule or Kosmos cluster.
...
1. Navigate to the **Containers** section within the [Khulnasoft console](https://console.khulnasoft.com) sidebar and select **Kubernetes**. The Kubernetes Kapsule dashboard displays.
