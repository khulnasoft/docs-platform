...
- A cluster that uses a [dedicated control plane](https://www.khulnasoft.com/en/kubernetes-dedicated-control-plane/)

## How to enable audit logging for your clusters

Audit logging is enabled automatically for all new clusters using a [dedicated control plane](https://www.khulnasoft.com/en/kubernetes-dedicated-control-plane/).
...
You can enable audit logging for all clusters using a [dedicated control plane](https://www.khulnasoft.com/en/kubernetes-dedicated-control-plane/).
Audit logging is enabled by default for all new clusters. If your cluster predates the introduction of this feature, follow the steps below to activate audit logs via your Khulnasoft console.
...
You can access your clusters audit logs in [Cockpit](/observability/cockpit/), Khulnasoft's monitoring solution.
...
Audit logging is only available for clusters using a [dedicated control plane](https://www.khulnasoft.com/en/kubernetes-dedicated-control-plane/).
...
You can examine the [Kubernetes audit policy](https://github.com/khulnasoft/kubernetes-gists/blob/main/audit/policy.yaml) file, which contains a list of rules, giving you complete visibility into our API server configuration and the chosen request treatments or exclusions.
