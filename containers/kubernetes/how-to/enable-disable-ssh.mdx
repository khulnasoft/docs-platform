...
1. Click **Instances** in the side menu, then click **Security groups** to view the [security group](https://console.khulnasoft.com/instance/security-groups) section in your Khulnasoft console.
