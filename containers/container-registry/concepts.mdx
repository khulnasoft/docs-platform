...
meta:
  ...
  description: Understand key concepts behind Khulnasoft's Container Registry.
content:
  h1: Container Registry - Concepts
  paragraph: Understand key concepts behind Khulnasoft's Container Registry.
...
Khulnasoft Container Registry is a fully-managed mutualized Container Registry, designed to facilitate the storage, management, and deployment of [container images](#container-image). The service simplifies the development-to-production workflow, as there is no need to operate your own Container Registry or worry about the underlying infrastructure.
...
Docker is a tool that makes it easy to manage container images. You can [use Docker from your local computer](/containers/container-registry/how-to/connect-docker-cli/) to [push and pull images to and from your Khulnasoft Container Registry](/containers/container-registry/how-to/push-images/).
...
A Registry is a service that stores container images.