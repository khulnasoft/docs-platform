...
meta:
  ...
  description: Instructions for connecting Docker CLI to Khulnasoft's Container Registry.
content:
  h1: How to connect your namespace to the Docker CLI
  paragraph: Instructions for connecting Docker CLI to Khulnasoft's Container Registry.
...
Docker is a tool that makes it easy to manage container images. You can use Docker to push and pull images to and from your Khulnasoft Container Registry. We show you how to set up Docker on your local computer to connect to your Container Registry.
