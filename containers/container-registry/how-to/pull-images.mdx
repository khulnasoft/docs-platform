...
meta:
  ...
  description: Learn how to pull container images from Khulnasoft's Container Registry.
content:
  h1: How to pull images from your namespace
  paragraph: Learn how to pull container images from Khulnasoft's Container Registry.
