...
meta:
  ...
  description: Quickstart guide to using Khulnasoft's Container Registry service.
content:
  h1: Container Registry - Quickstart
  paragraph: Quickstart guide to using Khulnasoft's Container Registry service.
...
1. Click **Container Registry** in the **Containers** section of the [Khulnasoft console](https://console.khulnasoft.com) side menu. The Container Registry namespaces dashboard displays.
