...
<Tabs id="os">
  <TabsTab label="macOS">
    If your local machine runs macOS, you can use the Khulnasoft console to connect to your Mac mini using the built-in Apple ARD client.

    1. Click **Apple silicon** in the **Bare Metal** section of the side menu. A list of your Mac minis displays.
        <Lightbox src="khulnasoft-apple-silicon-dashboard.webp" alt="Khulnasoft Apple Silicon Dashboard" />
    ...
    3. Click **Open remote desktop** in the **Access remote desktop from macOS ①** section to launch Apple's built-in screen sharing client for a seamless remote desktop experience.
        <Lightbox src="khulnasoft-apple-silicon-remote-desktop.webp" alt="Khulnasoft Apple Silicon remote desktop selector" />
    ...
    <Lightbox src="khulnasoft-m1-remote-desktop.webp" alt="Khulnasoft remote desktop" />
    ...
    3. Configure your remote desktop client for the connection. We suggest using one of these two remote desktop clients:
        - **Remmina:**
          ...
          - Enter the following parameters:
            ...
            - **Server**: The public IP address of your Mac mini, found on its **Overview** page in the Khulnasoft console.
            - **Username**:  The remote desktop password of your Mac mini, available on its **Overview** page in the Khulnasoft console.
            - **Password**: The remote desktop password of your Mac mini, displayed on its **Overview** page in the Khulnasoft console.
          ...
          - You can now log in to the graphical environment of macOS using the user and the remote desktop password displayed in your Khulnasoft console.
              <Message type="tip">
