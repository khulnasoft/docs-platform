...
meta:
  ...
  description: This page explains how to update the operating system of a Khulnasoft Mac mini.
content:
  h1: How to update the OS of a Mac mini
  paragraph: This page explains how to update the operating system of a Khulnasoft Mac mini.
...
This guide provides instructions on updating the operating system of a Khulnasoft Mac mini.
...
## Recommended method: macOS provided by Khulnasoft

The recommended method to update the macOS is to reinstall your Mac mini with an OS image provided by Khulnasoft:
1. Click **Apple silicon** in the **Bare Metal** section of the side menu. A list of your Mac minis displays.
    <Lightbox src="khulnasoft-apple-silicon-dashboard.webp" alt="" />
