...
meta:
  ...
  description: This page explains all the concepts related to Khulnasoft Elastic Metal servers
content:
  h1: Elastic Metal - Concepts
  paragraph: This page explains all the concepts related to Khulnasoft Elastic Metal servers
...
Khulnasoft Elastic Metal are dedicated physical servers you can order on-demand, like Instances. These servers can be used for large workloads, big data and applications that require increased security and dedicated resources.
...
[Private Networks allow your Elastic Metal servers to communicate with other Khulnasoft resources](/bare-metal/elastic-metal/how-to/use-private-networks/) in an isolated and secure network without requiring a connection to the public internet.
...
Remote access is available as an option on most Elastic Metal offers. Currently, remote access must be configured [via the API](https://www.khulnasoft.com/en/developers/api/elastic-metal/#path-bmc-access-start-bmc-access).
...
Tags allow you to organize your resources by sorting and filtering your cloud assets in any organizational pattern you choose. This helps you arrange, control, and monitor your cloud resources. You can assign as many tags as you want to each Khulnasoft product.