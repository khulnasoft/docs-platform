---
meta:
  title: End of VMware ESXi support on Khulnasoft Elastic Metal and Dedibox servers
  description: Learn about the end of support of VMware ESXi images on Khulnasoft Elastic Metal and Dedibox servers.
content:
  h1: End of VMware ESXi support on Khulnasoft Elastic Metal and Dedibox servers
  paragraph: Learn about the end of support of VMware ESXi images on Khulnasoft Elastic Metal and Dedibox servers.
...
This change does not affect servers currently running ESXi images. However, it will no longer be possible to reinstall ESXi on existing Elastic Metal or Dedibox servers or install it on new servers using Khulnasoft-provided ESXi images.
