---
meta:
  title: Khulnasoft Bare Metal Shared Responsibility Model
  description: Learn about the shared responsibility model for Khulnasoft Bare Metal services, outlining the roles of Khulnasoft and users in managing server security, backups, and compliance.
content:
  h1: Khulnasoft Bare Metal Shared Responsibility Model
  paragraph: Learn about the shared responsibility model for Khulnasoft Bare Metal services, outlining the roles of Khulnasoft and users in managing server security, backups, and compliance.
...
Our shared responsibility model clarifies the division of duties between Khulnasoft and our users, ensuring clarity in managing server availability, backups, configurations, and security measures. 
By understanding this shared responsibility, you can optimize the performance, reliability, and security of your Khulnasoft Bare Metal services.
...
The detailed SLAs measurements and guarantees can be found at [Service Level Agreement for Bare Metal Services](https://www.khulnasoft.com/en/bare-metal/sla/).

Once the resource is in your hands, we have no access to the machine and therefore no way to monitor its operation.
In case of any operational issues, we invite you to consult our [documentation](/bare-metal/) or [create a ticket](https://console.khulnasoft.com/support/tickets/create) with our support team. We will then do our utmost to ensure that you regain access to your resources as quickly as possible.
...
We provide a range of Linux, Windows and macOS server distributions for automatic installation from the Khulnasoft console. These distributions come with a default configuration designed for standard use cases, ensuring security, usage efficiency, and reliability. During the setup of your machine, you can modify and customize this initial configuration. However, you are responsible for any impact on your server's availability, security, or performance.

Apple Silicon servers, in particular, are enrolled with a Khulnasoft-operated mobile device management server. Removing the enrolment, or any of the associated configuration profiles, may impact Khulnasoft's ability to monitor & restart your server on your behalf, for instance, in case of power loss.
...
We regularly provide OS version updates, allowing you to upgrade your environment if desired. It is your responsibility to update your machine to the desired version and thus maintain its compatibility with all internal and external resources at Khulnasoft.

If you perform manual upgrades without reinstalling your machine with an image provided by Khulnasoft, it is your responsibility to ensure the reliability and stability of your machine's configuration.

### Usage compliance

You are responsible for the proper use of your resources. In this regard, you are responsible for maintaining the use of your server in accordance with Khulnasoft's compliance policy, as well as those of the various operating systems you use.
...
Dedibox servers provide [outsourcing services features](https://www.khulnasoft.com/en/dedibox/outsourcing/), allowing you to delegate resource management. You remain responsible for giving access and management permissions to the relevant users or outsourcing providers and reviewing these accesses frequently.
...
Our security guarantees are available at [https://www.khulnasoft.com/en/security-and-resilience/](https://www.khulnasoft.com/en/security-and-resilience/), and our certifications and commitments are available in our [Trust Center](https://security.khulnasoft.com/).
