...
meta:
  ...
  description: Learn how to attach and detach a flexible IP to and from a Khulnasoft Elastic Metal server.
content:
  h1: How to attach and detach a flexible IP to and from an Elastic Metal server
  paragraph: This guide explains how to attach and detach a flexible IP to and from a Khulnasoft Elastic Metal server.
