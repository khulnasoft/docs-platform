...
meta:
  ...
  description: Learn how to add a virtual MAC address to a flexible IP for Khulnasoft Elastic Metal servers.
content:
  h1: How to add a virtual MAC address to a flexible IP
  paragraph: This guide explains how to add a virtual MAC address to a flexible IP for Khulnasoft Elastic Metal servers.
