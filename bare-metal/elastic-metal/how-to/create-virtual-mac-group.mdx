...
meta:
  ...
  description: This page explains how to create a virtual MAC group for Khulnasoft Elastic Metal servers
content:
  h1: How to create a virtual MAC group for Elastic Metal servers
  paragraph: This page explains how to create a virtual MAC group for Khulnasoft Elastic Metal servers
...
- [Ordered more than one flexible IP](/bare-metal/elastic-metal/how-to/order-flexible-ip/)
