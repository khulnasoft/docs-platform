...
meta:
  ...
  description: Learn how to configure the reverse DNS of a flexible IP on Khulnasoft Elastic Metal servers.
content:
  h1: How to configure the reverse DNS of a flexible IP on Elastic Metal servers
  paragraph: This guide explains how to configure the reverse DNS of a flexible IP on Khulnasoft Elastic Metal servers.
