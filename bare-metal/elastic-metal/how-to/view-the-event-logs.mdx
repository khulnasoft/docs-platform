...
meta:
  ...
  description: This page explains how to view the event logs of a Khulnasoft Elastic Metal server
content:
  h1: How to view the event logs of an Elastic Metal server
  paragraph: This page explains how to view the event logs of a Khulnasoft Elastic Metal server
