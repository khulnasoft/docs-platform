...
meta:
  ...
  description: This page explains how to use your Khulnasoft EM-RV1 Elastic Metal server as a Kosmos Kubernetes node
content:
  h1: How to run Kubernetes nodes on RISC-V
  paragraph:  This page explains how to use your Khulnasoft EM-RV1 Elastic Metal server as a Kosmos Kubernetes node
...
With Khulnasoft Kosmos and our Elastic Metal RV1, you can follow this guide to launch RISC-V containers on Kubernetes effortlessly, and in just a few minutes.
