...
1. Navigate to **Elastic Metal** under the **Bare Metal** section in the [Khulnasoft console](https://console.khulnasoft.com) side menu. This action takes you to the Elastic Metal dashboard.
...
1. Access the **Elastic Metal** section within the **Bare Metal** category of the [Khulnasoft console](https://console.khulnasoft.com).
2. Click the server name or the <Icon name="more" /> beside your desired server to access its information page.
