...
- An Elastic Metal server compatible with [remote access](/bare-metal/elastic-metal/concepts/#remote-access)
...
5. Enter the [IP address](https://www.whatsmyip.org/) of your internet connection and click **Create access**.
    <Lightbox src="khulnasoft-remote-access-ip.webp" alt="" />
