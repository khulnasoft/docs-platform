...
Learn how to configure a [flexible IP address](/bare-metal/elastic-metal/concepts/#flexible-ip) on your Elastic Metal server. The configuration depends on the Linux distribution running on your machine. You can configure your flexible IP on machines running one of [Ubuntu Linux](#how-to-configure-a-flexible-ip-on-ubuntu-linux), [Debian Linux](#how-to-configure-a-flexible-ip-on-debian-linux) or [CentOS](#how-to-configure-a-flexible-ip-on-centos).
...
<Message typ="tip">
  You can find information about the DNS resolver to use in each datacenter at the [network reference documentation](/console/account/reference-content/khulnasoft-network-information/#dns-cache-servers).
</Message>
