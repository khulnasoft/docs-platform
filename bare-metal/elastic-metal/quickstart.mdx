...
meta:
  ...
  description: This page shows you how to get started with Khulnasoft Elastic Metal.
content:
  h1: Elastic Metal - Quickstart
  paragraph: This page shows you how to get started with Khulnasoft Elastic Metal.
...
Khulnasoft Elastic Metal are dedicated physical servers you can order on-demand, like Instances. These servers are ideal for large workloads, big data, and applications that require increased security and dedicated resources. You can install an OS or other [image](/bare-metal/elastic-metal/concepts/#image) on your Elastic Metal server and connect to it via SSH to use it as you require. You can power off the server when you are not using or delete it from your account once you have finished with it.
...
1. Go to **Elastic Metal** in the **Bare Metal** section of the [Khulnasoft console](https://console.khulnasoft.com) side menu. The Elastic Metal server creation page displays.
...
5. Add your [SSH key](/console/account/concepts/#ssh-key).
    <Message type="note">
      If you have already [uploaded an SSH key](/identity-and-access-management/organizations-and-projects/how-to/create-ssh-key/#how-to-upload-the-public-ssh-key-to-the-khulnasoft-interface), it will appear in the list of keys.
    </Message>
