---
meta:
  title: Create and manage Elastic Metal servers with the Khulnasoft CLI
  description: Learn to create and manage Elastic Metal servers using the Khulnasoft CLI in this comprehensive guide.
content:
  h1: Create and manage Elastic Metal servers with the Khulnasoft CLI
  paragraph: Learn to create and manage Elastic Metal servers using the Khulnasoft CLI in this comprehensive guide.
...
Khulnasoft's [Elastic Metal servers](https://www.khulnasoft.com/en/elastic-metal/) provide you with dedicated servers on-demand, with all the benefits of the cloud, including flexibility and hourly billing. These servers are great for large workloads, big data, and applications that require increased security and dedicated resources. You can create and manage your Elastic Metal servers from the [Khulnasoft console](https://console.khulnasoft.com/), via the [API](https://www.khulnasoft.com/en/developers/api/elastic-metal/) or the [Khulnasoft Command Line Interface (CLI)](https://github.com/khulnasoft/khulnasoft-cli#khulnasoft-cli-v2).
...
The [Khulnasoft Command Line Interface (CLI)](https://github.com/khulnasoft/khulnasoft-cli) allows you to pilot your Khulnasoft infrastructure directly from your terminal, providing a faster way to administer and monitor your resources. Khulnasoft CLI is easy to set up and use, and an essential tool for operating efficiently in your cloud environment. The CLI provides many functionalities, including the ability to create and administer Elastic Metal servers.
...
There are many other functionalities you can access for your Elastic Metal server via the Khulnasoft CLI. In the following examples, replace `your-elastic-metal-server-ID` with your server's ID.

<Message type="note">
  * Before powering off your server, we recommend you [log into your server as root](/bare-metal/elastic-metal/how-to/connect-to-server/) and execute the `halt` command to shut down the OS.
...
<Message type="important">
  Before powering off your Elastic Metal server, we recommend you [log into your server as root](/bare-metal/elastic-metal/how-to/connect-to-server/) and execute the `halt` command to shut down the OS.
</Message>
