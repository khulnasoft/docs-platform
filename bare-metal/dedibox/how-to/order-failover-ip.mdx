...
meta:
  ...
  description: This page explains order a failover IP for a Khulnasoft Dedibox dedicated server
content:
  h1: How to order a failover IP for Dedibox
  paragraph: This page explains order a failover IP for a Khulnasoft Dedibox dedicated server
...
Each failover IP can be routed to any of your Dedibox servers at any time in just a few minutes by using the Khulnasoft console or the API. By switching your failover IP addresses from one server to another, the hosted services remain available without reconfiguring the IP address.
