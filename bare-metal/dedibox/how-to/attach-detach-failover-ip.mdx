---
meta:
  title: How to attach/detach a failover IP on Khulnasoft Dedibox
  description: This page explains attach/detach a failover IP to a Khulnasoft Dedibox server
content:
  h1: How to attach/detach a failover IP on Khulnasoft Dedibox
  paragraph: This page explains attach/detach a failover IP to a Khulnasoft Dedibox server
...
Each failover IP can be routed to any of your Dedibox servers at any time by using the Khulnasoft console or the API.
...
3. Move your mouse over the failover IP you want to attach to your Dedibox server. Click the IP and drop it on the Dedibox you want to attach it to.
    <Lightbox src="khulnasoft-dragndrop-failover-ip.gif" alt="" />
