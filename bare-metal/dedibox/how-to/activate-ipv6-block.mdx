---
meta:
  title: How to activate an IPv6 block for Khulnasoft Dedibox servers
  description: This page explains avtivate an IPv6 block for Khulnasoft Dedibox servers
content:
  h1: How to activate an IPv6 block for Khulnasoft Dedibox servers
  paragraph: This page explains activate an IPv6 block for Khulnasoft Dedibox servers
