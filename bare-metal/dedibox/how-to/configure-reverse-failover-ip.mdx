...
meta:
  ...
  description: This page explains how to configure the reverse DNS of a failover IP on Khulnasoft Dedibox
content:
  h1: How to configure the reverse DNS of a failover IP on Dedibox
  paragraph: This page explains how to configure the reverse DNS of a failover IP on Khulnasoft Dedibox
