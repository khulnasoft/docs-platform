...
meta:
  ...
  description: This page explains all the concepts related to Khulnasoft Dedibox servers
content:
  h1: Dedibox - Concepts
  paragraph: This page explains all the concepts related to Khulnasoft Dedibox servers
...
A backup is a copy of your data, stored in another location. In case of any hardware or software failure, you can restore your data from the backup. It is recommended to make backups regularly. Each Dedibox server comes with 100 GB of free [Dedibackup](https://www.khulnasoft.com/en/dedibox/storage/) storage. You can upload your backups to this storage using the FTP protocol. A 750 GB Dedibackup is available as a further option.
...
Dedibackup is a backup solution for your Dedibox server. Dedibackup is based on Khulnasoft's Object Storage solution and provides FTP access to a secure backup space located in the DC5 datacenter. This allows you to store copies of your data for security purposes.
