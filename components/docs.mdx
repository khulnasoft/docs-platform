...
A list of languages can be found [here](https://prismjs.com/#supported-languages).
...
<Concept>
  ...
  <Lightbox src="miam.webp" alt="Cupcake Khulnasoft" />
...
Inline Console icons are used in the text. They are the same as the Khulnasoft Console icons.
...
#### With 2 small images:
<Lightbox src={["icon.webp","miam.webp"]} size={"small"}  alt={["icon","Cupcake Khulnasoft"]} />
...
<Lightbox src={["icon.webp","miam.webp"]} size={"medium"}  alt={["icon","Cupcake Khulnasoft"]} />
...
#### With 3 small images:
<Lightbox src={["icon.webp","miam.webp","first-khulnasoft-chip.webp"]} size={"small"}  alt={["icon","Cupcake Khulnasoft","chips"]} />
...
### Can handle .gif
<Lightbox src="khulnasoft-flex-drag.gif" alt="" />

<Lightbox src={["icon.webp", "khulnasoft-flex-drag.gif"]} alt="" />
...
<Lightbox src="miam.webp" alt="Cupcake Khulnasoft" />
<Lightbox src="first-khulnasoft-chip.webp" alt="First Khulnasoft chip" />
...
- Internal
  ...
  - `[]()` PDF: [Latest changes of the week](new-changes.pdf)
    ...
    ```
- External
  - `<Link />` Tag component: <Link to="https://console.khulnasoft.com">Console Khulnasoft</Link>
    ```jsx
      <Link to="https://console.khulnasoft.com">Console Khulnasoft</Link>
    ```
  - `[]()` Native syntax: [Tutorials](https://console.khulnasoft.com)
    ```md
      [Tutorials](https://console.khulnasoft.com)
    ```
...
1. First
2. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
    <Lightbox src="first-khulnasoft-chip.webp" />
3. Third
4. fourth
...
| [Khulnasoft Onboarding guide](new-changes.pdf) | Learning-oriented, we take you through a series of steps to learn a concept          |

|                      Content Type                       |                                  Description                                  |
| :-----------------------------------------------------: | :---------------------------------------------------------------------------: |
| [Internal link](/dedibox-console/account/quickstart/) |                             Centered-align table                              |
|        [External link](https://www.khulnasoft.com)        | Problem-oriented, we take you through a series of steps to reach a real goal. |
...
<Tabs id="createinstance">
  <TabsTab label="Console Tab">
    CONSOLE
    1. Click **Instances** in the **Compute** section of the side menu. The Instance creation page displays.
        <Lightbox src="first-khulnasoft-chip.webp" alt="" />
        <Message type="note">
    ...
    3. Complete the following steps in the wizard:
        - Choose an **Availability Zone**, which is the geographical region where your Instance will be deployed.
        - Choose an **Image** to run on your Instance. This can be an operating system, an InstantApp or a custom image. A complete list of all available Linux distributions and InstantApps can be found [here](https://www.khulnasoft.com/en/imagehub/).
        <Message type="note">
  ...
  <TabsTab label="API Tab">
    ...
    ```bash
    curl -H "X-Auth-Token: $SECRET_KEY" -H "Content-Type: application/json" https://api.khulnasoft.com/instance/v1/zones/fr-par-1/servers -d \
    '{
      "name": "my-instance",
...
<HelpBanner
  url="https://console.khulnasoft.com/support/tickets"
