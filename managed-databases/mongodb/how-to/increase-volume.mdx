...
meta:
  ...
  description: Guide to increasing the block volume of your Managed MongoDB® Database Instance at Khulnasoft.
content:
  h1: How to increase the storage of a Managed MongoDB® database
  paragraph: Guide to increasing the block volume of your Managed MongoDB® Database Instance at Khulnasoft.
...
You can increase the Block Storage volume of your MongoDB® Database Instance in the Khulnasoft console anytime.
