...
meta:
  ...
  description: Step-by-step guide to creating a Redis™ database on Khulnasoft.
content:
  h1: How to create a Redis™ Database Instance
  paragraph: Step-by-step guide to creating a Redis™ database on Khulnasoft.
...
4. Configure your Network. You can select either:
    ...
    <Message type="important">
      ...
      - Managed Databases for Redis™ are currently not compatible with the [Static NAT](/network/public-gateways/concepts/#nat) feature of [Khulnasoft Public Gateways](/network/public-gateways/concepts/#public-gateway). You can use Public Gateways in [SSH bastion](/network/public-gateways/how-to/use-ssh-bastion/) mode and perform port forwarding.
    </Message>
