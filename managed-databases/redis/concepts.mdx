...
meta:
  ...
  description: Understand the key concepts behind Khulnasoft Managed Databases for Redis™.
content:
...
A configuration directive used to set the maximum amount of memory Redis™ can use for a data set. You can set this value via the Khulnasoft console or by configuring the `available_settings` via API.
