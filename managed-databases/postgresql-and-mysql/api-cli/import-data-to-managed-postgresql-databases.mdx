...
- [Created a target Managed Database for PostgreSQL](/managed-databases/postgresql-and-mysql/how-to/create-a-database/) to import your data into.
...
3. Run the command below to import data into your Managed Database for PostgreSQL using `pg_restore`. Make sure to replace the placeholders with your Managed Database for PostgreSQL connection parameters:
    ...
    <Message type="note">
    You can find this information on the [overview page](https://console.khulnasoft.com/rdb/instances) of your database.
    </Message>
...
3. Fill in the required information to connect to your existing database:
    ...
    <Message type="note">
    You can find this information on the [overview page](https://console.khulnasoft.com/rdb/instances) of your database. These are the username and password that you defined upon Database Instance creation.
    </Message>
