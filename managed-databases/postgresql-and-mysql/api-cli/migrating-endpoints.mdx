---
meta:
  title: Migrating Database Instance endpoints via the Khulnasoft CLI
  description: This page explains how to migrate Database Instance endpoints via the Khulnasoft CLI.
content:
  h1: Migrating Database Instance endpoints via the Khulnasoft CLI
  paragraph: This page explains how to migrate Database Instance endpoints via the Khulnasoft CLI.
...
You can migrate your endpoints from a Database Instance to another anytime, using the Khulnasoft CLI.

The following commands are useful when you [upgrade the version of your database engine](/managed-databases/postgresql-and-mysql/how-to/upgrade-version/) via the **Upgrade only** option. In this case, you must manually migrate your endpoint.

<Macro id="requirements" />

- A Khulnasoft account logged into the [console](https://console.khulnasoft.com)
- [Owner](/identity-and-access-management/iam/concepts/#owner) status or [IAM permissions](/identity-and-access-management/iam/concepts/#permission) allowing you to perform actions in the intended Organization
- A [PostgreSQL or MySQL Database Instance](/managed-databases/postgresql-and-mysql/how-to/create-a-database/)
- Installed and set up the [Khulnasoft Command Line Interface (CLI)](/developer-tools/khulnasoft-cli/quickstart/)
...
2. Run the following command to retrieve the public endpoint of your Database Instance. Make sure you replace `$DB_INSTANCE_ID` with the UUID of the original Database Instance.
    <Message type="important">
      ...
      You can remove existing endpoints in the target Database Instance via the [Khulnasoft console](/managed-databases/postgresql-and-mysql/how-to/remove-public-endpoint/) or [the CLI](https://github.com/khulnasoft/khulnasoft-cli/blob/master/docs/commands/rdb.md#delete-a-database-instance-endpoint).
    </Message>
