...
meta:
  ...
  description: Learn more about the PostgreSQL extensions available at Khulnasoft and explore best configuration practices
content:
  h1: PostgreSQL extensions reference
  paragraph: Learn more about the PostgreSQL extensions available at Khulnasoft and explore best configuration practices
...
The following `pg_extensions` are available with Khulnasoft Managed Databases for PostgreSQL:
