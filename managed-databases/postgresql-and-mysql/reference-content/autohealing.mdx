...
At Khulnasoft, High Availability Database Instances are continuously monitored and benefit from the autohealing feature.
...
Your Database Instance then goes into autohealing mode and switches to the `AUTOHEALING` status (represented by a blue dot in the Khulnasoft console).
...
Once this process is complete, your Database Instance goes back to `READY` status (represented by the green dot in the Khulnasoft console).