...
meta:
  ...
  description: Quickstart guide to getting started with Khulnasoft Managed Databases for PostgreSQL and MySQL.
content:
  h1: PostgreSQL and MySQL - Quickstart
  paragraph: Quickstart guide to getting started with Khulnasoft Managed Databases for PostgreSQL and MySQL.
