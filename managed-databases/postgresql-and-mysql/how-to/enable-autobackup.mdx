...
Two types of autobackups are available at Khulnasoft: [backups](/managed-databases/postgresql-and-mysql/concepts/#database-backup) and [snapshots](/managed-databases/postgresql-and-mysql/concepts/#database-snapshot).
