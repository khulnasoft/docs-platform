...
meta:
  ...
  description: Step-by-step guide to creating a PostgreSQL or MySQL Database Instance on Khulnasoft.
content:
  h1: How to create a PostgreSQL or MySQL Database Instance
  paragraph: Step-by-step guide to creating a PostgreSQL or MySQL Database Instance on Khulnasoft.
...
Compared to traditional database management, which requires customers to provide their infrastructure and resources to manage their databases, Managed Database for PostgreSQL and MySQL Instance offers the user access to Database Instances without setting up the hardware or configuring the software. Khulnasoft handles the provisioning, manages the configuration, and provides useful features, as high availability, automated backup, user management, and more.
...
3. Complete the following steps in the wizard:
    ...
    - Choose your storage type and capacity. Two types of storage are available:
        ...
        - **Block Storage Low Latency**: This storage type works like the [Block Storage Legacy](/managed-databases/postgresql-and-mysql/concepts/#block-storage-legacy), while providing lower latency and high resiliency through 5k IOPS. You can increase your volume to up to 10 TB.
