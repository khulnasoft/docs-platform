...
meta:
  ...
  description: Guide to managing allowed IP addresses for your Database Instances.
content:
...
1. Click **PostgreSQL and MySQL** in the **Managed Databases** section of the [Khulnasoft console](https://console.khulnasoft.com) side menu. A list of your Database Instances displays.
