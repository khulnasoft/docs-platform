...
5. Select the Availability Zone (AZ) configuration. Two configurations are available:
    ...
    [Block Storage Low Latency volumes](/managed-databases/postgresql-and-mysql/concepts/#block-storage-low-latency) are currently not available with Multi-AZ Read Replicas.
    </Message>
