---
meta:
  title: How to monitor your Database Instance with Khulnasoft Cockpit
  description: Learn how to effectively monitor your Database Instance using Khulnasoft Cockpit for optimal performance.
content:
  h1: How to monitor your Database Instance with Khulnasoft Cockpit
  paragraph: Learn how to effectively monitor your Database Instance using Khulnasoft Cockpit for optimal performance.
...
You can view your Managed Database for PostgreSQL or MySQL metrics and logs using [Khulnasoft Cockpit](/observability/cockpit/quickstart/). Managed Databases are fully integrated into Cockpit.
...
This page explains how to get started with Khulnasoft Cockpit for viewing your Managed Database metrics and logs.
...
Khulnasoft Cockpit is activated by default if you have created any [Khulnasoft resources integrated with Cockpit](/observability/cockpit/reference-content/cockpit-limitations/#product-integration-into-cockpit).

## How to access the Grafana dashboard

To view your Managed Database's metrics and logs, use the Grafana dashboard which is accessible from the Khulnasoft console:
...
1. Click **Open dashboards** on the top right from the Khulnasoft Cockpit dashboards homepage.
2. Click either **RDB MySQL Overview** or **RDB PostgreSQL Overview**, depending on your engine of choice, on the left side menu.
    ...
    <Lightbox src="khulnasoft-grafana-rdb.webp" alt="" />
...
Log configuration is done by Khulnasoft. Note that:
...
You can activate Khulnasoft preconfigured alerts for your Managed Databases with Khulnasoft Cockpit.

<Message type="note">
  Refer to the [How to activate preconfigured alerts](/observability/cockpit/how-to/activate-managed-alerts/) to learn how to do so.
</Message>
...
You can also configure [your own alerts](/observability/cockpit/how-to/configure-alerts-for-scw-resources/) and set values for each of the parameters below to define when you want to be alerted:
