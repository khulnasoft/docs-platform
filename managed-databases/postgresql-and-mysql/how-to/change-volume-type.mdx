...
It is possible to change your [volume type](/managed-databases/postgresql-and-mysql/concepts/#volume-type) anytime in the Khulnasoft console.
...
3. Scroll down to **Volume settings**, then click **Change volume type**.
    <Message type="important">
      ...
      - `READY` (represented as "Running" in the Khulnasoft console)
      - `DISK_FULL`
    </Message>
    A pop-up appears.
