...
meta:
  ...
  description: Instructions for deleting a PostgreSQL or MySQL Database Instance on Khulnasoft.
content:
  h1: How to delete a PostgreSQL and MySQL Database Instance
  paragraph: Instructions for deleting a PostgreSQL or MySQL Database Instance on Khulnasoft.
