...
content:
  ...
  paragraph: Learn how to manage Read Replicas for your PostgreSQL and MySQL databases.
...
- [Created a Read Replica](/managed-databases/postgresql-and-mysql/how-to/create-read-replica/)
...
Refer to the [How to delete a public endpoint](/managed-databases/postgresql-and-mysql/how-to/remove-public-endpoint/#from-read-replicas) documentation page to do so for your Read Replica.
...
2. Click the database name or <Icon name="more" /> > **More info** to access the Database Instance information page.
3. Scroll down to the **Read Replica** section.
4. Click <Icon name="more" /> > **Delete**. A pop-up appears.
    <Message type="important">
