...
This state allows you to increase your volume, if you use Block Storage, or [upgrade your node type](/managed-databases/postgresql-and-mysql/how-to/upgrade-a-database/). You can also clear some space in your volume to increase your capacity.
...
You can check your current engine logs consumption by using the Khulnasoft CLI:
