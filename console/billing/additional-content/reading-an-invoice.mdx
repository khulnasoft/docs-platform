...
<Lightbox src="khulnasoft-invoice-1.webp" size="medium" />

Your Khulnasoft invoice contains the following sections:
...
- **Seller information (3):** Contact details of Khulnasoft SAS along with their VAT number.
