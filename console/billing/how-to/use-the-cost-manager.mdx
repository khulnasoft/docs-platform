...
meta:
  ...
  description: Manage and track your costs with the Khulnasoft Cost Manager.
content:
  h1: How to use the billing cost manager
  paragraph: Manage and track your costs with the Khulnasoft Cost Manager.
...
The Khulnasoft cost manager is a comprehensive tool to monitor and analyze cloud resource consumption and costs. It offers a clear and detailed view of consumption data, enabling you to accurately consolidate consumption for re-invoicing purposes.
...
1. Click **Billing** in the Organization drop-down menu to go to the **Billing Overview** page.
    <Message type="tip">
      Alternatively, you can reach the [billing page](https://console.khulnasoft.com/billing/overview) from your [Organization Dashboard](https://console.khulnasoft.com/organization) by clicking **Go to Billing** above the **Current consumption** area.
    </Message>
...
4. Filter the data by selecting the different categories in the drop-down, then click **Filter**.
    ...
    You can filter by:
      ...
      <Lightbox src="khulnasoft-billing-consumption-chart.webp" alt="picture of a chart showing the 2023 consumption of products in the 'managed databases' category in the Khulnasoft console."/>
...
5. Scroll the page to see a detailed list of your resource consumption based on your filter selection.
      ...
      <Lightbox src="khulnasoft-billing-consumption-list.webp" alt="picture of a list detailing 2023 consumption of products in the 'managed databases' category in the Khulnasoft console. The list includes the category, product, project, and cost in euros"/>

      In the list you can see the product categories on the left. They follow the same order as the left menu of the Khulnasoft console.
...
<Message type="note">
  You can retrieve your monthly consumption via the [Billing API](https://www.khulnasoft.com/en/developers/api/billing/#path-consumption-get-monthly-consumption). Refer to the [Retrieving your monthly consumption](/console/billing/api-cli/retrieve-monthly-consumption/) documentation page for more information.
</Message>