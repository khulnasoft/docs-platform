...
meta:
  ...
  description: Set up billing alerts to monitor your Khulnasoft spending.
content:
  h1: How to use billing alerts
  paragraph: Set up billing alerts to monitor your Khulnasoft spending.
...
Your budget, denominated in euros, represents the limit for your expenses. Simultaneously, the threshold corresponds to a predetermined percentage of this budget. You have the autonomy to define both the budget and the threshold within the Khulnasoft console.
