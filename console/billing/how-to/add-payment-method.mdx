...
meta:
  ...
  description: Step-by-step guide to adding a payment method to your Khulnasoft account.
content:
  h1: How to add a payment method
  paragraph: Step-by-step guide to adding a payment method to your Khulnasoft account.
...
Before you can order Khulnasoft resources, you must add a payment method to your account. You can choose between two payment methods: **credit card** or **SEPA mandate**.
...
<Tabs id="add credit card">
  <TabsTab label="Read the step-by-step">
    1. Access the [Khulnasoft console](https://console.khulnasoft.com/organization).
    2. On the **Billing** page, click the [Payment and billing](https://console.khulnasoft.com/billing/payment) tab.
