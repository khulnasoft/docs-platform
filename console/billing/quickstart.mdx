...
meta:
  ...
  description: Quickstart guide to setting up and managing billing in Khulnasoft.
content:
  h1: Billing - Quickstart
  paragraph: Quickstart guide to setting up and managing billing in Khulnasoft.
...
Before you can order Khulnasoft resources, you must add your payment method to your account.
...
1. Click **Billing** in the Organization drop-down menu to go to the [Billing page](https://console.khulnasoft.com/billing/overview).
...
1. Click **Billing** in the Organization drop-down menu to go to the [Billing page](https://console.khulnasoft.com/billing/payment).
...
<Message type="note">
  It is not possible to edit your country and region information directly from this form. Contact the [support team](https://console.khulnasoft.com/support/tickets/) if you need to modify this information.
</Message>