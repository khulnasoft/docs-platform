...
meta:
  ...
  description: Manage personal data under GDPR regulations in Khulnasoft.
content:
  h1: How to manage your personal data
  paragraph: Manage personal data under GDPR regulations in Khulnasoft.
...
Khulnasoft makes it easy for you to manage your personal data and privacy via the console.
...
To access the privacy page, open the Organization drop-down menu in the top-right corner of the Khulnasoft console, and click **Privacy**.
...
2. Either:
    - Check the first box to obtain information about your personal data processed by Khulnasoft, or
    - Check the second box to obtain a copy of your personal data processed by Khulnasoft
...
If you do not want to use Khulnasoft services anymore, you can [close your account](/console/account/how-to/close-account/) and/or delete your personal data.
...
1. Click your Organization’s name at the top-right corner of the Khulnasoft console. 
