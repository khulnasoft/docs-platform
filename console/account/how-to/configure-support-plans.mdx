...
meta:
  ...
  description: Set up and configure support plans in Khulnasoft.
content:
  h1: How to configure Support Plans
  paragraph: Set up and configure support plans in Khulnasoft.
...
<Lightbox src="khulnasoft-support-plans-overview.webp" alt="" />
...
<Lightbox src="khulnasoft-support-plan-confirmation.webp" alt="" />

An overview of your previous and current plans is available under **Support Plans History**.

<Lightbox src="khulnasoft-support-history.webp" alt="" />
