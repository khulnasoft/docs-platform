...
meta:
 ...
 description: Convert your Khulnasoft account to a corporate account.
content:
 h1: How to switch from a personal to a corporate account
 paragraph: Convert your Khulnasoft account to a corporate account.
...
The [Khulnasoft console](https://console.khulnasoft.com) allows you to choose between two types of accounts, Personal and Corporate. All users are given the possibility to select one or the other option when first signing up for a Khulnasoft account. If you signed up for a personal account and need to convert to a corporate one, follow these instructions.
...
1. From your [Organization dashboard](https://console.khulnasoft.com/organization), click Billing in the top right drop-down menu. The **Billing** dashboard displays.
...
3. Scroll down to billing information, then click <Icon name="edit" /> **Edit**. A pop-up with your billing information displays.
    <Lightbox src="khulnasoft-billing-personal-info.webp" alt="" />
4. Check the box at the top to confirm you wish to have a corporate account. A new form displays.
    <Lightbox src="khulnasoft-billing-corporate-info.webp" alt="" />
