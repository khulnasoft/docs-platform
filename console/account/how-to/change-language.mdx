...
meta:
  ...
  description: Switch languages in the Khulnasoft account interface.
content:
  h1: How to change the account language
  paragraph: Switch languages in the Khulnasoft account interface.
...
You can choose which language you would like to view the [Khulnasoft console](/console/account/concepts/#console) in. This language will also be used for any marketing and product communications Khulnasoft sends you.
