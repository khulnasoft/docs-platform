...
meta:
  ...
  description: Steps to log in to the Khulnasoft console.
content:
  h1: How to log in to the console
  paragraph: Steps to log in to the Khulnasoft console.
...
Instead of using your password, you can use a **Magic Link** to authenticate yourself when you log into the Khulnasoft console. This provides quick and secure access to your account without the hassle of remembering your password. When you choose to sign in with Magic Link, you receive a unique link sent directly to your email inbox which you can use one time only to authenticate your login. Afterward, it automatically becomes invalid.

1. Open your web browser and go to the [Khulnasoft console](https://console.khulnasoft.com).
2. Enter your email address in the form and click **Send a Magic Link**.
   A magic link will be sent to your email inbox.
3. Check your email inbox for an email with the subject **Khulnasoft - Passwordless Authentication** and open it.
4. Click **Authenticate Myself** to connect to the Khulnasoft console.
    <Lightbox src="khulnasoft-magic-link-email.webp" alt="" />
...
Khulnasoft provides Single Sign-On (SSO) options for a seamless login experience. You can use your Google or Microsoft account to log in to the console. To do so, make sure the email address associated with your Khulnasoft account matches the email address of your Google or Microsoft account.
