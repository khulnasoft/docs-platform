...
meta:
  ...
  description: Verify your identity for secure Khulnasoft account access.
content:
  h1: How to verify your identity
  paragraph: Verify your identity for secure Khulnasoft account access.
...
1. Click **Add ID document** under **(Optional) Verify my ID document** on the [Organization dashboard](https://console.khulnasoft.com/organization/). You can also verify your identity from the [Settings tab](https://console.khulnasoft.com/organization/settings) of your Organization dashboard. 
    <Lightbox src="khulnasoft-add-id-document.webp" alt="" />
2. Click **Start** to proceed.
    <Lightbox src="khulnasoft-choose-country-of-issue.webp" alt="" />
...
5. Click **Start** to center your ID and take a photo.
    <Message type="important">
      The **console.khulnasoft.com** website will request access to your camera. If you wish to proceed, allow your browser to use the camera.
    </Message>
