...
meta:
  ...
  description: Get started with Khulnasoft Block Storage. This guide covers creating, attaching, and mounting Block Storage volumes to your Instances for efficient data management.
content:
  h1: Block Storage - Quickstart
  paragraph: Get started with Khulnasoft Block Storage. This guide covers creating, attaching, and mounting Block Storage volumes to your Instances for efficient data management.
...
1. Click **Block Storage** in the **Storage** section of the [Khulnasoft console](https://console.khulnasoft.com) side menu. The Block Storage page displays.
...
1. Click **Block Storage** in the **Storage** section of the [Khulnasoft console](https://console.khulnasoft.com) side menu. Your volumes display.
...
1. Open a terminal and use the following command to connect to your Instance. Replace `<your_instance_ip>` with your Instance's IP. You can also find the SSH command in your Instance's **Overview** tab in the Khulnasoft console.
    ```
