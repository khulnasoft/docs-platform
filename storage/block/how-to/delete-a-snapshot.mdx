...
meta:
  ...
  description: This guide explains the steps to safely delete a volume snapshot from your Khulnasoft account.
content:
  h1: How to delete a volume snapshot
  paragraph: This guide explains the steps to safely delete a volume snapshot from your Khulnasoft account.
