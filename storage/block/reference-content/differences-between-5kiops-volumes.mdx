...
When creating volumes from the Khulnasoft console, you are prompted to choose between [Block Storage Low Latency](/storage/block/) volumes, [block volumes (Block Storage)](/compute/instances/concepts/#block-volumes), and [local volumes (Local Storage)](/compute/instances/concepts/#volumes).
