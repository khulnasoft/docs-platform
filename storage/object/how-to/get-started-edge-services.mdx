...
meta:
  ...
  description: This page explains how to configure an Edge Services pipeline for a Khulnasoft Object Storage bucket. Set up your own custom domain to point to your bucket, and enable a caching service for faster and more efficient delivery.
content:
  h1: How to set up an Edge Services pipeline for an Object Storage bucket
  paragraph: This page explains how to configure an Edge Services pipeline for a Khulnasoft Object Storage bucket. Set up your own custom domain to point to your bucket, and enable a caching service for faster and more efficient delivery.
...
Edge Services is an additional feature for Khulnasoft Load Balancers and Object Storage buckets. Creating an Edge Services pipeline towards your Object Storage bucket brings you a number of possible benefits:

<Macro id="edge-services-bucket-benefits" />
...
To use Edge Services, you must subscribe to a [pricing plan](https://www.khulnasoft.com/en/pricing/network/#edge-services). Within its monthly price, each pricing plan lets you create a certain number of pipelines and consume a certain amount of cache data.
...
1. Click **Object Storage** in the **Storage** section of the [Khulnasoft console](https://console.khulnasoft.com/) side menu.

2. Click the name of the bucket you want to create an Edge Services pipeline for.
    <Lightbox src="khulnasoft-edge-services-select-bucket.webp" alt="A screenshot of the Khulnasoft console shows a listing of Object Storage buckets, with an arrow showing that you click on the name of the bucket you want to enable Edge Services on." />

3. Click the **Edge Services** tab.

    <Lightbox src="khulnasoft-edge-services-os-splash.webp" alt="A screenshot of the Khulnasoft console shows the Edge Services tab for the selected bucket: it is in an empty state, with a button inviting you to enable Edge Services." />
