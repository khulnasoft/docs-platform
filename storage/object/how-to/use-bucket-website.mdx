...
meta:
  ...
  description: Host a website using Khulnasoft Object Storage buckets.
content:
  h1: How to enable and use the bucket website feature
  paragraph: Host a website using Khulnasoft Object Storage buckets.
...
The Bucket Website feature allows you to host [static websites](https://en.wikipedia.org/wiki/Static_web_page) using Khulnasoft [Object Storage](https://www.khulnasoft.com/en/object-storage/).
...
6. Click **Save configuration** to confirm. The details of your website configuration display.
    ...
    You can now [upload the **index** and **error** files](/storage/object/how-to/upload-files-into-a-bucket/) to your bucket, if you have not already done so, as well as the other files that make up your static website.
