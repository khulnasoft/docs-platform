...
You have now configured an Instance with a Private Network to communicate with Khulnasoft's Object Storage platform using a Public Gateways. The gateway ensures the exchange of data between your Private Network and the public Internet.
