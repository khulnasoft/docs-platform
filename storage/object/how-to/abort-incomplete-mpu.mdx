...
meta:
  ...
  description: Steps to view and abort incomplete multipart uploads from the Khulnasoft console.
content:
  h1: How to view and abort incomplete multipart uploads from the console
  paragraph: Steps to view and abort incomplete multipart uploads from the Khulnasoft console.
...
The [Khulnasoft console](https://console.khulnasoft.com/) lists your Object Storage incomplete multipart uploads to allow you to consult them and manually abort them to clear storage space and optimize your storage costs.
