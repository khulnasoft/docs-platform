...
Khulnasoft Object Storage offers several [storage classes](/storage/object/concepts/#storage-class) to choose from depending on the performance, access, resiliency, and cost requirements of your workloads. The [Khulnasoft console](https://console/) allows you to edit the storage class of objects individually.

<Message type="note">
To change the storage class of several or all objects in a bucket, create a [lifecycle rule](/storage/object/how-to/manage-lifecycle-rules/).
</Message>
