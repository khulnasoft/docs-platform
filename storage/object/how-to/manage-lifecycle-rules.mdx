...
With the Khulnasoft console, you can use lifecycle rules to [manually](/storage/object/how-to/edit-storage-class/) or automatically change the storage class of your objects. These rules also allow users to set expiration dates for objects and their versions.
