...
meta:
  ...
  description: Troubleshoot issues related to accessing data in Khulnasoft Object Storage.
content:
  h1: I cannot access my data
  paragraph: Troubleshoot issues related to accessing data in Khulnasoft Object Storage.
...
I am experiencing issues while trying to access my buckets and objects stored on Khulnasoft Object Storage.

## Solution

- Go to the [Status page](https://status.khulnasoft.com/) to see if there is an ongoing incident on the Khulnasoft infrastructure.
