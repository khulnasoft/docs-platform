...
meta:
  ...
  description: Discover the checksums supported by Khulnasoft Object Storage.
content:
  h1: Supported checksums
  paragraph: Discover the checksums supported by Khulnasoft Object Storage.
...
Khulnasoft Object Storage supports several checksum algorithms that allow you to verify the integrity of your objects:
