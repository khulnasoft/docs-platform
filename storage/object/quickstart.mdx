...
meta:
  ...
  description: Quickly get started with Khulnasoft Object Storage.
content:
  h1: Object Storage - Quickstart
  paragraph: Quickly get started with Khulnasoft Object Storage.
...
[Khulnasoft Object Storage](/storage/object/concepts/#object-storage) is an Object Storage service based on the Amazon S3 protocol. It allows you to store any objects (documents, images, videos, etc.) and access them anytime from anywhere in the world. You can manage your storage directly from the Khulnasoft console. On the control panel, you can easily upload, download, and visualize the objects in your buckets. In addition, you can integrate many existing libraries or CLI clients into your application or scripts.
...
3. Select the geographical location in which to create your bucket. Khulnasoft Object Storage is currently available in three Regions.
...
5. Select the Storage Class of your object. Khulnasoft Object Storage allows you to associate storage classes with each of your objects. You can choose the storage class depending on your use case:
    - [Standard](/storage/object/concepts/#storage-class): The `Standard` class is [Multi-AZ](/faq/objectstorage/#what-are-the-object-storage-classes-offered-by-khulnasoft), and is available in all regions. It is suitable for any use case, such as on-demand content, like streaming or CDN.
