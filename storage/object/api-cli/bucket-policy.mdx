...
meta:
  ...
  description: Implement and manage bucket policies in Khulnasoft Object Storage.
content:
  h1:  Bucket policies overview
  paragraph: Implement and manage bucket policies in Khulnasoft Object Storage.
...
- With the `2023-04-17` version, only actions explicitly **allowed** by the bucket policy are permitted, if the principal is also **allowed** by an [IAM policy](/identity-and-access-management/iam/how-to/create-policy/). **Deny** statements are therefore useless.
  ...
  "Statement": [
    {
      ...
      "Condition": {
        "StringLike": {
          "aws:Referer": "https://console.khulnasoft.com/*"
        }
      }
    }
  ]
...
Refer to our [dedicated documentation](/storage/object/api-cli/manage-bucket-permissions-ip/) for more information on managing bucket permissions for IP addresses or ranges of IP.