...
meta:
  ...
  description: Set CORS rules to manage cross-origin requests in Khulnasoft Object Storage.
content:
  h1: Setting CORS rules on Object Storage buckets
  paragraph: Set CORS rules to manage cross-origin requests in Khulnasoft Object Storage.
