...
meta:
  ...
  description: Learn how to use the API call list effectively with Khulnasoft Object Storage.
content:
  h1: Supported Object Storage API calls
  paragraph: Learn how to use the API call list effectively with Khulnasoft Object Storage.
...
In this page we index all available Khulnasoft Object Storage API requests.
...
|  [ListObjectVersions](/storage/object/api-cli/bucket-operations/#getbucketobjectversion) |  Returns metadata about all the versions of objects in a bucket | ✅ |
