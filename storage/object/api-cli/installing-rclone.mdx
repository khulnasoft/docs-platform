...
meta:
  ...
  description: Install and configure rclone for Khulnasoft Object Storage integration.
content:
  h1: Installing and setting up Rclone
  paragraph: Install and configure rclone for Khulnasoft Object Storage integration.
...
3. Type `s3` and hit enter to confirm this storage type. The following output displays:
    ...
    13 / Any other Amazon S3 compatible provider
      \ "Other"
    ```
4. Type `Khulnasoft` and hit enter to confirm this Amazon S3 provider. The following output displays:
    ```
