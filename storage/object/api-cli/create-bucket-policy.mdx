...
meta:
  ...
  description: Create custom bucket policies in Khulnasoft Object Storage using the CLI.
content:
  h1: Creating and applying a bucket policy
  paragraph: Create custom bucket policies in Khulnasoft Object Storage using the CLI.
...
To create and apply a bucket policy from the [Khulnasoft console](https://console/khulnasoft.com), refer to the [dedicated documentation](/storage/object/how-to/create-bucket-policy/).
...
- An [IAM policy](/identity-and-access-management/iam/how-to/create-policy/) to grant access to your users and applications
...
Your objects will become accessible to all the users in your organization that have [IAM permissions](/storage/object/api-cli/combining-iam-and-object-storage/#combining-iam-and-bucket-policies) for Object Storage.
</Message>