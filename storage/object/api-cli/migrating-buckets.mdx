...
meta:
  ...
  description: Learn to migrate buckets between accounts and regions with the Khulnasoft CLI.
content:
  h1: Migrating data from one bucket to another
  paragraph: Learn to migrate buckets between accounts and regions with the Khulnasoft CLI.
...
- Installed and initialized the [AWS CLI for Khulnasoft](/storage/object/api-cli/object-storage-aws-cli/)
...
2. Copy the objects between the Object Storage buckets.
    <Message type="important">
      If you have objects in the Khulnasoft `Glacier` storage class you must [restore](/storage/object/how-to/restore-an-object-from-glacier/) them before continuing.
    </Message>
