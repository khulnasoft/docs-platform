...
meta:
  ...
  description: Manage large object uploads efficiently with multipart uploads in Khulnasoft.
content:
  h1: Managing multipart uploads
  paragraph: Manage large object uploads efficiently with multipart uploads in Khulnasoft.
...
<Message type="note">
You can also abort incomplete multipart uploads manually using the [Khulnasoft console](https://console.khulnasoft.com/), or automatically using [lifecycle rules](/storage/object/how-to/manage-lifecycle-rules).
</Message>
