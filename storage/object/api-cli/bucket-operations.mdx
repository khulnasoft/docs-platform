...
meta:
  ...
  description: Perform various operations on buckets in Khulnasoft Object Storage using the CLI.
content:
  h1: Understanding Object Storage bucket operations
  paragraph: Perform various operations on buckets in Khulnasoft Object Storage using the CLI.
