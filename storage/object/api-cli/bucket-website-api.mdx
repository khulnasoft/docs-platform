...
meta:
  ...
  description: Configure bucket websites using the API in Khulnasoft Object Storage.
content:
  h1: Setting up static websites on a bucket with the API
  paragraph: Configure bucket websites using the API in Khulnasoft Object Storage.
...
The bucket website feature allows you to host static websites using Khulnasoft [Object Storage](https://www.khulnasoft.com/en/object-storage/).
...
To enable and configure the bucket website using the Khulnasoft console, refer to our [dedicated documentation](/storage/object/how-to/use-bucket-website/).
