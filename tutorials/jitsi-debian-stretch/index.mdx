...
- An [Instance](/compute/instances/how-to/create-an-instance/) running on Debian Stretch (9.0) with **at least 4 GB of RAM**.
...
9. The Jitsi Meet Instance is configured now and ready for a first conference call. Open a web browser and type the FQDN of your Instance, for example: `https://jitsi.mydomain.tld`. The following screen will appear:
    <Lightbox src="khulnasoft-jitsi_home_2.webp" alt="" />
    ...
    <Lightbox src="khulnasoft-jitsi-meet-conf-call-2.webp" alt="" />