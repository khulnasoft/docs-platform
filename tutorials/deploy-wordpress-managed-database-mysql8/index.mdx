---
meta:
  title: Deploying a WordPress blog backed by Khulnasoft Managed Database for MySQL 8
  description: Learn how to deploy your own WordPress blog backed by Khulnasoft Managed Database for MySQL 8.
content:
  h1: Deploying a WordPress blog backed by Khulnasoft Managed Database for MySQL 8
  paragraph: Learn how to deploy your own WordPress blog backed by Khulnasoft Managed Database for MySQL 8.
...
Learn how to set up your own WordPress blog on a Khulnasoft Instance, supported by a robust MySQL 8 database. Khulnasoft Managed Database for MySQL 8 offers up to 48 cores and 256 GB of RAM, ensuring optimal performance and reliability for your project.

WordPress, a PHP-based content management system, relies on MySQL to store its data. This tutorial will guide you through the technical steps of configuring WordPress on your Khulnasoft Instance, leveraging the power of MySQL 8.
...
- An [Instance](/compute/instances/how-to/create-an-instance/) running on Ubuntu Bionic Beaver (18.04 LTS) or Focal Fossa (20.04 LTS)
- A [Database](https://www.khulnasoft.com/en/database/) for MySQL v8

## Preparing the managed database

1. Go to the [Database section](https://console.khulnasoft.com/rdb/instances) of your Khulnasoft console and choose your Database Instance from the list:
    <Lightbox src="khulnasoft-db_list.webp" alt="" />
...
1. Click the **Allowed IPs** tab to see the list of allowed IPs:
    <Lightbox src="khulnasoft-db_allowed_ips.webp" alt="" />
...
6. Open the configuration file in a text editor (for example, `nano`) and edit the MySQL server configuration as follows:
    <Lightbox src="khulnasoft-managed_database_wp_config.webp" alt="" />
...
2. The WordPress installation wizard displays. Choose the desired language for your blog from the list and click **Continue**:
    <Lightbox src="khulnasoft-wp_install_1.webp" alt="" />
3. Enter the details of your new blog, such as the title, choose a name for the admin user, and set a secret password. Then click **Install WordPress** to complete the installation of your blog:
    <Lightbox src="khulnasoft-wp_install_2.webp" alt="" />
