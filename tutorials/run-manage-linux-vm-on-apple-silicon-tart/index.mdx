...
content:
  h1: Run and manage macOS and Linux virtual machines on Apple silicon with Tart
...
- [Created a Mac mini](/bare-metal/apple-silicon/how-to/create-mac-mini/) running macOS 13.0 (Ventura) or later
...
3. The virtual machine displays. Log into the virtual machine with the provided credentials.
   ...
   <Lightbox src="tart-run-sonoma.webp" alt="Mac OS Sonoma in a virtual machine, displayed on the main desktop of a Mac mini" size="large" />
...
3. After running the Ubuntu image, log into the virtual machine with the provided credentials.
  ...
  <Lightbox src="tart-run-ubuntu.webp" alt="Ubuntu Linux in a virtual machine, displayed on the main desktop of a Mac mini" size="large" />
  <Message type="tip">
