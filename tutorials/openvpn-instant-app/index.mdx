---
meta:
  title: One-click OpenVPN deployment on Khulnasoft Instances using InstantApp
  description: Learn how to get started with OpenVPN on Khulnasoft Instances using the OpenVPN InstantApp. Follow our step-by-step guide for a seamless VPN setup.
content:
  h1: One-click OpenVPN deployment on Khulnasoft Instances using InstantApp
  paragraph: Learn how to get started with OpenVPN on Khulnasoft Instances using the OpenVPN InstantApp. Follow our step-by-step guide for a seamless VPN setup.
...
1. [Connect to your Instance](/compute/instances/how-to/connect-to-instance/) via SSH. You see the following message:
```
###############################################################################
#                      KHULNASOFT OPENVPN INSTANTAPP                            #
###############################################################################
...
Read our tutorial: https://www.khulnasoft.com/en/docs/tutorials/openvpn-instant-app
```
