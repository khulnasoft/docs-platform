...
meta:
  ...
  description: Learn how to install and use the MLX array framework on Khulnasoft's Apple silicon as a Service.
content:
  h1: Deploying the MLX array framework for Apple silicon
  paragraph: Learn how to install and use the MLX array framework on Khulnasoft's Apple silicon as a Service.
categories:
  - apple-silicon
