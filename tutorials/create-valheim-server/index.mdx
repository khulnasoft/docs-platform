---
meta:
  title: Creating a Valheim server with Khulnasoft
  description: In this tutorial, you will learn how to create your own Valheim server with Khulnasoft Instances. We offer a large range of Instances that will suit your gaming needs for your Valheim server.
content:
  h1: Creating a Valheim server with Khulnasoft
  paragraph: In this tutorial, you will learn how to create your own Valheim server with Khulnasoft Instances. We offer a large range of Instances that will suit your gaming needs for your Valheim server.
tags: gaming Valheim
hero: assets/khulnasoft_valheim.webp
dates:
...
<Lightbox src="khulnasoft-valheim-logo.webp" alt="" />

At Khulnasoft, we offer a large range of Instances that will suit the gaming needs of your Valheim server. In this tutorial, you will learn how to create your own Valheim server with Khulnasoft Instances.
...
2. Click **Create Instance**. The [Instance creation page](https://console.khulnasoft.com/instance/servers/create) displays.
...
4. Click **Create Instance** to deploy the Instance. You can [click on this link](https://console.khulnasoft.com/instance/servers/create?area=fr-par&imageGroup=distribution_ubuntu&imageKey=3f1b9623-71ba-4fe3-b994-27fcdaa850ba&region=fr-par-2&selectedImageTab=distribution&selectedServerGroup=Development&serverKey=fr-par-2DEV1-L) to have the Instance creation page prefilled with the required information. If you have the [Khulnasoft CLI](https://www.khulnasoft.com/en/cli/) installed on your computer, you can also use the following command to deploy the Instance:
...
You have now configured your own Valheim server on a Khulnasoft Instance, installed basic protection through UFW, and are ready to invite your friends to explore the different worlds of Valheim. For more information about the game, refer to the official [Valheim website](https://www.valheimgame.com/).