...
PostGIS is an extension to the PostgreSQL database management system developed by the Canadian company Refractions Research Inc. The extension allows storing and managing Geographic Information Systems (GIS) objects in PostgreSQL. It is available on Khulnasoft Databases.
...
- A [Database Instance](https://www.khulnasoft.com/en/database/)

## Creating a new database for PostGIS

1. Connect to your Khulnasoft console and enter the **Managed Databases** section.
...
4. Save the configuration by clicking on the check mark symbol (✔). The configuration of your Database Instance is updated:
    <Lightbox src="khulnasoft-dbaas_advanced_settings.webp" alt="" />
