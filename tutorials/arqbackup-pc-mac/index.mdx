---
meta:
  title: Backing up a PC or a Mac on Khulnasoft Object Storage with Arq Backup
  description: This page shows you how to configure Arq to back up a PC or Mac automatically on Khulnasoft Object Storage
content:
  h1: Backing up a PC or a Mac on Khulnasoft Object Storage with Arq Backup
  paragraph: This page shows you how to configure Arq to back up a PC or Mac automatically on Khulnasoft Object Storage
categories:
  - object-storage
hero: assets/khulnasoft_arqbackup.webp
...
This tutorial guides you through backing up your PC or Mac computer to Khulnasoft Object Storage using Arq Backup version 7.

<Macro id="requirements" />

- A Khulnasoft account logged into the [console](https://console.khulnasoft.com)
- [Owner](/identity-and-access-management/iam/concepts/#owner) status or [IAM permissions](/identity-and-access-management/iam/concepts/#permission) allowing you to perform actions in the intended Organization
- An [Object Storage bucket](https://www.khulnasoft.com/en/object-storage/)
...
8. Enter the Object Storage credentials:
    ...
    - **Access key ID:** The [access key](/identity-and-access-management/iam/how-to/create-api-keys/) of the API key used for authentication
    - **Secret key:** The [secret key](/identity-and-access-management/iam/how-to/create-api-keys/) of the API key used for authentication
    - **Region**: The region of your Object Storage bucket (`fr-par`, `nl-ams`, or `pl-waw`)

    <Lightbox src="khulnasoft-arq7_s3_credentials.webp" alt="" />
...
10. Create the new backup plan using the previously configured storage location. Click **Continue** to confirm:
    <Lightbox src="khulnasoft-arq7_choose_storage.webp" alt="" />
11. Configure an optional password to increase the security of your backups. You will need this password to decrypt your data. Tick the checkbox and enter your password and its confirmation, then click **Continue** to confirm:
    <Lightbox src="khulnasoft-arq7_password.webp" alt="" />
...
12. Click **Create** to validate the settings and to create the new backup plan:
    ...
    <Lightbox src="khulnasoft-arq7_edit_plan.webp" alt="" />

### Restoring files

1. Go to the **Restore Files** section of Arq:
    <Lightbox src="khulnasoft-arq7_restore.webp" alt="" />
2.  Expand the menu on the left to see a list of all backups. They are sorted by the time/date of their creation. Click the desired backup, and the contents of the backup appear on the right.
    ...
    <Lightbox src="khulnasoft-arq7_restore_settings.webp" alt="" />
