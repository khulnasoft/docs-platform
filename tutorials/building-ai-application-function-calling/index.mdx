...
- Access to Khulnasoft [Generative APIs](/ai-data/generative-apis/quickstart/) or to Khulnasoft [Managed Inference](/ai-data/managed-inference/quickstart/)
...
# Initialize the OpenAI client with Khulnasoft configuration
...
1. Set your Khulnasoft API key:
   ```
   export KHULNASOFT_API_KEY="your-api-key-here"
   ```

2. Set your Base URL for OpenAI client:
   ```
   export KHULNASOFT_INFERENCE_ENDPOINT_URL="your-inference-endpoint-here"
   ```
