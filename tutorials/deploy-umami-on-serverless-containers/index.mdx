---
meta:
  title: Deploying Umami web analytics on Khulnasoft Serverless Containers
  description: Discover how to deploy Umami web analytics on Khulnasoft Serverless Containers.
content:
  h1: Deploying Umami web analytics on Khulnasoft Serverless Containers
  paragraph: Discover how to deploy Umami web analytics on Khulnasoft Serverless Containers.
...
- A [Container Registry](/containers/container-registry/quickstart/)
...
4. Push the local container to your Container Registry namespace:
    ...
    ```
5. Click the **Namespace settings** tab in the **Container Registry** section of the Khulnasoft console and make sure your namespace privacy policy is set to **Public**.
    <Lightbox src="khulnasoft-umami-namespace-public.webp" alt="" />

## Deploying the Serverless Container

1. Select the namespace you want to use to deploy the application in the **Serverless Containers** section of the Khulnasoft console. If you do not have a Serverless Containers namespace yet, click **+ Create a namespace** to create a new one.
    <Lightbox src="khulnasoft-serverless-containers-namesp-list.webp" alt="" />
...
7. Set the Secrets. Secrets are an extra-secure type of environment variables that are injected into your container and stored securely:
    <Lightbox src="khulnasoft-serverless-secrets.webp" alt="" />
...
2. Copy the URL displayed for **Container Endpoint** and paste it into a web browser. The Umami login screen displays.
    <Lightbox src="khulnasoft-container-information.webp" alt="" />
3. Log in to the Umami interface using the following credentials:
    * User: `admin`
    * Password: `umami`

    <Lightbox src="khulnasoft-umami-dashboard.webp" alt="" />
...
3. Enter the name of your endpoint. You can use any domain or subdomain that you own. Click **Add Endpoint** to validate.
    <Lightbox src="khulnasoft-serverless-endpoint.webp" alt="" />
...
<Lightbox src="khulnasoft-serverless-custom-endpoint.webp" alt="" />