...
In this tutorial, you learn how to migrate an existing remote MySQL database to a [Database for PostgreSQL](https://www.khulnasoft.com/en/database/) using pgLoader and an intermediate [Development Instance](https://www.khulnasoft.com/en/cost-optimized-instances/) running Ubuntu Linux.
