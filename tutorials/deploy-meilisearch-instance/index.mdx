---
meta:
  title: Deploying Meilisearch on a Khulnasoft Instance
  description: Deploy Meilisearch on Khulnasoft Instances with this step-by-step guide to set up and run the Meilisearch search engine efficiently. Perfect for fast, relevant searches.
content:
  h1: Deploying Meilisearch on a Khulnasoft Instance
  paragraph: Deploy Meilisearch on Khulnasoft Instances with this step-by-step guide to set up and run the Meilisearch search engine efficiently. Perfect for fast, relevant searches.
...
This tutorial shows you how to deploy a Meilisearch search engine on a [Khulnasoft Instance](/compute/instances/).
...
- **Fine-tune deployment configuration** such as [Instance type or disk size](/compute/instances/reference-content/choosing-instance-type/), from the [Khulnasoft console](https://console.khulnasoft.com/instance/servers/), [the Khulnasoft API](https://www.khulnasoft.com/en/developers/api/instance/), [CLI](/compute/instances/api-cli/cli-cheatsheet/) or [Terraform](https://registry.terraform.io/providers/khulnasoft/khulnasoft/latest/docs/resources/instance_server/).

## Troubleshooting

If you encounter any issues, check that you meet all the [requirements listed at the beginning of this page](#before-you-start). Also, verify that your Instance accepts connections from your computer. To do so, you can configure [security groups](/compute/instances/how-to/use-security-groups/) or a [Public Gateway](/network/public-gateways/how-to/configure-a-public-gateway/) on the [Private Network](/compute/instances/how-to/use-private-networks/) your Instance belongs to.
