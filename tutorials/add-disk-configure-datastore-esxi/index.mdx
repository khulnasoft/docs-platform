...
categories:
  - dedibox
hero: assets/khulnasoft_add_disk.webp
dates:
...
With [Dedibox](https://www.khulnasoft.com/en/dedibox/), you have the flexibility to order [additional disks](https://www.khulnasoft.com/en/dedibox/storage/) to increase the storage capacity of your machine.
...
- A [Dedibox](https://www.khulnasoft.com/en/dedibox/) running [VMware ESXi](/tutorials/configure-virtual-machine-esxi/#installing-esxi)
...
4. Click **Customize** in the side menu:
    <Lightbox src="khulnasoft-add_disk_customize.webp" width="200" alt="" />
5. Select either an **USB disk** or an **Internal disk** for your server.
    ...
    <Lightbox src="khulnasoft-add_disk_choose_storage.webp" width="800" alt="" />
6. Select the payment method for the installation fees and validate your order.
    <Lightbox src="khulnasoft-add_disk_validate_order.webp" width="800" alt="" />

    <Message type="note">
      The disk is installed within approximately one hour from the moment you place the order.
    </Message>
8. Connect to the ESXi web interface at `https://your_khulnasoft_dedibox_ip/` and log in:
    <Lightbox src="khulnasoft-add_disk_vmware.webp" width="800" alt="" />

    The ESXi Dashboard displays.

    <Lightbox src="khulnasoft-add_disk_vmware_dashboard.webp" width="800" alt="" />
...
<Lightbox src="khulnasoft-add_disk_not_visible.webp" width="800" alt="" />
...
1. Launch an iDRAC session from the server overview in the Dedibox console:
    <Lightbox src="khulnasoft-add_disk_connect_idrac.webp" width="800" alt="" />
...
3. Click **Physical Disks** to verify that the disk is physically available:
    <Lightbox src="khulnasoft-add_disk_physical_disks.webp" width="500" alt="" />

    A list of all installed disks and their status displays at the bottom of the page.

    <Lightbox src="khulnasoft-add_disk_physical_disks_list.webp" width="800" alt="" />
...
5. Click **Create** in the menu bar to create a new virtual disk.
    <Lightbox src="khulnasoft-add_disk_virtual_disk_create.webp" width="300" alt="" />
6. Select the newly installed disk from the list. You can keep the default parameters for a basic configuration, or fine-tune them towards your needs.
    <Lightbox src="khulnasoft-add_disk_virtual_disk_settings.webp" width="800" alt="" />
...
8. Click **Overview** in the side-menu to go back to the home page of iDRAC, then click **Power Cycle System (cold boot)** to reboot the machine. The virtual disk will be configured during the boot process.
    <Lightbox src="khulnasoft-add_disk_power_cycle_system.webp" width="300" alt="" />
...
<Lightbox src="khulnasoft-add_disk_virtual_disk_created.webp" width="800" alt="" />
...
1. Click **New Datastore** on the storage dashboard of the vSphere web client:
    <Lightbox src="khulnasoft-add_disk_new_datastore.webp" width="800" alt="" />
2. Select the option **Create new VMFS datastore** and click **Next**:
    <Lightbox src="khulnasoft-add_disk_new_datastore_create.webp" width="500" alt="" />
3. Select the device from the list of available devices and enter a name for the new datastore. Then click **Next**:
    <Lightbox src="khulnasoft-add_disk_select_device.webp" width="500" alt="" />
4. Select the partitioning options. To use the full disk as datastore, choose **Use full disk**, then click **Next**:
    <Lightbox src="khulnasoft-add_disk_select_partitioning_options.webp" width="500" alt="" />
...
<Lightbox src="khulnasoft-add_disk_confirm_partition.webp" width="500" alt="" />
...
2. Select **Increase the size of an existing VMFS datastore** and click **Next**:
    <Lightbox src="khulnasoft-add_disk_increase_datastore.webp" width="800" alt="" />
3. Select the datastore to extend from the list and confirm by clicking on **Next**:
    <Lightbox src="khulnasoft-add_disk_select_datastore.webp" width="800" alt="" />
...
5. Select a partitioning configuration for the disk. To use all available disk space, go with the default settings and click **Next**:
    <Lightbox src="khulnasoft-add_disk_increase_datastore_partitioning.webp" width="800" alt="" />

    The summary displays. 
6. Check the summary settings and click **Finish**:
    <Lightbox src="khulnasoft-add_disk_ready_to_extend.webp" width="800" alt="" />
