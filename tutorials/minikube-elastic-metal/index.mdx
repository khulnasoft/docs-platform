...
meta:
  ...
  description: This page shows how to set up a Kubernetes cluster with Minikube on a Khulnasoft Elastic Metal server
content:
  h1: Setting up Kubernetes with Minikube on an Elastic Metal Server
  paragraph: This page shows how to set up a Kubernetes cluster with Minikube on a Khulnasoft Elastic Metal server
categories:
  - kubernetes
  - elastic-metal
