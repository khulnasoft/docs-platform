---
meta:
  title: Pushing metrics and logs from a Khulnasoft Instance
  description: This page shows you how to push metrics and logs from a Khulnasoft Instance
content:
  h1: Pushing metrics and logs from a Khulnasoft Instance
  paragraph: This page shows you how to push metrics and logs from a Khulnasoft Instance
...
This page shows you how to push your metrics and logs from a [Khulnasoft Instance](/compute/instances/concepts/#instance). You can also use this tutorial to **push metrics and logs from external Instances (i.e. Instances outside of Khulnasoft)**.
...
1. [Create an Instance](/compute/instances/how-to/create-an-instance/) from the **Compute** section of the Khulnasoft console.
...
We have created a [GitHub repository](https://github.com/khulnasoft/tuto-cockpit-instance/tree/main) that contains all the code you need to configure the Grafana agent, to push your data.
...
1. Open another terminal and type the following command to clone our `tuto-cockpit-instance` directory on your local machine:
            ...
            ```bash
            git clone git@github.com:khulnasoft/tuto-cockpit-instance.git
            ```
...
1. Log in to the Khulnasoft console and click **Cockpit** in the side menu.
...
4. Click the downward pointing arrow at the top right corner of your screen and select **Import dashboard**.
    <Lightbox src="khulnasoft-import-dashboard.webp" alt="" />
...
8. Select **Khulnasoft metrics** in the drop-down box and click **Import**.
    ...
    <Lightbox src="khulnasoft-metrics-display.webp" alt="" />
...
11. Click **Run query** at the top right corner of your screen. Your logs should display.
    <Lightbox src="khulnasoft-logs-display.webp" alt="" />