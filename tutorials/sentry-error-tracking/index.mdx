...
meta:
  ...
  description: Discover how to configure a Sentry monitoring & error tracking server on a Khulnasoft Instance.
content:
  h1: Configuring Sentry error tracking
  paragraph: Discover how to configure a Sentry monitoring & error tracking server on a Khulnasoft Instance.
tags: messaging apache Sentry error-tracking
categories:
  - instances
hero: assets/khulnasoft-sentry-hero.webp
dates:
...
This tutorial details how to set up a [Sentry](https://sentry.io/welcome/) self-hosted server on a Khulnasoft Instance to start error tracking in your applications.
...
<Message type="note">
  Sentry requires at least 8 GB of RAM to run. We recommend, therefore, that you use a Khulnasoft Instance with at least 4 CPU cores, 8 GB of RAM, and 20 GB of available disk space to follow this tutorial.
</Message>
...
8. Test the installation by pointing your web browser to `http://<your_instance_ip>:9000`. The Sentry login displays.
    <Lightbox src="khulnasoft-sentry_login.webp" alt="" />
...
3. Provide additional information and parameters. The Sentry Dashboard displays:
    <Lightbox src="khulnasoft-sentry_dashboard.webp" alt="" />
