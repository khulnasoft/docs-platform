...
- An [Instance](/compute/instances/how-to/create-an-instance/) running on Ubuntu Linux
...
4. Point the browser to `http://server-IP:4567`.
    <Lightbox src="khulnasoft-firstapp.webp" alt="" />
...
2. Run your little app.
    ...
    <Lightbox src="khulnasoft-firstindex.webp" alt="" />
...
4. Run your app
    ...
    <Lightbox src="khulnasoft-chansons.webp" alt="" />
