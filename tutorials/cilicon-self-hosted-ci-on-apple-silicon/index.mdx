...
content:
  h1: Getting started with Cilicon self-hosted CI on Apple silicon
...
1. Connect to your Mac Mini using [VNC](/bare-metal/apple-silicon/how-to/access-remote-desktop-mac-mini/).
