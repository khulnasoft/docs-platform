---
meta:
  title: Installing CockroachDB on Khulnasoft Instances
  description: This page shows you how to deploy a secure multi-node CockroachDB cluster on Khulnasoft, using the Khulnasoft managed load balancing service to distribute client traffic.
content:
  h1: Installing CockroachDB on Khulnasoft Instances
  paragraph: This page shows you how to deploy a secure multi-node CockroachDB cluster on Khulnasoft, using the Khulnasoft managed load balancing service to distribute client traffic.
...
This article shows you how to install CockroachDB using three nodes on a Private Network as well as a Khulnasoft Load Balancer to access the database and console.
...
Khulnasoft offers fully-managed Load Balancers to distribute traffic between Instances.
...
2. Attach the Load Balancer to the Private Network using the Private Network UUID.
    ...
    ```
3. Configure a Load Balancer IP in your DNS, using Khulnasoft Domains and DNS for example.
    ```
