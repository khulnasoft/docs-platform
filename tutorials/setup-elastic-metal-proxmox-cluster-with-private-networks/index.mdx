...
- At least 2 [Elastic Metal servers](https://www.khulnasoft.com/en/dedibox/)
- Created a [Private Network](/bare-metal/elastic-metal/how-to/use-private-networks/) and [attached](/bare-metal/elastic-metal/how-to/use-private-networks/#how-to-attach-and-detach-elastic-metal-servers-to-a-private-network) your Elastic Metal servers to it
...
1. Select your Elastic Metal server by clicking on **Elastic Metal** in the **Compute** section of the side menu of the Khulnasoft console.
...
3. Click **Install** and select **Proxmox VE 7** from the list of available images.
    <Lightbox src="khulnasoft-proxmox-image.webp" alt="" />
...
3. Click **Create** > **Linux VLAN**.
    <Lightbox src="khulnasoft-proxmox-network-dashboard.webp" alt="" />
4. Enter the VLAN details for your Private Network:
    <Lightbox src="khulnasoft-proxmox-vlan-details.webp" alt="" />
...
8. Enter your first node's `root` password and click **Join** to link the machine to the cluster.
    <Lightbox src="khulnasoft-proxmox-join-cluster.webp" alt="" />
...
<Lightbox src="khulnasoft-proxmox-cluster-created.webp" alt="" />