...
In this tutorial, you will discover how to secure your Apache web server on a Khulnasoft Instance running Ubuntu Linux. 
...
6. Open the file in a text editor:
    ...
    <Lightbox src="khulnasoft-config_apache.webp" alt="" />
...
2. Verify the certificate by opening your site in a web browser:
    <Lightbox src="khulnasoft-ssl_enabled.webp" alt="" />
