...
meta:
  ...
  description: This guide helps you migrate Docker applications to Khulnasoft Kapsule (Khulnasoft's managed Kubernetes service) with detailed instructions and troubleshooting tips.
content:
  h1: Migrating Docker workloads to Kubernetes Kapsule
  paragraph: This guide helps you migrate Docker applications to Khulnasoft Kapsule (Khulnasoft's managed Kubernetes service) with detailed instructions and troubleshooting tips.
...
This step-by-step guide will help you migrate your applications packaged in Docker containers to **Khulnasoft Kubernetes Kapsule**, Khulnasoft's managed Kubernetes service.
...
- The following tools installed:
  ...
  - [Khulnasoft CLI (optional but recommended)](https://www.khulnasoft.com/en/docs/cli/install)
...
- [Khulnasoft Container Registry](/containers/container-registry/quickstart/) (recommended)
- Other registries (e.g., Docker Hub or GitHub Container Registry)

### 2.1 Create a namespace in Khulnasoft Container Registry


1. Click **Container Registry** in the **Containers** section of the [Khulnasoft console](https://console.khulnasoft.com) side menu. If you do not have a Registry already created, the product creation page is displayed.
...
### 2.2 Authenticate Docker with Khulnasoft Registry

```
docker login rg.<region>.scw.cloud
```
<Message type="note">
  Use your **Khulnasoft credentials** when prompted.
</Message>
...
### 3.1 Create the cluster via Khulnasoft console
...
<Message type="tip">
  Refer to the [How to create a Kubernetes Kapsule cluster](/containers/kubernetes/how-to/create-cluster/) for more information.
</Message>
...
For advanced routing and SSL termination, [deploy an ingress controller](/containers/kubernetes/how-to/deploy-ingress-controller/) like **NGINX Ingress**.
```sh
...
- Use **[Khulnasoft Cockpit](/observability/cockpit/quickstart/)** for basic monitoring and metrics.
...
- Keep your [Kubernetes cluster](/containers/kubernetes/how-to/upgrade-kubernetes-version/) and applications up to date.
- Regularly check for updates to dependencies and security patches.

## Troubleshooting tips

- **Permission Issues**: If you encounter IAM permission errors, verify your Khulnasoft account permissions and ensure your IAM policies allow necessary actions.
...
- **Khulnasoft Documentation**:
  - [Kubernetes Kapsule Documentation](/compute/kubernetes/)
  - [Khulnasoft Container Registry](/containers/container-registry/)
- **Kubernetes Documentation**:
  - [Kubernetes Concepts](https://kubernetes.io/docs/concepts/)
  - [Kubectl Cheat Sheet](https://kubernetes.io/docs/reference/kubectl/cheatsheet/)
- **Community Support**:
  - [Khulnasoft Community Slack](https://slack.khulnasoft.com/)
...
- **Khulnasoft Support**: Reach out via your [Khulnasoft console support](https://console.khulnasoft.com/support) options.
- **Community Forums**: Engage with other users and Khulnasoft staff.
