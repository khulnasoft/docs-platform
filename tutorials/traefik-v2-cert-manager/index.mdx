...
hero: assets/khulnasoft_traefik.webp
categories:
  - kubernetes
  - domains-and-dns
  - load-balancer
...
- Expose [Traefik 2](https://doc.traefik.io/traefik/v2.2/) using a Khulnasoft Load Balancer
...
1. Log into the [Khulnasoft console](https://console.khulnasoft.com/) and navigate to the **Kubernetes** section under **Containers**.
...
3. Create a wildcard DNS entry (`*.mytest.com`) pointing to this IP address.
    ...
    - Using Khulnasoft’s Domains and DNS product:
        1. Navigate to the [Domains and DNS product](https://console.khulnasoft.com/domains/external/).
