---
meta:
  title: How to use Postman to manage Khulnasoft APIs
...
content:
  h1: Using Khulnasoft APIs with Postman
  paragraph: This page shows how to import Khulnasoft APIs into Postman, configure your environment variables and authentication, and share your workspace with other users.  
...
In this tutorial, you will learn how to import Khulnasoft APIs into Postman, configure your environment variables and authentication, and share your workspace with other users. 
...
## Importing Khulnasoft APIs into Postman

1. Click **Workspaces** > **Create Workspace** in the top menu of the Postman interface.
    <Lightbox src="khulnasoft-postman-create-workspace.webp" />
2. Enter a name and description and select a visibility setting for your workspace. Your workspace displays.
3. Go to the Khulnasoft [developers website](https://www.khulnasoft.com/en/developers/) and select a product API to download. 

    In this tutorial, we use the [Khulnasoft Instances API](https://www.khulnasoft.com/en/developers/api/instance/).
4. Click **Download OpenAPI**.
    <Lightbox src="khulnasoft-postman-download-open-api.webp" />
5. Click **Collections** > **Import** in the side menu of the Postman interface.
    <Lightbox src="khulnasoft-postman-import.webp" />
...
In this section, we show you how to create an environment with environment variables for a Khulnasoft Project.
...
3. Configure your variables, as such:
    ...
    <Lightbox src="khulnasoft-postman-add-variables.webp" />
...
3. Select your environment in the top right menu.
    <Lightbox src="khulnasoft-postman-select-environment.webp" />
...
4. Edit the `{zone}` variable in the endpoint. In this tutorial, we will create our Instance in `fr-par-1`.
    <Lightbox src="khulnasoft-postman-endpoint.webp" />
...
5. Edit the parameters in the request with your preferences following the example below. In this tutorial, we will create a GP1-M instance with the default local volume.
    <Message type="note">
      - For more information on how to fill out the parameters, refer to the [Khulnasoft Developers website](https://www.khulnasoft.com/en/developers/api/instance/#path-instances-create-an-instance).
    ...
    ```
6. Click **Send**.
    <Lightbox src="khulnasoft-postman-response.webp" />
