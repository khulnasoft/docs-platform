---
meta:
  title: One-click Docker deployment on Khulnasoft Instances using InstantApp
  description: Discover how to use the Docker InstantApp on your Khulnasoft Instance. Unlock the power of containerization with Docker, and follow our step-by-step instructions for deployment and management of your applications.
content:
  h1: One-click Docker deployment on Khulnasoft Instances using InstantApp
  paragraph: Discover how to use the Docker InstantApp on your Khulnasoft Instance. Unlock the power of containerization with Docker, and follow our step-by-step instructions for deployment and management of your applications.
...
<Lightbox src="khulnasoft-docker_app_running.webp" alt="" />
...
In this example, the public Docker registry is used ("Docker Hub"), but it is also possible to set up a [private registry](https://docs.docker.com/registry/deploying/) to distribute the image on your infrastructure, or to use the [Khulnasoft Container Registry](/containers/container-registry/quickstart/).
