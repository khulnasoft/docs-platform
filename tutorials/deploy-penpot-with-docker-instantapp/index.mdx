...
dates:
  ...
  posted: 2022-09-28
hero: assets/khulnasoft-penpot.webp
---
...
1. Click **Instances** in the **Compute** section of the [Khulnasoft console](https://console.khulnasoft.com/organization) side menu. Then [deploy](/compute/instances/how-to/create-an-instance/) a new Instance using the [Docker InstantApp](https://console.khulnasoft.com/instance/servers/create?area=fr-par-1&imageKey=c1b530d8-0ca0-45c4-80db-ba06608287b2&offerName=PLAY2-MICRO).
...
3. Open a web browser on your local computer and point it to your Penpot domain. The login screen displays.
    <Lightbox src="khulnasoft-penpot-login.webp" alt="" />
4. Log in using the credentials of the previously created user. The Penpot dashboard displays. You can now start designing your assets. 
    <Lightbox src="khulnasoft-penpot-dashboard.webp" alt="" />
