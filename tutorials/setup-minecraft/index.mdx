---
meta:
  title: Creating your own Minecraft server on Khulnasoft
  description: This page shows you what steps are required to host your own Minecraft server on a Khulnasoft Instance.
content:
  h1: Creating your own Minecraft server on Khulnasoft
  paragraph: This page shows you what steps are required to host your own Minecraft server on a Khulnasoft Instance.
...
The Minecraft server is a Java application and runs perfectly on [Khulnasoft Instances](https://www.khulnasoft.com/en/virtual-instances/), allowing you to deploy your own Minecraft Instance in just a few minutes.
...
Deploying your own Minecraft server can be done in a few easy steps on a [Khulnasoft Development Instance](https://www.khulnasoft.com/en/cost-optimized-instances/). In case you do not have an Instance yet, start by [deploying your first Instance](/compute/instances/how-to/create-an-instance/).
...
5. Congratulations! You are now connected to your own Minecraft server:
    <Lightbox src="khulnasoft-minecraft_game.webp" alt="" />