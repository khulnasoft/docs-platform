---
meta:
  title: Setting up a Django Web Framework on a Khulnasoft Production-Optimized Instance running Ubuntu 20.04 LTS (Focal Fossa)
  description: This page shows how to install Django web framework on Ubuntu 20.04 LTS (Focal Fossa)
content:
  h1: Setting up a Django Web Framework on a Khulnasoft Production-Optimized Instance running Ubuntu 20.04 LTS (Focal Fossa)
...
- An [Instance](/compute/instances/how-to/create-an-instance/) running on Ubuntu 20.04 LTS (Focal Fossa) or later
...
9. Answer the prompts which will ask for:
    ...
    * A password (containing at least 8 characters)
    ...
    Username (leave blank to use 'root'): khulnasoft
