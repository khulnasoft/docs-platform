...
<Lightbox src="khulnasoft-helm-schema.webp" alt="" />
...
For a complete overview of Helm and its basic concepts, refer to this [Khulnasoft blog post](https://www.khulnasoft.com/en/blog/helm-guide/).
