---
meta:
  title: One-click WordPress deployment on Khulnasoft Instances using InstantApp
  description: Easily start your own blog with one click using the WordPress InstantApp on Khulnasoft Instances. Follow our complete guide for quick and seamless WordPress deployment.
content:
  h1: One-click WordPress deployment on Khulnasoft Instances using InstantApp
  paragraph: Easily start your own blog with one click using the WordPress InstantApp on Khulnasoft Instances. Follow our complete guide for quick and seamless WordPress deployment.
...
This guide demonstrates how to quickly deploy a WordPress application in seconds using Khulnasoft's InstantApp.
...
When defining the `weblog_title` tag on the console, it is not possible to have spaces in the title of the weblog. This is only feasible when using the CLI. Refer to our tutorial on [creating a WordPress Instance using the Khulnasoft CLI](/tutorials/create-wordpress-instances-cli/) to create an Instance with the Khulnasoft CLI.
...
2. Click **Create Instance**. The [Instance creation wizard](https://console.khulnasoft.com/instance/servers/create) displays.
...
To avoid spam, remote mail ports cannot be reached from our infrastructure by default. As WordPress requires sending mail, we need to open them. Your account needs to be validated to perform this operation. [Contact our assistance](https://console.khulnasoft.com/support/) to get your account reviewed.
...
2. Click **Create security group** and enter the security group's name and description.
    <Lightbox src="khulnasoft-nc-new-sg.webp" alt="" />
...
5. Fill in the required information and click **Install WordPress**.
    ...
    <Lightbox src="khulnasoft-wp-configuration.webp" alt="" />
...
6. On the login page, enter your username and password, and click **Log In**.
    <Lightbox src="khulnasoft-wplogin.webp" alt="" />
7. You are now connected to your blog and can start using it.
    <Lightbox src="khulnasoft-wp.webp" alt="" />