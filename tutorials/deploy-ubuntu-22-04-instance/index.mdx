---
meta:
  title: Deploying an Ubuntu 22.04 LTS (Jammy Jellyfish) Instance on Khulnasoft
  description: In this tutorial, you will learn how to deploy, update, and manage a Ubuntu 22.04 LTS (Jammy Jellyfish) Instance on Khulnasoft.
content:
  h1: Deploying an Ubuntu 22.04 LTS (Jammy Jellyfish) Instance on Khulnasoft
  paragraph: In this tutorial you will learn how to deploy an Ubuntu 22.04 LTS (Jammy Jellyfish) Instance on Khulnasoft.
...
In this tutorial, you learn how to deploy an Instance with Ubuntu 22.04 LTS (Jammy Jellyfish) from the Khulnasoft console and configure it for hosting your apps and websites.
...
- Basic knowledge of [Linux commands](/dedibox/dedicated-servers/reference-content/basic-linux-commands/)

## Deploying your Ubuntu Linux Instance from the Khulnasoft console

1. Click **Instances** in the **Compute** section of the side menu. The [Instance creation page](https://console.khulnasoft.com/instance/servers/create) displays.
2. Configure your Instance:
    * Choose an Availability Zone
        * An Availability Zone refers to the geographical location in which your Instance will be created.
    * Select the Instance type
        * Khulnasoft provides different Instance types, designed for specific use cases. Choose the configuration that fits your requirements.
    ...
    * Check your [SSH key](/identity-and-access-management/organizations-and-projects/how-to/create-ssh-key/) displays in the list of keys authorized to access the Instance
...
2. Navigate to the **SSH command** section and click **Copy** to copy the command into the clipboard.
    <Lightbox src="khulnasoft-instance-information-ssh.webp" />
