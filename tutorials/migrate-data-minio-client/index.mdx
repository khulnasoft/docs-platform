---
meta:
  title: Migrating Khulnasoft Object Storage data with MinIO client
  description: This page shows you how to migrate Khulnasoft Object Storage data from one region to another with MinIO client
content:
  h1: Migrating Khulnasoft Object Storage data with MinIO client
  paragraph: This page shows you how to migrate Khulnasoft Object Storage data from one region to another with MinIO client
categories:
  - instances
  - object-storage
...
- [Object Storage buckets](/storage/object/how-to/create-a-bucket/) in two different regions
...
2. Optionally, add other providers:
    ...
    For Google Cloud Storage:
      ...
      ```
3. Create the buckets you need on the Khulnasoft Object Storage:
    ```
...
4. Start the migration of your data:
    ...
    The commands above:
      1.  Migrates data from an Amazon S3-compatible Object Storage to Khulnasoft's **fr-par** Object Storage
      2.  Migrates data from GCS Object Storage to Khulnasoft's **nl-ams** Object Storage
    ...
    <Lightbox src="khulnasoft-mc.webp" alt="" />
