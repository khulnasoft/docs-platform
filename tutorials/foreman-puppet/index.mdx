...
1. Connect to the Instance using SSH:
  ...
  To retrieve the Instance's IP, list your existing servers using `scw ps` (Khulnasoft CLI). For more information on the Khulnasoft CLI, refer to the tutorial on the [Khulnasoft Command Line Interface](https://github.com/khulnasoft/khulnasoft-cli/).

  The Instance's IP can also be retrieved from the Khulnasoft console. Once logged in, check the **IP addresses** in the **Instances** tab of the left menu.
...
<Lightbox src="khulnasoft-foreman_login.webp" alt="" />
...
<Lightbox src="khulnasoft-dashboard.webp" alt="" />
...
2. When connected to the Foreman web UI, click **Configure**> **Puppet**> **Classes**:
    <Lightbox src="khulnasoft-configure_classes.webp" alt="" />
3. Click the `Import environments from foreman.example.com` button.
    <Lightbox src="khulnasoft-import.webp" alt="" />
...
4. Tick the NTP checkbox next to the item and click **Update** to import the NTP module.
    <Lightbox src="khulnasoft-ntp_prod.webp" alt="" />
...
3. Scroll down to find the **servers** item in the left sidebar, and select it.
    <Lightbox src="khulnasoft-ntp_servers.webp" alt="" />
...
2. Click **Edit** on the far right of your Foreman host.
    <Lightbox src="khulnasoft-hosts.webp" alt="" />
3. Click the **Puppet Classes** tab. Within the Available Classes section, click the ntp class, then click the plus sign next to "ntp":
    <Lightbox src="khulnasoft-ntp_add.webp" alt="" />
    ...
    <Lightbox src="khulnasoft-ntp_included.webp" alt="" />
...
After editing Foreman host's configuration, a redirection to Foreman host's summary page applies.
  ...
  <Lightbox src="khulnasoft-hosts_dashboard.webp" alt="" />
