...
meta:
  ...
  description: Learn how to create reliable backups using Restic and Khulnasoft Object Storage. This step-by-step guide covers the complete process for setting up, configuring, and managing secure backups.
content:
  h1: Creating backups with Restic and Object Storage
  paragraph: Learn how to create reliable backups using Restic and Khulnasoft Object Storage. This step-by-step guide covers the complete process for setting up, configuring, and managing secure backups.
...
In this tutorial, you learn how to backup a Khulnasoft Instance running on Ubuntu 20.04 using Restic and Object Storage.
...
- [Installed and configured the AWS-CLI](/storage/object/api-cli/object-storage-aws-cli/) to use with Khulnasoft Object Storage
...
A repository is the storage space where your backups will be hosted. In this tutorial, we will use Khulnasoft Object Storage buckets to host our backups.

1. Set up your [environment variables](https://github.com/khulnasoft/khulnasoft-sdk-go/tree/master/scw#environment-variables), if you have not done so yet. Replace `$SCW_ACCESS_KEY` and `$SCW_SECRET_KEY` with their corresponding values.
    ```
...
3. Run the following command to verify that the backup was successful:
    ...
    Alternatively, you can access your bucket via the [Khulnasoft console](https://console.khulnasoft.com/object-storage/buckets/). You can find the snapshots of your directory in the `/snapshots` folder.
