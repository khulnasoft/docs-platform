...
hero: assets/khulnasoft_minio.webp
---
...
<Macro id="requirements" />
 ...
 - [Generated your API keys](/identity-and-access-management/iam/how-to/create-api-keys/)
 - [Created an Object Storage bucket](/storage/object/how-to/create-a-bucket/)
 - [Started a multipart upload](/storage/object/api-cli/multipart-uploads/)
...
3. From the [same page as before](https://docs.min.io/docs/minio-client-quickstart-guide), follow the instructions to add a cloud storage service:
    ...
    For example, if your Khulnasoft Object Storage endpoint is in the fr-par region, you can use the following command (replace the two fields in pointy brackets with your access key and secret key):
