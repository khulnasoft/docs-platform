---
meta:
  title: Installing Odoo on Kubernetes with the Khulnasoft Easy Deploy feature
  description: Discover how to effortlessly install Odoo, a powerful suite of open-source business apps, on Khulnasoft Kubernetes Kapsule with Easy-Deploy in this tutorial.
content:
  h1: Installing Odoo on Kubernetes with the Khulnasoft Easy Deploy feature
  paragraph: Discover how to install Odoo, a powerful suite of open-source business apps, on Khulnasoft Kubernetes Kapsule with Easy-Deploy in this tutorial.
tags: kubernetes Odoo easy-deploy docker
hero: assets/khulnasoft_odoo_easydeploy.webp
dates:
...
But how can you initiate your Odoo journey? Our guide will walk you through the process of setting up Odoo on a [Khulnasoft Kubernetes Kapsule](/containers/kubernetes/quickstart/) using the [easy-deploy](/containers/kubernetes/how-to/enable-easy-deploy/) feature, easily accessible right from the [Khulnasoft console](https://console.khulnasoft.com). In minimal time, you will have Odoo up and operational, primed to advance your business endeavors. Just adhere to the steps outlined in the sidebar on the right to get started.
...
## Creating a Khulnasoft Container Registry namespace

1. Go to the **Container Registry** dashboard in the [Khulnasoft console](https://console.khulnasoft.com), and click **Create a namespace**.
    <Lightbox src="khulnasoft-registry_home.webp" alt="" />
...
3. Check the summary, then click **Create a namespace**.
    <Lightbox src="khulnasoft-create-namespace.webp" alt="" />

    The following screen displays:

    <Lightbox src="khulnasoft-namespace-created.webp" alt="" />

## Using Docker to get the official Odoo image and pushing it to your Khulnasoft Container Registry
...
5. Wait a minute, then go to the Container Registry dashboard to make sure the image has been successfully created.
    <Lightbox src="khulnasoft-image-pushed.webp" alt="" />
...
1. Go to the Kubernetes dashboard in the Khulnasoft console.
2. Click **Create a cluster**.
    <Lightbox src="khulnasoft-kapsule_splashscreen.webp" alt="" />
3. Enter the required information:
    ...
    <Lightbox src="khulnasoft-create-cluster.webp" alt="" />
...
1. Go to the **Database** dashboard, in the Khulnasoft console.
2. Click **Create an Instance**.
    <Lightbox src="khulnasoft-db-create-instance.webp" alt="" />
3. Enter your Database Instance information. Select **PostgreSQL-12** as your database engine. Select your **region** and **node type** (we recommend minimum `DB-DEV-L`).
    <Lightbox src="khulnasoft-create-db1.webp" alt="" />
4. Enter a **username** and **password** in the **Credentials** section. Then, enter a **name** for your Database Instance. Note all of these down as you will need them in a future step.
    <Lightbox src="khulnasoft-create-db2.webp" alt="" />
5. Check the summary and click **Create an Instance**.
    <Lightbox src="khulnasoft-create-db3.webp" alt="" />
    ...
    <Lightbox src="khulnasoft-db-created.webp" alt="" />
...
1. Go to the **Kubernetes** dashboard in the Khulnasoft console and select the cluster you created and deployed your Odoo image on.
    <Lightbox src="khulnasoft-edit-cluster.webp" alt="" />
2. Click the **Easy Deploy** tab. Then click <Icon name="[more]" /> **> Edit** next to your Odoo container.
    <Lightbox src="khulnasoft-edit-cluster2.webp" alt="" />
...
4. Under **Container port to expose**, enter `80:8069` and click **Add**.
    ...
    <Lightbox src="khulnasoft-expose-port.webp" alt="" />
...
6. Click **Add Variable** under **Environment Variables**. Add four variables.
    <Lightbox src="khulnasoft-edit-container2.webp" alt="" />
...
8. Click **Update Container**. The container information page displays.
    <Lightbox src="khulnasoft-update-container.webp" alt="" />
9. Click **Load Balancer** on the side menu of the Khulnasoft console. A list of your Load Balancers displays.
    <Lightbox src="khulnasoft-load-balancer1.webp" alt="" />
10. Click the name of the Load Balancer you added. Take note of the Load Balancer IP.
    <Lightbox src="khulnasoft-load-balancer2.webp" alt="" />
...
1. Enter the `Load Balancer IP` in a new browser window. It will take you to the Odoo landing page:
    <Lightbox src="khulnasoft-odoo-landing1.webp" alt="" />
2. Enter the required information:
    ...
    <Lightbox src="khulnasoft-odoo-landing2.webp" alt="" />

    The application may take a few minutes to launch.

    <Lightbox src="khulnasoft-odoo-demo.webp" alt="" />
