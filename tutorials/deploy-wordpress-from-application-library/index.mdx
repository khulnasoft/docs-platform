---
meta:
  title: Deploying WordPress on a Khulnasoft Kubernetes cluster with the Application Library
  description: Learn how to deploy WordPress on Kubernetes using the Easy Deploy feature in a few clicks
content:
  h1: Deploying WordPress on a Khulnasoft Kubernetes cluster with the Application Library
...
This tutorial teaches you how to install WordPress on a Khulnasoft Kubernetes Kapsule or Kosmos cluster by using the [Application Library in the Easy-Deploy feature](/containers/kubernetes/how-to/enable-easy-deploy/).

You can perform most of these steps directly from the Khulnasoft console.

<Macro id="requirements" />

- A Khulnasoft account logged into the [console](https://console.khulnasoft.com)
- [Owner](/identity-and-access-management/iam/concepts/#owner) status or [IAM permissions](/identity-and-access-management/iam/concepts/#permission) allowing you to perform actions in the intended Organization
- A Khulnasoft [Kubernetes Kapsule or Kosmos cluster](/containers/kubernetes/how-to/create-cluster/)
- Installed [kubectl](/containers/kubernetes/how-to/connect-cluster-kubectl/) on your local computer

## Creating a Kubernetes Kapsule cluster and deploying WordPress

1. Go to the [Kubernetes dashboard](https://console.khulnasoft.com/kapsule/clusters) in the Khulnasoft console.
2. Select the cluster you want to deploy WordPress to.
3. Select the **Easy Deploy** tab.
    <Lightbox src="khulnasoft-kubernetes-easy-deploy.webp" alt="" />
...
5. Select **Application Library** as the application type.
    <Lightbox src="khulnasoft-kubernetes-deploy-app.webp" alt="" />
6. Search for the application you want to deploy using the search bar.
    <Lightbox scr="khulnasoft-kubernetes-wordpress-app.webp" alt="" />
    ...
    <Lightbox src="khulnasoft-kubernetes-yaml-editor.webp" alt="" />
...
8. Once configured, click **Deploy an application** to deploy your application on your Kubernetes cluster.
    <Lightbox src="khulnasoft-kubernetes-deploy-app-summary.webp" alt="" />

    You are then redirected to the listing page of our deployed applications.

    <Lightbox src="khulnasoft-kubernetes-deployed-apps-list.webp" alt="" />
9. Check that the deployment is successful by running the command `kubectl get all -n cms-ns` in your terminal.
    ...
    You can see that your WordPress application is running, and has even created a [MariaDB](https://mariadb.org/) database within your cluster to store our data on [Khulnasoft Block Storage](https://www.khulnasoft.com/en/object-storage/).
