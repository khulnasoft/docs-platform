...
meta:
  ...
  description: This page shows you how to configure an SMTP relay with Khulnasoft's Transactional Email and Postfix
content:
  h1: Configuring an SMTP relay with Transactional Email and Postfix
  paragraph: This page shows you how to configure an SMTP relay with Khulnasoft's Transactional Email and Postfix
...
- Opened [the mail ports on your Instance](/compute/instances/how-to/send-emails-from-your-instance/)
...
Some providers do not let you access port 587. To solve this issue, Khulnasoft offers non-standard ports that are unlikely to be blocked: `2587` (SMTP) and `2465` (TLS). A workaround is to use `stunnel` to be able to use Postfix.

<Message type="important">
 If you are sending emails from an Instance, you must [open your Instance's mail ports](/compute/instances/how-to/send-emails-from-your-instance/).
</Message>
