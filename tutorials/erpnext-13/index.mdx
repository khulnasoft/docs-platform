---
meta:
  title: Deploying ERPNext 13 at Khulnasoft on Ubuntu 20.04 LTS (Focal Fossa)
...
content:
  h1: Deploying ERPNext 13 at Khulnasoft on Ubuntu 20.04 LTS (Focal Fossa) 
...
This tutorial will show you how to deploy ERPNext 13 on a Khulnasoft machine running Ubuntu Focal Fossa (20.04 LTS). This could be a [Dedibox](https://www.khulnasoft.com/en/dedibox/), an [Instance](https://www.khulnasoft.com/en/virtual-instances/) or an [Elastic Metal server](https://www.khulnasoft.com/en/elastic-metal/).
...
7. Enter information about what your company does, your bank's name, the charts template to use, as well as information on your financial year. Then click **Complete Setup**:
    ...
    <Lightbox src="khulnasoft-erpnext-getting-started-13.webp" width="900" alt="" />
