...
meta:
  ...
  description: This page shows how to set up a Focalboard project-management tool on Cost-Optimized Khulnasoft Instances running Ubuntu Linux
content:
  h1: Project management for technical teams with Focalboard on Ubuntu Instances
  paragraph: This page shows how to set up a Focalboard project-management tool on Cost-Optimized Khulnasoft Instances running Ubuntu Linux
...
Your Focalboard Instance is now ready. You can open a web browser on your local computer and point it to your Focalboard domain — the Login screen displays. Click **Create an account** to create your first account and start using your Instance.
    <Lightbox src="khulnasoft-focalboard-splash.webp" alt="" />
