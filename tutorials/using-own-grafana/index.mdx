...
In this tutorial, you will learn how to use your own Grafana with [Khulnasoft's Cockpit](/observability/cockpit/quickstart/) service. In this tutorial, we are using Grafana version 9.5.1.
...
1. From the Grafana homepage, click **Add your first data source**.
      <Lightbox src="khulnasoft_cockpit_tuto_data_source.webp" alt="" />
2. Select the Prometheus data source in the list that displays.
3. Retrieve the URL of the metrics data source you want to add from the [Data sources tab](https://console.khulnasoft.com/cockpit/dataSource) of the Khulnasoft console. Make sure that the region in the URL is the one where your data source is located.
...
3. Retrieve the URL of the logs data source you want to add from the [Data sources tab](https://console.khulnasoft.com/cockpit/dataSource) of the Khulnasoft console.
...
3. Retrieve the URL of the traces data source you want to add from the [Data sources tab](https://console.khulnasoft.com/cockpit/dataSource) of the Khulnasoft console.
4. Paste your logs' URL in the **URL** field of the **HTTP** section.
