...
meta:
  ...
  description: Discover how to use Terraform to configure your Khulnasoft Cockpit. This detailed guide walks you through creating a token, setting up a Grafana user, and configuring Khulnasoft and custom data sources.
content:
...
Open a terminal on your local machine and clone the `cockpit-terraform` repository containing the Terraform configuration file:
    ...
    ```
    git clone git@github.com:khulnasoft/cockpit-terraform.git
    ```
...
2. Replace `xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx` line 5, with your Khulnasoft Project ID.
...
3. Run the following command to deploy your infrastructure. Terraform generates an execution plan showing you what actions are about to be performed.
    ...
    Terraform will perform the following actions:
      ...
      # khulnasoft_cockpit.main will be created
      + resource "khulnasoft_cockpit" "main" {
      ...
      # khulnasoft_cockpit_grafana_user.main will be created
      + resource "khulnasoft_cockpit_grafana_user" "main" {
          + id         = (known after apply)
      ...
      # khulnasoft_cockpit_source.main will be created
      + resource "khulnasoft_cockpit_source" "main" {
      ...
      # khulnasoft_cockpit_token.main will be created
      + resource "khulnasoft_cockpit_token" "main" {
          + created_at = (known after apply)
          + id         = (known after apply)
...
1. Click **Cockpit** in the Observability section of the [console](https://console.khulnasoft.com). The Cockpit overview page displays.
