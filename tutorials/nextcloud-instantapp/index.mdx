---
meta:
  title: One-click NextCloud deployment on Khulnasoft Instances using InstantApp
  description: Learn how to deploy NextCloud on Khulnasoft Instances in seconds with our step-by-step guide. Start using NextCloud quickly and efficiently with Khulnasoft's InstantApp.
content:
  h1: One-click NextCloud deployment on Khulnasoft Instances using InstantApp
  paragraph: Learn how to deploy NextCloud on Khulnasoft Instances in seconds with our step-by-step guide. Start using NextCloud quickly and efficiently with Khulnasoft's InstantApp.
...
2. The MySQL user, password, and database name are shown in the MOTD message that displays upon your first connection to the server:
    ...
    Getting started with: https://www.khulnasoft.com/en/docs/tutorials/nextcloud-instantapp/
...
4. Enter a username and password (of your choice) as well as the database credentials shown in the MOTD of your Instance. Leave the database host as `localhost`. Then click **Install**.
    <Lightbox src="khulnasoft-instantapp-nextcloud-install.webp" alt="" />
    <Message type="note">
...
<Lightbox src="khulnasoft-instantapp-nextcloud-splash.webp" alt="" />
