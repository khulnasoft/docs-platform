...
- An [Instance](/compute/instances/how-to/create-an-instance/) running Ubuntu Bionic
...
1. Connect to your server using SSH:
    ...
    If you do not know your server IP, you can list your existing servers using `scw ps` (Khulnasoft CLI). For more information on the Khulnasoft CLI, refer to the tutorial on the [Khulnasoft Command Line Interface](https://www.khulnasoft.com/docs/manage-cloud-servers-with-khulnasoft-cli/).

    The server IP can also be retrieved from the Khulnasoft console. Once logged in, check the **IP Adresses** in the **Servers** tab of the left menu.
...
8. To make Ansbile work with Python 3, specify the Python interpreter in a var or the inventory.
    ...
    <Message type="important">
      Under **Credentials**, paste your SSH key in the Khulnasoft console and click **Use this SSH key**.
    </Message>
