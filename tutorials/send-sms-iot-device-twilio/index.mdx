...
1. Create a Twilio account on [their website](https://www.twilio.com).
    <Lightbox src="khulnasoft-twilio-signup.webp" alt="" />
...
3. If you want to add another verified phone number, go to [Verified Caller IDs](https://www.twilio.com/console/phone-numbers/verified).
    ...
    <Lightbox src="khulnasoft-twilio-welcome-dashboard.webp" alt="" />

    <Lightbox src="khulnasoft-twilio-get-phone-number.webp" alt="" />
4. Head to the [Messaging / Setting Started](https://www.twilio.com/console/sms/getting-started/build) page and click `Show your Auth Token`.
    ...
    <Lightbox src="khulnasoft-twilio-try-sms.webp" alt="" />
...
1. Head to the [Serverless section](https://console.khulnasoft.com/serverless/) of your Khulnasoft console and create a new Namespace.
2. Once done, create a new function, set `python3` as the runtime, paste the following code in the code editor, choose any name for your function, leave everything else with the default settings, and click create.
    ...
    params = urllib.parse.urlencode({
        'From': smsFrom,
        'To': smsTo,
        'Body': 'This is an alert from Khulnasoft IoT Hub!'
        }).encode('ascii')
...
1. Create an IoT Hub in the [IoT Hub section](https://console.khulnasoft.com/iot-hub/hubs) of the Khulnasoft console.
...
3. Verify on your phone that the message was received.
    ...
    For more information about Khulnasoft IoT Hub refer to our [product documentation](/managed-services/iot-hub/concepts/).