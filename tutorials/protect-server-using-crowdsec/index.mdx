...
<Lightbox src="khulnasoft-crowdsec-ecosystem.webp" alt="" />
...
- [Created](/dedibox/dedicated-servers/how-to/order-a-server/) a Dedibox server and [installed Debian](/dedibox/dedicated-servers/how-to/install-a-server/) on it
- [Connected](/dedibox/dedicated-servers/how-to/connect-to-server/#how-to-connect-via-ssh) to your Dedibox via SSH as `root`
...
<Lightbox src="khulnasoft-crowdsec-dashboard.webp" alt="" />
