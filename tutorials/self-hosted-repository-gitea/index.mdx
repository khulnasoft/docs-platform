...
meta:
  ...
  description: This page shows you how to configure Gitea a lightweight code hosting solution on a Khulnasoft Instance.
content:
  h1: Setting up a self-hosted git repository with Gitea
  paragraph: This page shows you how to configure Gitea a lightweight code hosting solution on a Khulnasoft Instance.
categories:
  - instances
...
5. In a web browser go to `http://<your_instance_ip>:3000/` to access the Gitea application:
    <Lightbox src="khulnasoft-gitea_app.webp" alt="" />
...
9. Once the form has been submitted, you are logged into your Gitea account:
    <Lightbox src="khulnasoft-gitea_dashboard.webp" alt="" />
