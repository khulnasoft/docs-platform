...
- An [Instance](/compute/instances/how-to/create-an-instance/) running Ubuntu Focal Fossa (20.04) or later
...
8. When typing *http://example.com* in your browser, you should see your newly created placeholder page:
    <Lightbox src="khulnasoft-example_site.webp" alt="" />
...
<Lightbox src="khulnasoft-example_https.webp" alt="" />