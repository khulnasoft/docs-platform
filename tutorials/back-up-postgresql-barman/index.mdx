...
- Two [Instances](/compute/instances/how-to/create-an-instance/) running a [PostgreSQL database](/tutorials/install-postgresql/) on Ubuntu Bionic or a later version
