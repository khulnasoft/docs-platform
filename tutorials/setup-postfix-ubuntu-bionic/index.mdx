...
content:
  h1: Setting up a secure mail server on Ubuntu 22.04 LTS (Jammy Jellyfish)
  paragraph: This page explains how to set up a mail server on Ubuntu 22.04 LTS (Jammy Jellyfish).
categories:
  - instances
...
5. Retrieve the DKIM public key for your domain:
   ...
   Refer to [How to manage DNS records](/network/domains-and-dns/how-to/manage-dns-records/) for furher information.
