...
content:
  ...
  paragraph: This tutorial shows you how to get started with Python lists and dictionaries, and is aimed at complete beginners who do not necessarily have any coding experience.
tags: python loops
categories:
  - compute
dates:
...
<Lightbox src="khulnasoft-python-list.webp" alt="a 2 by 5 table shows 0, 1, 2, 3, 4 across the top row and 99, 68, 72, 50, 72 across the bottom row" />
...
3. Display the list of class_marks, and see the following output:
    ...
    <Lightbox src="khulnasoft-python-list-reverse-index.webp" alt="a 2 by 5 table shows -5, -4, -3, -2, -1 across the top row and 99, 67, 72, 50, 72 across the bottom row" />
