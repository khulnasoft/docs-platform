---
meta:
  title: Deploying a documentation website with Docusaurus on Khulnasoft
  description: In this tutorial, you will learn how to deploy a documentation website to Khulnasoft Object Storage with Docusaurus and GitHub runners.
content:
  h1: Deploying a documentation website with Docusaurus on Khulnasoft
  paragraph: In this tutorial, you will learn how to deploy a documentation website to Khulnasoft Object Storage with Docusaurus and GitHub runners.
...
- An [Object Storage bucket](/storage/object/how-to/create-a-bucket/) with the [bucket website feature](/storage/object/how-to/use-bucket-website/) enabled
...
2. Type the following command in the terminal to generate a new Docusaurus site:
    ...
    * A name for your new site (for example: `docusaurus-on-khulnasoft`)
    ...
    * Confirm that you want to use the TypeScript version of the template by typing `y`.
    ```
    ✔ What should we name this site? … docusaurus-on-khulnasoft
...
7. Add the Docusaurus files to your repository, commit, and push the changes:
    ...
    ```
### Deploying to Khulnasoft Object Storage
...
3. Click **Secrets** > **Actions** in the side menu. A list of the Actions' secrets displays. GitHub Secrets are encrypted data of sensitive information. They are used here to store the Khulnasoft secret key and access key.
...
10. Copy the following code in the text editor, keep the default file name `main.yml` and click **Start commit**:
    ...
    ```
    <Message type="note">
      The GitHub Action used to deploy the Docusaurus site on Khulnasoft Object Storage is forked from [turnerlabs/s3-docusaurus-sync-action](https://github.com/turnerlabs/s3-docusaurus-sync-action).
    </Message>
...
The GitHub runner will run Docusaurus and build your website. It will then deploy it on your Khulnasoft Object Storage.
