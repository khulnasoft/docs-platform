---
meta:
  title: Deploying NextCloud with Khulnasoft Object Storage
  description: This page shows how to deploy and configure NextCloud with Khulnasoft Object Storage
content:
  h1: Deploying NextCloud with Khulnasoft Object Storage
  paragraph: This page shows how to deploy and configure NextCloud with Khulnasoft Object Storage
categories:
  - object-storage
  - instances
...
Combining NextCloud with Khulnasoft Object Storage gives you infinite storage space for your personal cloud.
...
1. Retrieve your `ACCESS-KEY` and `SECRET-KEY` from the [Khulnasoft console](https://console.khulnasoft.com/project/credentials/).
...
4. Save the configuration file, close the text editor, and open the NextCloud web interface in a browser. NextCloud uses Object Storage for storing files now:
    <Lightbox src="khulnasoft-nextcloud-obstorage.webp" alt="" />
...
2. From the NextCloud interface, click **Apps** in the drop-down menu to access the list of available apps:
    <Lightbox src="khulnasoft-nc_apps.webp" alt="" />
3. Enable the **External Storage Service** by clicking on **Enable**:
    <Lightbox src="khulnasoft-nc_external_storage_enable.webp" alt="" />
4. Click **Settings** in the drop-down menu, then on **External Storages** in the **Administration** section of the page:
    <Lightbox src="khulnasoft-nc_admin_ext_storage.webp" alt="" />
5. Configure the credentials for your bucket:
    <Lightbox src="khulnasoft-nc_config_storage.webp" alt="" />

    - `Bucket` = The Name of your bucket
    - `Hostname` = The hostname of the bucket (For Khulnasoft Object Storage in Amsterdam: `s3.nl-ams.scw.cloud`, for Khulnasoft Object Storage in Paris: `s3.fr-par.scw.cloud` for Warsaw: `s3.pl-waw.scw.cloud`)
...
6. Click the **file icon**, then on **External Storages** to access your bucket:
    <Lightbox src="khulnasoft-nc_external_storage_files.webp" alt="" />
