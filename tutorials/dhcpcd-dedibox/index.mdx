---
meta:
  title: Configuring DHCPCD on a Khulnasoft Dedibox
  description: DHCPCD is an open-source DHCP client, supporting both IPv4 and IPv6.
content:
  h1: Configuring DHCPCD on a Khulnasoft Dedibox
...
In this tutorial, you will learn how to configure your IPv6 subnet with DHCPCD on a Khulnasoft Dedibox dedicated server.
...
Your server is now ready to communicate with IPv6. For more information about IPv6 at Khulnasoft Dedibox, refer to our [dedicated documentation](/dedibox-network/ipv6/quickstart/).