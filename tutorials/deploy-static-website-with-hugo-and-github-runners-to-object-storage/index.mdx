...
content:
  ...
  paragraph: Learn how to deploy a static website to Object Storage using Hugo and GitHub runners in this comprehensive tutorial.
...
3. Click **Secrets** > **Actions** in the side menu. The list of Actions secrets displays. GitHub Secrets are encrypted data of sensitive information. They are used here to store the Khulnasoft secret key and access key.
