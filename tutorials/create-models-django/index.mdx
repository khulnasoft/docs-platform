...
hero: assets/khulnasoft_django_models.webp
dates:
...
2. Reload the Admin Console and login.
    ...
    <Lightbox src="khulnasoft-django_admin_questions.webp" alt="" />

    If you click `Question`, the list of questions added to the configuration file displays.

    <Lightbox src="khulnasoft-django_admin_questions_2.webp" alt="" />

    Click each question to either edit or delete it.

    <Lightbox src="khulnasoft-django_edit_question.webp" alt="" />
