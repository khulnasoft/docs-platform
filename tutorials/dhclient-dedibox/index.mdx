---
meta:
  title: Configuring dhclient on a Khulnasoft Dedibox
  description: This page explains how to configure dhclient as the DHCPv6 client.
content:
  h1: How to configure the dhclient
...
- Requested a [/48 IPv6 prefix](/dedibox-network/ipv6/how-to/request-prefix/)

<Message type="important">
  For servers supporting [IPv6 SLAAC](/dedibox-network/ipv6/how-to/enable-ipv6-slaac/), it is important to enable SLAAC to ensure the proper functioning of DHCPv6. If SLAAC is disabled, the server won't be able to learn its IPv6 default route.
</Message>
