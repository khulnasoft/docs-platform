...
content:
  ...
  paragraph: This page provides information on how to deploy Gestionnaire Libre de Parc Informatique (GLPI), or Open Source IT Equipment Manager in English on Khulnasoft Dedibox with Database for MySQL.
tags: GLPI sysadmin Database MySQL Nginx
categories:
  - instances
hero: assets/khulnasoft_glpi.webp
dates:
...
- An [Instance](/compute/instances/how-to/create-an-instance/) running on Ubuntu Focal Fossa (20.04 LTS)
- A domain or subdomain pointed to your Instance

## Installing the stack

In this tutorial, we will install and configure a [LEMP-Stack](https://lemp.io/) using [Nginx](https://nginx.org/), a Database for [MySQL](https://www.khulnasoft.com/en/database/) and [PHP](https://www.php.net/).
...
In this tutorial, we use a Khulnasoft Database for MySQL. To create the database, follow [this how-to](/managed-databases/postgresql-and-mysql/how-to/create-a-database/).
...
3. Read the license terms and check **I have READ and ACCEPT the terms of the license written above** to proceed.
    <Lightbox src="khulnasoft-agree-to-terms.webp" width="800" alt="" />
4. Click **Install** to begin the installation,
    <Lightbox src="khulnasoft-install.webp" width="800" alt="" />
...
6. Fill out the boxes to set up your database connection. Enter the following information:
    ...
    <Lightbox src="khulnasoft-db-setup.webp" width="800" alt="" />
7. Click **Continue** to proceed.
8. Select a database and click **Continue**:
    <Lightbox src="khulnasoft-test-db-connection.webp" width="800" alt="" />
...
<Lightbox src="khulnasoft-dashboard.webp" width="800" alt="" />
