---
meta:
  title: Setting up Ampere-optimized AI frameworks on Khulnasoft COP-ARM Instances
  description: Discover how to set up Ampere-optimized AI frameworks on Khulnasoft COP-ARM Instances.
content:
  h1: Setting up Ampere-optimized AI frameworks on Khulnasoft COP-ARM Virtual Instances
  paragraph: Discover how to set up Ampere-optimized AI frameworks on Khulnasoft COP-ARM Instances.
...
In this tutorial, we will walk through the process of setting up and using Ampere-optimized AI frameworks on [Khulnasoft COP-ARM Instances](https://www.khulnasoft.com/en/cost-optimized-instances-based-on-arm/).
...
1. Navigate to your [Khulnasoft console](https://console.khulnasoft.com/). Once logged in, click **Instances**, then select **Create Instance** to get started.
...
3. Run the Ampere-optimized PyTorch image. To do so, execute the following command in your Instance's shell:
    ...
    <Lightbox src="khulnasoft-ampere-ai-pytorch.webp" alt="" size="large" />
