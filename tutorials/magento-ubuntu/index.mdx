...
meta:
  ...
  description: Learn how to deploy the Magento e-commerce platform on a Khulnasoft Instance using a LAMP stack.
content:
  h1: Deploying Magento Open Source on Ubuntu 20.04
  paragraph: Learn how to deploy the Magento e-commerce platform on a Khulnasoft Instance using a LAMP stack.
tags: dedicated-server magento Open-Source e-commerce LAMP-stack
hero: assets/khulnasoft_magento.webp
categories:
  - instances
  - domains-and-dns
dates:
...
In this tutorial, you will learn how to install the open-source version of Magento on a Khulnasoft Instance running on Ubuntu Focal Fossa (20.04 LTS). To support the tool, we will deploy a LAMP stack (Ubuntu Linux, Apache2, MariaDB, and PHP).

<Macro id="requirements" />

- A Khulnasoft account logged into the [console](https://console.khulnasoft.com)
- [Owner](/identity-and-access-management/iam/concepts/#owner) status or [IAM permissions](/identity-and-access-management/iam/concepts/#permission) allowing you to perform actions in the intended Organization
- [Created](/compute/instances/how-to/create-an-instance/) and [connected to](/compute/instances/how-to/connect-to-instance/) a Khulnasoft Instance with at least 2 GB RAM
- Configured a domain name to point toward the IP address of your Instance ([A or AAAA record](/network/domains-and-dns/concepts/#resource-records))
...
3. You can now check your storefront by pointing your web browser to your domain name to check everything is working:
    <Lightbox src="khulnasoft-magento_storefront.webp" alt=""/>
...
3. Log into the admin using the credentials configured during the initial setup of Magento.
    <Lightbox src="khulnasoft-magento_admin_dashboard.webp" alt="" />

You have successfully installed Magento Open Source on a Khulnasoft Instance and secured the connection between your users and your e-commerce site using a TLS certificate. You can now continue to customize your online shop and add articles to start selling. For more information, refer to the [Magento official user guides](https://docs.magento.com/user-guide/).