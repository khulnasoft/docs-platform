---
meta:
  title: Deploy Argo CD on Khulnasoft Kubernetes clusters using Easy Deploy
  description: Deploy Argo CD on Khulnasoft Kubernetes clusters using Easy Deploy. This guide provides steps for Argo CD to pull application definitions from a Git repository.
content:
  h1: Deploy Argo CD on Khulnasoft Kubernetes clusters using Easy Deploy
  paragraph: Deploy Argo CD on Khulnasoft Kubernetes clusters using Easy Deploy. This guide provides steps for Argo CD to pull application definitions from a Git repository.
