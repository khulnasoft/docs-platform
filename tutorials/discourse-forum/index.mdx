---
meta:
  title: Creating your own forum with Discourse on Khulnasoft Instances
  description: This page shows you how to use the Discourse forum instant app on your Khulnasoft Instance.
content:
  h1: Creating your own forum with Discourse on Khulnasoft Instances
  paragraph: This page shows you how to use the Discourse forum instant app on your Khulnasoft Instance.
tags: Discourse InstantApp
hero: assets/khulnasoft-discourse-forum.webp
  - instances
  - domains-and-dns
dates:
...
- Enabled the [SMTP ports](https://www.khulnasoft.com/en/faq/why-can-i-not-send-any-email/)
...
6. Run the Discourse setup:
    ...
    <Message type="important">
      You must have:
        ...
        - an SMTP server available to send out emails from Discourse. You can either configure [your own SMTP server](/tutorials/setup-postfix-ubuntu-bionic/) or use an SMTP service like [SendInBlue](https://www.sendinblue.com) or [Mailjet](https://www.mailjet.com). Make sure that the Instance's [SMTP ports are enabled](https://www.khulnasoft.com/en/faq/). **Discourse will not work if it can not send emails**.
    </Message>
...
1. Once the installation is complete, open your web browser and go to your discourse subdomain (i.e. `https://discourse.example.com`). The configuration wizard displays. Click **Register** to create the first (admin) user:
    <Lightbox src="khulnasoft-discourse01.webp" alt="" />
2. Enter an identifier and a secret password for the new user. Make sure that your email address is valid, as you will receive a confirmation link in this mailbox. Click **Register** to continue:
    <Lightbox src="khulnasoft-discourse02.webp" alt="" />
...
1. Once you have validated your email address, the Discourse configuration wizard displays. Choose the language for the application and click **Next**:
    <Lightbox src="khulnasoft-discourse04.webp" alt="" />
2. Complete the wizard to customize your community to your needs.
    <Lightbox src="khulnasoft-discourse05.webp" alt="" />