---
meta:
  title: Achieving Super Resolution with a Sub-Pixel Convolutional Neural Network on Khulnasoft GPU
  description: This tutorial teaches you to achieve Super Resolution of images with a sub-pixel convolutional neural network. Learn to prepare your data, construct the network, train it and test it using a Khulnasoft GPU.
content:
  h1: Achieving Super-Resolution with a Sub-Pixel Convolutional Neural Network on Khulnasoft GPU
  paragraph: This tutorial teaches you to achieve Super Resolution of images with a sub-pixel convolutional neural network. Learn to prepare your data, construct the network, train it and test it using a Khulnasoft GPU.
categories:
  - gpu-instances
tags: Khulnasoft-GPU AI inference Super-Resolution
dates:
...
In this tutorial, we will show you how to prepare your data, construct the **sub-pixel convolutional** neural network, train it, and test it using a Khulnasoft [GPU instance](https://console.khulnasoft.com/instance/servers/create).

<Macro id="requirements" />

- A Khulnasoft account logged into the [console](https://console.khulnasoft.com)
- [Owner](/identity-and-access-management/iam/concepts/#owner) status or [IAM permissions](/identity-and-access-management/iam/concepts/#permission) allowing you to perform actions in the intended Organization
- A [GPU Instance](/compute/instances/how-to/create-an-instance/) running on UbuntuML
...
<Lightbox src="khulnasoft-plot.webp" alt="" />

In the image below you can see the results of the Super Resolution:

<Lightbox src="khulnasoft-input-output.webp" alt="" />
