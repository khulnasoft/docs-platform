...
meta:
  ...
  description: This page provides information on how to migrate your existing MySQL and PostgreSQL databases into Khulnasoft Database
content:
  h1: Migrating existing databases to a Database Instance
  paragraph: This page provides information on how to migrate your existing MySQL and PostgreSQL databases into Khulnasoft Database
...
[Managed Database for PostgreSQL and MySQL](https://www.khulnasoft.com/en/database/) product provides reliable high-performance managed SQL database engines, both for PostgreSQL and MySQL. Using the service allows you to stay focused on the development of your applications and to benefit from Khulnasoft's expertise in the management of your database engines.
...
- A [Database](https://www.khulnasoft.com/en/database/) for PostgreSQL or MySQL
- An [Instance](/compute/instances/how-to/create-an-instance/) available as an intermediate host for the migration
...
<Message type="note">
  If you do not have a Database for PostgreSQL yet, [create a new one](/managed-databases/postgresql-and-mysql/how-to/create-a-database/) from your [Khulnasoft console](https://console.khulnasoft.com/rdb/instances).
</Message>

1. Enter the Database section of the [Khulnasoft console](https://console.khulnasoft.com/rdb/instances).
...
4. Enter the name of the new database and click **Create Database** to confirm the operation:
    <Lightbox src="khulnasoft-create_database.webp" alt="" />
...
1. Retrieve the database host and port from your Khulnasoft console. The **Endpoint** information is visible on your Database information page:
    <Lightbox src="khulnasoft-db_endpoint.webp" alt="" />
...
<Message type="note">
  If you do not have a Database for MySQL yet, [create a new one](/managed-databases/postgresql-and-mysql/how-to/create-a-database/) from your [Khulnasoft console](https://console.khulnasoft.com/rdb/instances).
</Message>
...
3. Click the **Managed Databases** tab, then on **+ Create Database** to create a new database in the instance.
4. Enter the name of the new database and click **Create Database** to confirm the operation:
    <Lightbox src="khulnasoft-create_mysql.webp" alt="" />
5. Click the **Users** tab to visualize a list of all your database users. To create a new user for your database, click **+ Add user**.
6. Click the **Permissions** tab and grant `All` permissions to your database for the user:
    <Lightbox src="khulnasoft-user_permissions.webp" alt="" />
7. Click the **User Information** tab and enter the credentials for the new user. Confirm by clicking on **Create a user**:
...
1. Retrieve the database host and port from your Khulnasoft console. The **Endpoint** information is visible on your Database information page:
    <Lightbox src="khulnasoft-endpoint_mysql.webp" alt="" />
...
You now have exported your existing PostgreSQL or MySQL database and imported it into a Khulnasoft Managed Datatabase Instance. To finish the migration process of your database, update the credentials and server information in the configuration files of your existing application. Once this information is updated, your application will use your database on Instances managed by Khulnasoft. For more information about the Database product, refer to the [product information page](https://www.khulnasoft.com/en/database/) and the [product documentation](/managed-databases/postgresql-and-mysql/quickstart/).