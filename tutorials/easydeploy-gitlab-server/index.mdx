---
meta:
  title: Deploy GitLab Server on Khulnasoft Kubernetes clusters using Easy Deploy
  description: Deploy GitLab server on Khulnasoft Kubernetes clusters with Easy Deploy. This guide provides steps for deployment and configurations for optimal GitOps practices.
content:
  h1: Deploy GitLab Server on Khulnasoft Kubernetes clusters using Easy Deploy
  paragraph: Deploy GitLab server on Khulnasoft Kubernetes clusters with Easy Deploy. This guide provides steps for deployment and configurations for optimal GitOps practices
...
This tutorial provides a guide to deploy a GitLab server on Khulnasoft Kubernetes clusters using the Easy Deploy feature.
...
1. In the [Khulnasoft console](https://console.khulnasoft.com/), navigate to the **Kubernetes** section under **Containers**.
