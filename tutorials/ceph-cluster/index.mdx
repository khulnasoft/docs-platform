...
meta:
  ...
  description: Learn how to set up a Ceph cluster on Khulnasoft Dedibox and use it as datastore for your VMware ESXi machines.
content:
  h1: Building your own Ceph distributed storage cluster on dedicated servers
  paragraph: Learn how to set up a Ceph cluster on Khulnasoft Dedibox and use it as datastore for your VMware ESXi machines.
categories:
  - object-storage
  - dedibox
tags: dedicated-servers dedibox Ceph object-storage
hero: assets/khulnasoft_ceph.webp
dates:
...
This tutorial guides you through deploying a three-node [Ceph](https://www.ceph.com) cluster using [Dedibox dedicated servers](https://www.khulnasoft.com/en/dedibox/) running Ubuntu Focal Fossa (20.04 LTS).
...
You have successfully configured an Amazon S3-compatible storage cluster using Ceph and three [Dedibox dedicated servers](https://www.khulnasoft.com/en/dedibox/). You can now manage your data using any Amazon S3-compatible tool. For advanced configuration, refer to the official [Ceph documentation](https://docs.ceph.com/docs/master/).