...
content:
  ...
  paragraph: How to deploy AwStats to generate advanced web, streaming, FTP, or mail server statistics graphically.
categories:
  - instances
...
<Lightbox src="khulnasoft-awstats_homepage.webp" alt="" />
