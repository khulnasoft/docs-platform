---
meta:
  title: Setting up a RTMP streaming server on a Khulnasoft Instance
  description: This page shows you how to set up a self-hosted streaming server on a Khulnasoft Instance.
content:
  h1: Setting up a RTMP streaming server on a Khulnasoft Instance
  paragraph: This page shows you how to set up a self-hosted streaming server on a Khulnasoft Instance.
categories:
  - instances
hero: assets/khulnasoft_rtmp.webp
...
2. Enter the **Stream** tab and enter the Information about your streaming Instance:
    ...
    <Lightbox src="khulnasoft-obs_stream_settings.webp" alt="" />
...
2. Click the **Network** tab and enter the URL of your Stream:
    ...
    <Lightbox src="khulnasoft-vlc_source.webp" alt="" />
...
4. Start broadcasting from OBS. You can now either view your stream via a media player like VLC, and also from broadcasting platforms like Twitch:
    <Lightbox src="khulnasoft-twitch_stream.webp" alt="" />