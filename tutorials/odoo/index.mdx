...
categories:
  ...
  - instances
  - elastic-metal
hero: assets/khulnasoft_odoo.webp
dates:
...
This tutorial will show you how to deploy Odoo 16 on a Khulnasoft machine running Ubuntu Focal Fossa (20.04 LTS). This could be a [Dedibox](https://www.khulnasoft.com/en/dedibox/), an [Instance](https://www.khulnasoft.com/en/virtual-instances/) or an [Elastic Metal server](https://www.khulnasoft.com/en/elastic-metal/).
...
1. Open an internet browser on your local computer and point it to `http://<your_remote_machine_ip>:8069`. The Odoo installation wizard displays:
    <Lightbox src="khulnasoft-odoo14_install.webp" width="600" alt="" />
2. Enter the following information in the form:
    ...
    <Lightbox src="khulnasoft-odoo_app_dashboard.webp" width="900" alt="" />
3. (Optional) Click the **Install** button next to each app you want to install automatically on your Odoo server. You can see more details about each application by clicking on the **Learn More** button.
    ...
    <Lightbox src="khulnasoft-odoo_menu.webp" width="135" alt="" />

    Odoo CRM module:

    <Lightbox src="khulnasoft-odoo_crm.webp" width="900" alt="" />

    Odoo Discuss module with activated e-learning module:

    <Lightbox src="khulnasoft-odoo_discuss.webp" width="900" alt="" />
