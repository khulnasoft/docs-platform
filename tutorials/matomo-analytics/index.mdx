---
meta:
  title: Setting up web analytics with Matomo on a Khulnasoft Instance
  description: This page shows you how to install and configure Matomo web analytics on a Khulnasoft Instance running Ubuntu Focal Fossa (20.04)
content:
  h1: Setting up web analytics with Matomo on a Khulnasoft Instance
  paragraph: This page shows you how to install and configure Matomo web analytics on a Khulnasoft Instance running Ubuntu Focal Fossa (20.04)
categories:
  - instances
...
hero: assets/khulnasoft-matomo.webp
---
...
1. Open a web browser and go to `https://matomo.example.com/`. The web installer displays. Click **Next** to go to the second step:
    <Lightbox src="khulnasoft-matomo-setup1.webp" alt="" />
...
4. Click **Next** to continue with the installation:
    <Lightbox src="khulnasoft-matomo-setup2.webp" alt="" />
...
<Lightbox src="khulnasoft-matomo-login.webp" alt="" />
...
<Lightbox src="khulnasoft-matomo-dashboard.webp" alt="" />
