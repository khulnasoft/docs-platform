...
- An [Instance](/compute/instances/how-to/create-an-instance/) running on Ubuntu Noble Numbat (24.04) or later
...
1. [Connect to your Instance](/compute/instances/how-to/connect-to-instance/) via SSH.
    ...
    If you do not know your server IP, you can list your existing servers using the [Khulnasoft CLI](https://github.com/khulnasoft/khulnasoft-cli#khulnasoft-cli-v2) `scw instance server list`.
