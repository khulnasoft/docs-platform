---
meta:
  title: Deploy GitLab Runner on Khulnasoft Kubernetes clusters using Easy Deploy
  description: Learn how to deploy GitLab Runner on Khulnasoft Kubernetes clusters using the Easy Deploy feature. 
content:
  h1: Deploy GitLab Runner on Khulnasoft Kubernetes clusters using Easy Deploy
  paragraph: Learn how to deploy GitLab Runner on Khulnasoft Kubernetes clusters using the Easy Deploy feature. 
categories:
  - containers
dates:
