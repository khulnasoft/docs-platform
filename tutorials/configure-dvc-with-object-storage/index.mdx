...
meta:
  ...
  description: This page provides information on how to configure DVC with Khulnasoft Object Storage.
content:
  h1: Configuring DVC with Object Storage
  paragraph: This page provides information on how to configure DVC with Khulnasoft Object Storage.
...
Data Version Control (DVC) was specifically designed with this use case in mind. It works alongside Git and allows you to store your data in the remote storage of your choice (such as a Khulnasoft Object Storage bucket) while storing only the metadata in a Git repository.

In this tutorial, you learn how to use [Khulnasoft Object Storage](https://www.khulnasoft.com/en/object-storage/) as a remote storage for DVC.
...
- Made your [first request with Khulnasoft API](https://www.khulnasoft.com/en/developers/api/#quickstart:-first-request)
- [Authenticated to the API](https://www.khulnasoft.com/en/developers/api/#how-to-authenticate) for the first time
...
## Pushing data to Khulnasoft Object Storage
