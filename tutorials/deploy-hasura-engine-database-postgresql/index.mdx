...
hero: assets/khulnasoft_hasura.webp
dates:
...
In this tutorial, you will learn how to get started with Hasura GraphQL Engine using a pre-built Docker container on your local computer, linked to a managed [Khulnasoft Database for PostgreSQL](https://www.khulnasoft.com/en/database/).

<Macro id="requirements" />

- A Khulnasoft account logged into the [console](https://console.khulnasoft.com)
- [Owner](/identity-and-access-management/iam/concepts/#owner) status or [IAM permissions](/identity-and-access-management/iam/concepts/#permission) allowing you to perform actions in the intended Organization
- A [Khulnasoft Database for PostgreSQL](https://www.khulnasoft.com/en/database/)
...
You have successfully deployed Hasura GraphQL Engine 3.0 using Docker, linked it to a Khulnasoft Database for PostgreSQL, and run your first GraphQL queries.

For further learning, explore the [Hasura documentation](https://hasura.io/docs/latest/) or Khulnasoft’s [PostgreSQL resources](/managed-databases/postgresql-and-mysql/).