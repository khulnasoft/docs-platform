...
2. Check the status of your network interfaces using the `ip a` command. You see the details of the default Ethernet adapter of your Instance:
    ...
    ```
3. Go to the [VPC page](https://console.khulnasoft.com/vpc/vpc) of the Khulnasoft console.
...
5. Click **Create Private Network**. The Private Network creation wizard displays:
    <Lightbox src="khulnasoft-vpc-create-pn.webp" alt="" />
...
9. Click **Attach resource** and select your Instance from the dropdown list that displays. Leave the default IPv4 and IPv6 address settings in place, or specify these addresses yourself if you prefer. 
    <Lightbox src="khulnasoft-vpc-attach-resource.webp" alt="" />
...
1. Go to the [Public Gateways page](https://console.khulnasoft.com/public-gateway/public-gateways) of the Khulnasoft console, and click **Create a Public Gateway**. The Public Gateway creation wizard displays:
    <Lightbox src="khulnasoft-vpc-create-pgw.webp" alt="" />
...
5. Click the **Private Networks** tab, then **Attach to a Private Network**.
    <Lightbox src="khulnasoft-vpc-attach-pgw-pn.webp" alt="" />
...
1. Go to the [Public Gateways page](https://console.khulnasoft.com/public-gateway/public-gateways) of the Khulnasoft console, and click on the Public Gateway you created previously. Its **Overview** page displays.
...
3. Leave the default port in place, copy the SSH connection command, and click **Save SSH bastion settings**.
   SSH bastion is activated, and all the SSH keys currently associated with your Khulnasoft Project are uploaded to the bastion.
