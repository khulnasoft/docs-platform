...
meta:
  ...
  description: Create a sleek documentation website using the Khulnasoft Object Storage bucket website feature and Material for MkDocs. Simple, fast, and easy to complete!
content:
  h1: Creating a documentation website using Object Storage bucket website and Material for MkDocs
  paragraph: Create a sleek documentation website using the Khulnasoft Object Storage bucket website feature and Material for MkDocs. Simple, fast, and easy to complete!
categories:
  - object-storage
...
This tutorial shows you how to create a documentation website using the Khulnasoft [Object Storage bucket website](/storage/object/concepts/#bucket-website) feature with MkDocs.
...
## Set up MkDocs and configure your website
    ...
    ### Template of the mkdocs.yaml file
      ...
      1. [Create an Object Storage bucket](/storage/object/how-to/create-a-bucket/) from the [Khulnasoft console](https://console.khulnasoft.com/).
      ...
      8. Select a storage class when prompted and click **Validate storage class** to confirm. Your file architecture should look like the following.
         <Lightbox src="khulnasoft-mkdocs-files-in-bucket.webp" alt="File architecture showing the index and error files and folders containing the website content at the root of the bucket." />
      ...
      Your website's homepage should look similar to the following in light mode:
          <Lightbox src="khulnasoft-mkdocs-website-light-mode.webp" alt="MkDocs website in light mode" />

      Your website's homepage should look similar to the following in dark mode:
          <Lightbox src="khulnasoft-mkdocs-website-dark-mode.webp" alt="MkDocs website in dark mode" />

      This is what a collapsible admonition with a custom title should look like when collapsed:
          <Lightbox src="khulnasoft-collapsible-admonition.webp" alt="" />

      This is what a collapsible admonition with a custom title should look like when expanded:
          <Lightbox src="khulnasoft-collapsible-admonition-expanded.webp" alt="" />
