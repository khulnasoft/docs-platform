...
By default, the IP owner’s information (e.g., Khulnasoft/Online.net) is used to identify the association of an email address with a specific IP. However, if you have [properly configured the reverse DNS for your IP](/dedibox-network/ip-failover/how-to/configure-reverse-dns/), you can use an email address from your own domain for these notifications.
