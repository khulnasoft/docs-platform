---
meta:
  title: Khulnasoft Dedibox RPN - Quickstart
  description: This page shows you how to get started with RPN (Real Private Network) on Khulnasoft Dedibox
content:
  h1: Khulnasoft Dedibox RPN - Quickstart
  paragraph: This page shows you how to get started with RPN (Real Private Network) on Khulnasoft Dedibox
...
- A [Dedibox dedicated server](https://www.khulnasoft.com/en/dedibox) with RPNv2 connectivity
