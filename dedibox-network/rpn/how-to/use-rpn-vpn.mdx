...
meta:
  ...
  description: This page explains how to use the RPN VPN with your Khulnasoft Dedibox servers
content:
  h1: How to use the RPN VPN with your Dedibox Servers
  paragraph: This page explains how to use the RPN VPN with your Khulnasoft Dedibox servers
...
- An RPN-compatible [Dedibox dedicated server](https://www.khulnasoft.com/en/dedibox)
...
3. Download the certificate files for your RPN VPN. Click **Show Password** to display the password associated with your RPN VPN.
    <Lightbox src="khulnasoft-rpn-vpn-03.webp" alt="" />
