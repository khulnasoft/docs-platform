...
meta: 
  ...
  description: This page explains how to find your RPNv1 gateway on Khulnasoft Dedibox servers
content:
  h1: How to find your RPNv1 gateway
  paragraph: This page explains how to find your RPNv1 gateway on Khulnasoft Dedibox servers
...
You can find the RPNv1 gateway for your Dedibox in the Khulnasoft console, or by running the following commands.

<Macro id="requirements" />

- A Dedibox account logged into the [Dedibox console](https://console.online.net)
- A [Dedibox dedicated server](https://www.khulnasoft.com/en/dedibox) with an RPN interface
