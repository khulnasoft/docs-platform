...
meta:
  ...
  description: This page explains how to configure the RPNv1 gateway on a Khulnasoft Dedibox
content:
  h1: How to configure the RPNv1 gateway on an RPNv2 Dedibox
  paragraph: This page explains how to configure the RPNv1 gateway on a Khulnasoft Dedibox
...
<Lightbox src="khulnasoft_rpnv1_gateway.webp" alt="" />
