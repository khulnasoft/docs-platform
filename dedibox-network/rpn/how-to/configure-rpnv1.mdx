---
meta:
  title: How to configure Khulnasoft Dedibox RPNv1 on a Dedibox
  description: This page explains how to configure Khulnasoft Dedibox RPNv1 on a Dedibox
content:
  h1: How to configure Khulnasoft Dedibox RPNv1 on a Dedibox
  paragraph: This page explains how to configure Khulnasoft Dedibox RPNv1 on a Dedibox
...
- A [Dedibox dedicated server](https://www.khulnasoft.com/en/dedibox) with RPNv1 connectivity

## How to create a new RPNv1 group from the Khulnasoft console
