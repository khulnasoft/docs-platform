...
meta:
  ...
  description: This page explains how to mount a Khulnasoft RPN SAN volume in VMware ESXi 7 and later
content:
  h1: How to mount an RPN SAN volume in VMware ESXi 7 and later
  paragraph: This page explains how to mount a Khulnasoft RPN SAN volume in VMware ESXi 7 and later
...
1. Log into the ESXi web interface at `https://YOUR_ESXI_HOST_IP`.
    ...
    <Lightbox src="khulnasoft-esxi7-dashboard.webp" alt="" />
...
3. Select **TSM-SSH**, then click **Start** to activate the SSH service.
    <Lightbox src="khulnasoft-esxi7-ssh.webp" alt="" />
...
3. Create a new **Virtual Switch** by clicking on **Networking** > **Virtual Switches** > **Add Standard Virtual Switch**. Configure it as shown in the following example:
    <Lightbox src="khulnasoft-rpn_switch.webp" width="400" alt="" />
...
9. Replace the MAC address of your RPN VMkernel NIC with your [virtual MAC](/dedibox-network/ip-failover/how-to/create-virtual-mac/).
    <Lightbox src="khulnasoft-esxi7-vmnic.webp" />
