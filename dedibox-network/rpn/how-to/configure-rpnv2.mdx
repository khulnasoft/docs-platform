---
meta:
  title: How to configure Khulnasoft Dedibox RPNv2
  description: This page explains how to configure Khulnasoft Dedibox RPNv2 on a Dedibox dedicated server.
content:
  h1: How to configure Khulnasoft Dedibox RPNv2
  paragraph: This page explains how to configure Khulnasoft Dedibox RPNv2 on a Dedibox dedicated server.
...
3. Configure your bridge with a `bridge_port` which will be named after your RPN NIC, and your VLAN ID.
    <Lightbox src="khulnasoft_proxmox_rpn.webp" />
