...
meta:
  ...
  description: This page explains how to connect a Khulnasoft Dedibox to RPN SAN
content:
  h1: How to connect a Dedibox to RPN SAN
  paragraph: This page explains how to connect a Khulnasoft Dedibox to RPN SAN
...
[RPN SAN](https://www.khulnasoft.com/en/dedibox/storage/) is a performance-oriented SAN storage network solution (Storage Area Network) accessible in block mode and available in iSCSI through the RPN private network of your Dedibox.
...
2. Click **Manage** next to the SAN you want to configure:
    <Lightbox src="khulnasoft_rpn_san_manage.webp" alt="" />
3. Configure access to the SAN. You can allow connections either by using the server ID or by their RPN IP address. Then Click **Save** to validate the configuration.
    <Lightbox src="khulnasoft_rpn_san_add.webp" alt="" />
...
3. Once the status of your group changes to **Active** the group is ready to be used and your Dedibox is able to communicate with the SAN.
    <Lightbox src="khulnasoft_rpn_san_added.webp" alt="" />
