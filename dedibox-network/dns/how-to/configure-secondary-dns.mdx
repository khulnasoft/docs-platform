...
meta:
  ...
  description: This page explains how to configure secondary DNS on your Khulnasoft Dedibox server
content:
  h1: How to configure secondary DNS
  paragraph: This page explains how to configure secondary DNS on your Khulnasoft Dedibox server
tags: dedibox dns 
dates:
