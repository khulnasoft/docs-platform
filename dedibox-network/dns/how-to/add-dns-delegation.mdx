...
meta:
  ...
  description: This page explains how to add a DNS delegation to IPv6 and IPv4 on Khulnasoft Dedibox
content:
  h1: How to add a DNS delegation
  paragraph: This page explains how to add a DNS delegation to IPv6 and IPv4 on Khulnasoft Dedibox
...
2. Click the settings icon (cogwheel) next to the relevant IP block, then select **Edit nameserver delegation**. The **Edit nameserver delegation** page displays.
    <Lightbox src="khulnasoft-edit-delegation.webp" alt="" />
