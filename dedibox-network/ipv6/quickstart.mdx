---
meta:
  title: Khulnasoft Dedibox IPv6 - Quickstart
  description: This page shows you how to get started with IPv6 on Khulnasoft Dedibox.
content:
  h1: Khulnasoft Dedibox IPv6 - Quickstart
  paragraph: This page shows you how to get started with IPv6 on Khulnasoft Dedibox.
...
All Khulnasoft Dedibox dedicated servers support IPv6. You can request a free /48 IPv6 prefix for your account. This prefix can then be divided into multiple /56 or /64 subnets. IPv6 is available for Dedibox servers in Paris and Warsaw.
...
* [How to configure IPv6 on Linux using `systemd-networkd`](/dedibox-network/ipv6/how-to/configure-ipv6-linux/)
