...
All Khulnasoft Dedibox dedicated servers support IPv6. You can request a free `/48` IPv6 prefix for your account, which can be divided into multiple `/56` or `/64` subnets. IPv6 support is available for all Dedibox servers.
...
2. Scroll to the bottom of the page and click **Order a free /48 IPv6 block**:
    <Lightbox src="khulnasoft_order_ipv6.webp" alt="" />
