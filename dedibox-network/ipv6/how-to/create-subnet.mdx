...
meta:
  ...
  description: This page explains how to create an IPv6 subnet for Khulnasoft Dedibox servers.
content:
  h1: How to create an IPv6 subnet
  paragraph: This page explains how to create an IPv6 subnet for Khulnasoft Dedibox servers.
...
2. Click the settings icon (cogwheel) next to your `/48` prefix. Then click **Create subnet**.
    <Lightbox src="khulnasoft_ipv6_list.webp" alt="" />
