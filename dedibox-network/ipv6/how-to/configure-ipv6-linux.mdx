...
meta:
  ...
  description: This page explains how to configure IPv6 connectivity on a Khulnasoft Dedibox using systemd-networkd.
content:
  h1: How to configure IPv6 connectivity using systemd-networkd
  paragraph: This page explains how to configure IPv6 connectivity on a Khulnasoft Dedibox using systemd-networkd.
...
5. Open the file in a text editor and paste the following content. Make sure to replace the values in the example with your own and save them before exiting the text editor.
    ...
    DUIDType=link-layer
    # Khulnasoft Dedibox DUID without the DUID-LL "00:03" at the beginning
    DUIDRawData=<Khulnasoft IPv6 DUID>
