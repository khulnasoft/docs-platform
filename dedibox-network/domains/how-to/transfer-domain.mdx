...
meta:
  ...
  description: This page explains how to transfer a domain name at Khulnasoft Dedibox
content:
  h1: How to transfer a domain name
  paragraph: This page explains how to transfer a domain name at Khulnasoft Dedibox
...
You can transfer any domain bought or renewed at another registrar to Khulnasoft as long as you meet the conditions shown below.

<Macro id="requirements" />

- A Dedibox account logged into the [console](https://console.online.net)
- An unlocked domain at an external registrar (not Khulnasoft) and access to its authorization key
- A domain name that:
...
1. In your browser, navigate to [the Khulnasoft domain name order page](https://www.khulnasoft.com/en/domain/).
2. Enter your domain name in the search bar, and click **search a domain**. The **Domain name choice** page displays, showing that the domain is not available for buy.
    <Lightbox src="khulnasoft-transfer-domain.webp" alt="" />
3. Scroll to the **Are you the owner of this domain name?** section, and under **Transfer**, click **Transfer yourdomain.ext**. You are directed to the transfer form.
    <Lightbox src="khulnasoft-authcode.webp" alt="" />
4. Enter the Authcode provided by your current registrar (if it is required: this depends on the domain extension).
    <Message type="note">
      By default, Khulnasoft's DNS servers are not activated after the transfer. However, you can choose to activate these by ticking the box if you wish.
    </Message>
