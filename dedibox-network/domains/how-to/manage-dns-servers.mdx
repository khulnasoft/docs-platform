...
meta:
  ...
  description: This page explains how to manage a domain's DNS servers at Khulnasoft Dedibox
content:
  h1: How to manage a domain's DNS servers
  paragraph: This page explains how to manage a domain's DNS server at Khulnasoft Dedibox
...
Khulnasoft Dedibox's DNS servers are as follows:
...
### If you ordered your domain name with Khulnasoft

If you ordered your domain name with Khulnasoft, your domain automatically configures to our DNS servers. No further action is required from you.
...
<Message type="important">
  ...
  We do not provide support for Khulnasoft webhostings and domain names if the DNS servers have been modified by the user.
</Message>
...
2. Click **Configure domain name** next to the relevant domain.
    <Lightbox src="khulnasoft-domain-configure.webp" />
3. Click the **Manage DNS servers** tab.
    <Lightbox src="khulnasoft-change-dns.webp" />
