...
meta:
  ...
  description: This page explains how to manage a domain's DNS zones at Khulnasoft Dedibox
content:
  h1: How to manage a domain's DNS zones
  paragraph: This page explains how to manage a domain's DNS zones at Khulnasoft Dedibox
...
The [DNS zone](/dedibox-network/domains/concepts/#dns-zone) is the roadmap of the domain name and contains all the required information to operate it on the internet.
...
You can manage multiple versions of your DNS zones at Khulnasoft.
...
3. Click the **Edit DNS zone** tab.
    <Lightbox src="khulnasoft-edit-dns-zone.webp" alt="" />
