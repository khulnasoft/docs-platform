...
meta:
  ...
  description: This page explains how to change the ownership of a domain name at Khulnasoft Dedibox
content:
  h1: How to change the ownership of a domain name
  paragraph: This page explains how to change the ownership of a domain name at Khulnasoft Dedibox
dates:
...
- A Khulnasoft domain you want to transfer to a new owner, who must have [created a Dedibox account](/dedibox-console/account/how-to/create-a-dedibox-account/)
...
2. Click **Trades**. Trading is the procedure that allows you to change the ownership of a domain.
    <Lightbox src="khulnasoft-trade-domain.webp" alt="" />
...
5. Select the account of the new owner, searching for it via the account login if necessary, and click **Confirm**.
  <Lightbox src="khulnasoft-trade-domain-2.webp" alt="" />
