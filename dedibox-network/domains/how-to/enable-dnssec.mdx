...
meta:
  ...
  description: This page explains how to enable DNSSEC for domains at Khulnasoft Dedibox
content:
  h1: How to enable DNSSEC
  paragraph: This page explains how to enable DNSSEC for domains at Khulnasoft Dedibox
...
## How to activate and deactivate DNSSEC if your domain and DNS are managed by Khulnasoft
...
2. Click **Domain**. A list of your domains displays.
    <Lightbox src="khulnasoft-domain-configure.webp" alt="" />
...
## How to activate and deactivate DNSSEC if your domain is managed by Khulnasoft with your own DNS server

1. Log in to the [Online console](https://console.online.net).
2. Click **Domain**. A list of your domains displays.
3. Click **Configure domain name** next to the relevant domain.
4. Click the **Manage DNSSEC** tab.
    <Lightbox src="khulnasoft-activate-dnssec-ext.webp" alt="" />
