---
meta:
  title: Khulnasoft Dedibox Failover IP - Concepts
  description: This page explains all the concepts related to failover IP on Khulnasoft Dedibox
content:
  h1: Khulnasoft Dedibox Failover IP - Concepts
  paragraph: This page explains all the concepts related to failover IP on Khulnasoft Dedibox
