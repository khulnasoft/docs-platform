---
meta:
  title: How to create a virtual MAC address for a Khulnasoft Dedibox failover IP
  description: This page explains how to create a virtual MAC address for a Khulnasoft Dedibox failover IP.
content:
  h1: How to create a virtual MAC address for a Khulnasoft Dedibox failover IP
  paragraph: This page explains how to create a virtual MAC address for a Khulnasoft Dedibox failover IP.
