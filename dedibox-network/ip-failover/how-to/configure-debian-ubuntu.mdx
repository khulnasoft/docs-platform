      ...
      ethernets:
        ensXX:
          ...
          nameservers:
            addresses:
              - 51.159.47.28
              - 51.159.47.26 # Replace the IP of the DNS cache server with the one located in the same physical location as your machine for optimal performance (https://www.khulnasoft.com/en/docs/console/account/reference-content/khulnasoft-network-information/#dns-cache-servers)
            search: []
    version: 2
    ```
    <Message type="tip">
