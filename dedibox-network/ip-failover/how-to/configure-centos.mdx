...
meta:
  ...
  description: This page explains how to configure a Khulnasoft Dedibnox failover IP on CentOS.
content:
  h1: How to configure a Dedibox failover IP on CentOS
  paragraph: This page explains how to configure a Khulnasoft Dedibox failover IP on CentOS.
