...
meta:
  ...
  description: This page explains how to assign a failover IP for Khulnasoft Dedibox servers.
content:
  h1: How to assign a failover IP to a Dedibox server
  paragraph: This page explains how to assign a failover IP for Khulnasoft Dedibox servers.
