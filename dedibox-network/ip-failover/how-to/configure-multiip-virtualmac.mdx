...
meta:
  ...
  description: This page explains how to configure multi-IP virtual MAC addresses on Khulnasoft Dedibox.
content:
  h1: How to configure multi-IP virtual MAC addresses
  paragraph: This page explains how to configure multi-IP virtual MAC addresses on Khulnasoft Dedibox.
