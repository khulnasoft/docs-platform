...
description: Learn to manage your key effectively with the Kubo client. Follow our step-by-step guide for seamless key management and enhanced security.
content:
h1: How to manage your key
paragraph: Learn to manage your key effectively with the Kubo client. Follow our step-by-step guide for seamless key management and enhanced security.
...
3. Convert the file contents to base64 to import them into the naming service via the Khulnasoft CLI.
    ```
