...
meta:
  ...
  description: This page explains how to get started with Khulnasoft IPFS Naming.
content:
  h1: IPFS Naming - Quickstart
  paragraph: This page shows you how to get started with Khulnasoft IPFS Naming.
