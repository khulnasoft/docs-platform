...
meta:
  ...
  description: Discover how to manage email accounts for Khulnasoft Web Hosting plans from the console.
content:
  h1: How to manage email accounts
  paragraph: Discover how to manage email accounts for Khulnasoft Web Hosting plans from the console.
tags: webhosting
dates:
...
Send, receive, and store electronic messages through the internet. Email accounts can be accessed via POP3 and IMAP protocols and managed from the Khulnasoft console.
...
<Message type="tip">
  This guide focuses on managing your email accounts through the Khulnasoft console. For advanced configurations, you can access your [Web Hosting control panel (cPanel or Plesk)](/managed-services/webhosting/quickstart/#how-to-access-the-web-hosting-control-panel-from-the-khulnasoft-console).
</Message>
