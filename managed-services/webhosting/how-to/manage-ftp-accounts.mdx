...
meta:
  ...
  description: Discover how to manage FTP accounts for Khulnasoft Web Hosting plans from the console.
content:
  h1: How to manage FTP accounts
  paragraph: Discover how to manage FTP accounts for Khulnasoft Web Hosting plans from the console.
tags: webhosting
dates:
...
You can create and manage FTP accounts directly from the Khulnasoft console.
...
<Message type="tip">
  This guide focuses on managing your FTP accounts through the Khulnasoft console. For advanced configurations, you can access your [Web Hosting control panel (cPanel or Plesk)](/managed-services/webhosting/quickstart/#how-to-access-the-web-hosting-control-panel-from-the-khulnasoft-console).
</Message>
