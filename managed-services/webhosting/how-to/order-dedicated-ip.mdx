...
meta:
  ...
  description: This page explains how to order a dedicated IP address for a Khulnasoft Web Hosting plan.
content:
  h1: How to order a dedicated IP address for a Web Hosting plan
  paragraph: This page explains how to order a dedicated IP address for a Khulnasoft Web Hosting plan
tags: webhosting
dates:
...
In shared Web Hosting, multiple websites share the same server and its resources. Each website typically has its own domain name, but they all use the same IP address for the server. Khulnasoft provides the option to purchase a dedicated IP address for your website, even within a shared hosting environment.
...
- [Registered a domain name](/network/domains-and-dns/how-to/register-internal-domain/) at Khulnasoft or another registrar
- A Web Hosting plan with a shared IP address

## Activate a dedicated IP address for a Web Hosting plan

1. Navigate to the **Managed Services** section of the [console](https://console.khulnasoft.com/) side menu and click **Web Hosting**. This action will lead you to the **Web Hosting** overview page.
2. Click either <Icon name="seeMore" /> or the domain name associated with the Web Hosting you want to configure. This will take you to the **Hosting Information** page.
...
<Message type="important">
  ...
  If your IP address is found to be blacklisted, the option cannot be deactivated, and you should reach out to our [technical support](https://console.khulnasoft.com/support/tickets) for assistance.
</Message>
