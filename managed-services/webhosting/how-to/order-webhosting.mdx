...
meta:
  ...
  description: Learn how to order a Khulnasoft Web Hosting plan with our detailed step-by-step guide.
content:
  h1: How to order a Web Hosting plan
  paragraph: Learn how to order a Khulnasoft Web Hosting with our detailed step-by-step guide.
...
This page shows how to create a Khulnasoft Web Hosting plan. Web Hosting is a managed service, designed for personal use, business use and everything in between. It allows you to host your website and databases and create personalized email addresses using your domain name.
...
5. Click **Create Web Hosting** to finish. Your Web Hosting plan creation starts, and you will be redirected to the **Overview** tab.
    ...
    <Lightbox src="khulnasoft-webhosting-dashboard.webp" alt="" />
