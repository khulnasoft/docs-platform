...
meta:
  ...
  description: This page explains all the concepts related to Khulnasoft’s Web Hosting service
content:
  h1: Web Hosting - Concepts
  paragraph: This page explains all the concepts related to Khulnasoft’s Web Hosting service
...
Upon activation, we automatically assign your hosting a dedicated IP after verifying it is not blacklisted. Deactivating the option triggers a similar check. If the IP is clean, it will automatically be removed from your account. Otherwise, [contact our support team](https://console.khulnasoft.com/support/tickets) to address any issues.
...
FTP, or File Transfer Protocol, is a protocol that allows you to transfer files between different computers over the internet. It allows you, as part of your Web Hosting plan, to transfer your files from your computer to Khulnasoft.com - e.g. to update your website. It also works the other way around: you can recover the files stored on Khulnasoft.com and transfer them to your personal computer, e.g. to make a backup.
...
The `php.ini` file is the configuration file used for applications that require PHP. It contains variable configurations such as upload size, file timeout, and resource limits. For Khulnasoft Web Hosting, we provide PHP with the most common values preconfigured. If required, you can [customize the configuration of PHP](/dedibox-console/classic-hosting/how-to/configure-php/) to suit your needs.
...
Web Hosting is a service provided by Khulnasoft which offers storage space and access for your websites. Our Web Hosting plans include:
