...
You can now migrate your Online.net Web Hosting Classic plan to Khulnasoft's new Web Hosting platform. This migration brings you better performance and an improved user experience. Benefits of the migration include:
...
You can initiate the migration of your Web Hosting plan directly from your [Dedibox/Online.net console](https://console.online.net/). For further information, refer to our dedicated documentation [How to migrate an Online.net/Dedibox web hosting plan to Khulnasoft](/managed-services/webhosting/how-to/migrate-webhosting-plan/).
...
After [initiating the migration](/managed-services/webhosting/how-to/migrate-webhosting-plan/) of your Online.net hosting plan, it will be transferred to Khulnasoft. During this transition, your existing offer will be temporarily moved to a migration plan. You will then have the possibility to select from Khulnasoft's range of Web Hosting plans, tailored to meet your specific requirements.

Your current offer will be transferred to one of these migration plans:

| Online.net/Dedibox Web Hosting offer | Khulnasoft Web Hosting offer    |
|--------------------------------------|-------------------------------|
...
<Message type="important">
    You are required to switch your hosting plan to one of our new [Web Hosting plans](https://www.khulnasoft.com/en/pricing/?tags=available,managedservices-webdevelopment-webhosting) once the migration of your data has been completed.
</Message>

### What happens to my backup option?

If the Online.net Web Hosting Classic plan includes the backup option, it will also be available for Khulnasoft Web Hosting. The pricing for the backup option will remain unchanged and will be billed at the current tariff.
...
All FTP accounts and configurations will be migrated. The existing password will remain functional, and the hostname will be updated to `ftp.domain.tld` or the platform's hostname in [Khulnasoft's Web Hosting Overview](https://console.khulnasoft.com/webhosting/webhosting).
...
Your Khulnasoft Web Hosting billing will start immediately following the successful completion of the migration. You will be granted a discount corresponding to the remaining term of your prior Online.net hosting and backup option.
