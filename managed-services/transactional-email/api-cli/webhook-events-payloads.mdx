...
meta:
  ...
  description: This page details the fields of the webhook event payloads for Khulnasoft Transactional Email
content:
  h1: Understanding Webhook event payloads
  paragraph: This page details the fields of the webhook event payloads for Khulnasoft Transactional Email
