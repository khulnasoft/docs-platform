...
This page shows you how to display your email activity and filter your emails using the [Khulnasoft console](https://console.khulnasoft.com/).
...
1. Click **Transactional Email** in the **Managed Services** section of the [console](https://console.khulnasoft.com/) side menu. Your domains display.
...
3. Click <Icon name="seeMore" /> next to the email for which you want to get more detail. You are directed to a page with more details such as the status of your email, the flags that apply to your email, how many times Khulnasoft tried to send your email, and the email address from which the email was sent.
...
- The **Email status** drop-down allows you to target specific emails according to their **status** or their **flags**.
    ...
    |--------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Greylisted                                                         | Your email has been slightly delayed by the recipient, to ensure that Khulnasoft is not sending spam.                                                                                                                                                                                        |
...
- Last event date: Indicates the date of your email's last update and the amount of times Khulnasoft attempted to send the email
...
<Message type="note">
You can also [filter your emails via the Transactional Email API](https://www.khulnasoft.com/en/developers/api/transactional-email/#path-statistics-email-statuses).
</Message>
