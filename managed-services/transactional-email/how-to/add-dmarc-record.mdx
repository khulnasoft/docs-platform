...
If you have registered a domain at Khulnasoft Domains and DNS, you can still use this documentation, as the process is similar.
...
6. Confirm the changes and add the DMARC record.
    ...
    <Message type="tip">
     If you have a domain at Khulnasoft Domains and DNS, you can access your account from the Khulnasoft [console](https://console.khulnasoft.com/), click **Domains and DNS** > **Your domain** > **DNS Zones**, then add a record in the same zone as your Transactional Email's domain.
    </Message>
