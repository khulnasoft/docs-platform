...
meta:
  title: Routes
  description: This page provides detailed information about Khulnasoft IoT Hub Routes.
content:
  h1: Routes
  paragraph: This page provides detailed information about Khulnasoft IoT Hub Routes.
excerpt: |
  This page provides detailed information about Khulnasoft IoT Hub Routes.
totalTime: PT5M
...
Object Storage Routes forward your messages to a [Khulnasoft Object Storage](/storage/object/quickstart/) bucket.
