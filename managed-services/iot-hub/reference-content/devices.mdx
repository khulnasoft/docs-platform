...
meta:
  title: Devices
  description: This page provides detailed information about Khulnasoft IoT Hub Devices.
content:
  h1: Devices
  paragraph: This page provides detailed information about Khulnasoft IoT Hub Devices.
dates:
...
For your convenience, your Hub's certificate authority is Khulnasoft-generated. Your IoT Hub will issue a Khulnasoft-generated device certificate when you add a new Device.

If you want to provide your own certificate, you can upload a certificate to associate it with a Device.

Whether your Device certificate is **Khulnasoft-generated** or **customer-provided**, the Device can connect to your Hub using it even if the certificate is not signed by the Hub certificate authority.
...
<Message type="note">
  If you changed the Hub certificate authority, the Device certificate renewal feature becomes permanently disabled. You will no longer be able to use a Khulnasoft-generated certificate for the Device in question.
</Message>
