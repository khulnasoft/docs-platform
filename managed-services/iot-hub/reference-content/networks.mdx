...
meta:
  title: Networks
  description: This page provides detailed information about Khulnasoft IoT Hub Networks.
content:
  h1: Networks
  paragraph: This page provides detailed information about Khulnasoft IoT Hub Networks.
excerpt: |
  This page provides detailed information about Khulnasoft IoT Hub Networks.
totalTime: PT5M
...
<Message type="note">
  For more information about how to use the default MQTT Network, see [How to connect to the default MQTT Network.](/managed-services/iot-hub/how-to/connect-default-mqtt-network/).
</Message>
...
<Message type="tip">
  For more information about the default WebSocket Network, check out [how to connect to the default WebSocket Network.](/managed-services/iot-hub/how-to/connect-default-websocket-network/).
</Message>
