...
meta:
  title: Hubs
  description: This page provides detailed information about the features of Khulnasoft IoT Hubs.
content:
  h1: Hubs
  paragraph: This page provides detailed information about the features of Khulnasoft IoT Hubs.
excerpt: |
  This page provides detailed information about the features of Khulnasoft IoT Hubs.
totalTime: PT5M
...
<Message type="note">
  A table describing the features of each plan in detail is available in the [Hub creation wizard](https://console.khulnasoft.com/iot-hub/hubs/create) on the console.
</Message>

## Certificate Authority

When you create a Hub, it comes with a Khulnasoft-generated [Certificate Authority](/managed-services/iot-hub/concepts/#certificate-authority). The Hub Certificate Authority is used to authenticate connecting devices through mutual TLS authentication.
