...
5. Complete the form by specifying the network's details:
    ...
    * Choose a topic prefix your network should publish to. You may leave this empty. All the messages published to this network will have their topics prefixed with this value.
    <Lightbox src="khulnasoft-iothub_network_modal_sigfox.webp" alt="" />
...
2. Go the **DEVICE TYPE** tab
    <Lightbox src="khulnasoft-iothub_network_sigfox_devicetype_tab.webp" alt="" />
3. Click the **CALLBACKS** entry in the left menu
    <Lightbox src="khulnasoft-iothub_network_sigfox_devicetype_callbacks.webp" alt="" />
4. Select the **Custom callback** option
    <Lightbox src="khulnasoft-iothub_network_sigfox_devicetype_new_custom_callback.webp" alt="" />
5. Fill-in the form like the example below.
    <Lightbox src="khulnasoft-iothub_network_sigfox_devicetype_callback_form.webp" alt="" />
