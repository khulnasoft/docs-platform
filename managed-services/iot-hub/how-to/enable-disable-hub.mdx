...
You can enable or disable your IoT Hub from the Khulnasoft console. This can be useful if you want to do maintenance actions on your hub, or if you want to change the [product plan](/managed-services/iot-hub/how-to/change-plan/) of your hub.
...
3. Toggle the **Enabled**/**Disabled** switch to change the status of your hub.
    <Lightbox src="khulnasoft-iothub_enable_disable.webp" alt="" />
