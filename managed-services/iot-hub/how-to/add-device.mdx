...
3. Click **Add devices** in the devices tab of your hub.
    <Lightbox src="khulnasoft-iothub_add_device.webp" alt="" />
...
5. Choose a **security setting** for your device. You can either deny or allow insecure connections.
    <Lightbox src="khulnasoft-iothub_device_security.webp" alt="" />
6. Click **Add device to hub**.
7. Download the credentials of the device and keep them safe.
    <Lightbox src="khulnasoft-iothub_device_credentials.webp" alt="" />
...
8. Click **Close** to leave the wizard or **Add new device** to add another device.
    ...
    Once the device is added, you may continue to configure [IoT Hub Routes](/managed-services/iot-hub/how-to/create-route/) to export your data to other Khulnasoft services.
