...
3. Click the **Metrics** tab of your hub.
    ...
    <Lightbox src="khulnasoft-iothub_metrics_hub.webp" alt="" />
...
4. Click the device name to open the **Device information** view, which includes a device metrics section.
    <Lightbox src="khulnasoft-iothub_metrics_device.webp" alt="" />
...
On the Khulnasoft console, the device active state is represented with a green positive bar, while an inactive state will be represented by a red negative bar.
