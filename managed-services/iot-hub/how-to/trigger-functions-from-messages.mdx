...
In a typical use case, the same function will be used for many topics. It is possible to achieve this by using MQTT wildcards in the route topic. You can then rely on the `X-Mqtt-Topic` HTTP header in your Serverless Function for your topic-based processing. See [this blog post](https://www.khulnasoft.com/en/blog/khulnasoft-iot-hub-introduction-to-mqtt-topics/) for more information about MQTT topics.
