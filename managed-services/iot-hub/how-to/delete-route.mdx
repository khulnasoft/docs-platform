...
Currently, the following routes are available:
 ...
 - **Khulnasoft Object Storage route** allowing you to store your messages in your Khulnasoft [Object Storage](https://www.khulnasoft.com/en/object-storage/) bucket.
...
4. Click the <Icon name="more" /> icon next to the route you want to delete, and select **Delete** from the drop-down menu.
    <Lightbox src="khulnasoft-iothub_routes_delete.webp" alt="" />
