...
An MQTT WebClient is embedded in the [Khulnasoft console](https://console.khulnasoft.com/iot-hub/hubs).
...
- [Added a device](/managed-services/iot-hub/how-to/add-device/) that allows insecure connections to your hub
...
<Lightbox src="khulnasoft-iothub-webclient.webp" size="large" alt=""/>

<Message type="note">
  To learn more about MQTT, refer to [An Introduction to the MQTT protocol](https://www.khulnasoft.com/en/blog/introduction-to-mqtt-protocol/) blog post.
</Message>
