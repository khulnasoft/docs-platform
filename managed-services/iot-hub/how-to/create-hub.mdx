...
5. Click **Create** or **Create and add device**.
    <Message type="note">
      If you want to add a first device to the hub, click **Create hub and add device** and add your device using our [documentation on how to add a device](/managed-services/iot-hub/how-to/add-device/).
    </Message>
