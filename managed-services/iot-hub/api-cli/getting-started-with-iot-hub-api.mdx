...
In this tutorial we will use the API through the well known utility [curl](https://curl.haxx.se/). This will show you how to create Hubs and Devices, as well as more advanced features of the Khulnasoft IoT Hub: Hub Events and Routes.

The API reference is here: [IoT API](https://www.khulnasoft.com/en/developers/api/iot/)
...
```bash
IOT_API="https://api.khulnasoft.com/iot/v1/regions/fr-par"
