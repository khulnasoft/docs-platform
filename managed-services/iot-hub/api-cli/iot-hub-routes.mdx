...
Routes are integrations with the Khulnasoft ecosystem: they can forward MQTT messages to Khulnasoft services.
...
- Installed the [Khulnasoft CLI](https://github.com/khulnasoft/khulnasoft-cli#khulnasoft-cli-v2) and [read the accompanying IoT document](/managed-services/iot-hub/api-cli/getting-started-with-iot-hub-cli/)
- Installed and configured [`s3cmd`](/tutorials/s3cmd/) for Khulnasoft

## Amazon S3 Routes

The Amazon S3 route allows you to put the payload of MQTT messages directly into Khulnasoft's Object Storage.
...
This tutorial covers the **PostgreSQL** database system. You can use a [Khulnasoft Database instance](https://console.khulnasoft.com/rdb/instances), or any other PostgreSQL instance publicly accessible.
...
You can use a [Khulnasoft Instance](https://console.khulnasoft.com/instance/servers), or any other machine with a public IP address.
