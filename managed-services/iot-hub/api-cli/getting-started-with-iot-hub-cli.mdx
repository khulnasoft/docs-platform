---
meta:
  title: Getting started with the Khulnasoft IoT Hub CLI
  description: This page explains how to use the IoT Hub from the command line using the Khulnasoft CLI
content:
  h1: Getting started with the Khulnasoft IoT Hub CLI
  paragraph: This page explains how to use the IoT Hub from the command line using the Khulnasoft CLI
categories:
  - managed-services
  - iot-hub
dates:
...
In this tutorial we will use the API through the Khulnasoft command line interface [CLI](https://github.com/khulnasoft/khulnasoft-cli#Installation). This will show you how to create Hubs and Devices, as well as more advanced features of the Khulnasoft IoT Hub: Hub Events and Routes.

You can find the API reference documentation at the following link: [IoT API](https://www.khulnasoft.com/en/developers/api/iot/)
...
You can harness the real power of MQTT Pub/Sub with this blog post: [An Introduction to the MQTT protocol](https://www.khulnasoft.com/en/blog/introduction-to-mqtt-protocol/).
