...
meta:
  ...
  description: Step-by-step guide to creating groups in Khulnasoft IAM.
content:
  h1: How to create an IAM group
  paragraph: Step-by-step guide to creating groups in Khulnasoft IAM.
dates:
...
3. Click **+ Create group**. The group creation wizard displays:
    <Lightbox src="khulnasoft-create-group.webp" alt="" />
