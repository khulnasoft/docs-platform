...
meta:
  ...
  description: Learn how to manage applications using Khulnasoft IAM.
content:
  h1: How to manage IAM applications
  paragraph: Learn how to manage applications using Khulnasoft IAM.
dates:
...
2. Click **Delete application**. A warning displays, asking you to confirm your action:
    <Lightbox src="khulnasoft-delete-application-popup.webp" alt="A pop up box displaying a warning: Warning: This will permanently delete your application. This action is irreversible and will automatically delete the application's API keys." />
