...
meta:
  ...
  description: Step-by-step guide to managing your API keys in Khulnasoft IAM.
content:
  h1: How to manage API keys
  paragraph: Step-by-step guide to managing your API keys in Khulnasoft IAM.
dates:
...
1. Click **Identity and Access Management (IAM)** from the top-right of your [**Organization Dashboard**](https://console.khulnasoft.com/organization) in the Khulnasoft console. You are taken to your [Identity and Access Management dashboard](https://console.khulnasoft.com/iam/users).
...
3. Click the <Icon name="more" /> icon next to the API key you want to edit, and select **Edit**. The following screen displays:
    <Lightbox src="khulnasoft-edit-api-key.webp" alt="" />

4. Edit the API key as required:
    - Edit the **description**, and/or
    - Change the [preferred Project](/identity-and-access-management/iam/concepts/#preferred-project) for Object Storage
