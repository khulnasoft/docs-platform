...
meta:
  ...
  description: Instructions on managing groups within Khulnasoft IAM.
content:
  h1: How to manage IAM groups
  paragraph: Instructions on managing groups within Khulnasoft IAM.
dates:
...
1. Click **Identity and Access Management (IAM)** from the top-right of your [Organization Dashboard](https://console.khulnasoft.com/organization) in the Khulnasoft console. The **Users** tab of the [Identity and Access Management dashboard](https://console.khulnasoft.com/iam/applications) displays.
...
1. In the **Users** panel, click **Add users**. A pop-up displays:
    <Lightbox src="khulnasoft-add-user-to-group.webp" alt="" />
...
2. Click **Delete group**. A warning displays, asking you to confirm your action:
    <Lightbox src="khulnasoft-delete-group.webp" alt="A pop up box displaying a warning: Warning: This will permanently delete your group. This action is irreversible and could delete permissions for group members. Policies attached to users and applications via this group will no longer apply." />
