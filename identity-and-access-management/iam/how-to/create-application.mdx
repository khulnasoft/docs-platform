...
meta:
  ...
  description: Steps to create applications within Khulnasoft IAM.
content:
  h1: How to create an IAM application
  paragraph: Steps to create applications within Khulnasoft IAM.
dates:
...
1. Click **Identity and Access Management (IAM)** from your [**Organization Dashboard**](https://console.khulnasoft.com/organization) in the Khulnasoft console. The **Users** tab of the [Identity and Access Management dashboard](https://console.khulnasoft.com/iam/users) displays.
...
3. Click [Create application](https://console.khulnasoft.com/iam/applications/create). The creation wizard displays:
