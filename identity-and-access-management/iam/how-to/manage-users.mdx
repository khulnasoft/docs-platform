...
meta:
  ...
  description: Instructions for managing user accounts in Khulnasoft IAM.
content:
  h1: How to manage IAM users
  paragraph: Instructions for managing user accounts in Khulnasoft IAM.
dates:
...
<Lightbox src="khulnasoft-user-info.webp" alt="" />
...
<Lightbox src="khulnasoft-groups-overview.webp" alt="" />
...
1. From the user's [Overview tab](#how-to-access-the-user-overview), click the **Credentials** tab.
    ...
    <Lightbox src="khulnasoft-api-key.webp" alt="" />
    <Message type="note">
...
1. From the user's [**Overview** tab](#how-to-access-the-user-overview), scroll down to the **Remove user** panel:
    <Lightbox src="khulnasoft-remove-user.webp" alt="" />
2. Click **Remove user**. A warning displays, asking you to confirm your action:
    <Lightbox src="khulnasoft-remove-user-popup.webp" alt="A pop up box displaying a warning: Removing a user from this Organization automatically deletes their API keys, and any policies directly attached to them become orphaned" />
