...
meta:
  ...
  description: Quickstart guide to setting up and using Khulnasoft IAM.
content:
  h1: IAM - Quickstart
  paragraph: Quickstart guide to setting up and using Khulnasoft IAM.
dates:
  validation: 2024-06-26
  posted: 2022-06-10
---

**I**dentity and **A**ccess **M**anagement (IAM) allows you to share access to the management of your Khulnasoft resources and Organization settings, in a controlled and secure manner. With IAM, you can invite other users to your [Organization](/identity-and-access-management/iam/concepts/#organization), as well as create IAM applications that represent non-human users with their own API keys. You define permissions for users and applications in your Organization via highly customizable [policies](/identity-and-access-management/iam/concepts/#policy). Policies let you specify exactly what rights users and applications (or groups of users and applications) should have within your Organization.
...
1. Click **Identity and Access Management (IAM)** from the top-right of your [**Organization Dashboard**](https://console.khulnasoft.com/organization) in the Khulnasoft console. The **Users** tab of the [Identity and Access Management dashboard](https://console.khulnasoft.com/iam/users) displays.
    <Lightbox src="khulnasoft-iam-users-dashboard.webp" alt="" />
2. Click **+ Add user**. The following screen displays:
    <Lightbox src="khulnasoft-iam-invite-user.webp" alt="" />
...
4. Click **Invite** to send the invitation.
    The user receives an email inviting them to accept your invitation. If they do not already have a Khulnasoft account, they will be prompted to [create one](/console/account/how-to/create-an-account/) first.
...
2. Click the **Applications** tab. A list of the Organization's existing IAM applications displays.
    <Lightbox src="khulnasoft-iam-applications.webp" alt="" />
...
2. Click the **Policies** tab. A list of the Organization's existing policies displays:
    <Lightbox src="khulnasoft-iam-policies.webp" alt="" />
3. Click **Create policy**. The creation wizard displays:
    <Lightbox src="khulnasoft-iam-create-policy-1.webp" alt="" />
4. Complete the steps on the first page of the creation wizard:
    - Enter a **name** for the policy,
    - Enter a **description** (optional),
    - Select a **principal**, who will be the target of your policy. The [principal](/identity-and-access-management/iam/concepts/#principal) should be the user, application, or group who you want to grant specific permissions to through this policy.
...
5. Click **Add rules** to progress to the next part of the policy creation wizard.
    <Lightbox src="khulnasoft-iam-create-policy-2.webp" alt="" />
    <Message type="tip">
