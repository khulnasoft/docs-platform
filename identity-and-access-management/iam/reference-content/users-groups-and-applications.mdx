...
meta:
  ...
  description: Manage users, groups, and applications within Khulnasoft IAM.
content:
  h1: Users, groups, and applications
  paragraph: Manage users, groups, and applications within Khulnasoft IAM.
dates:
  validation: 2024-10-16
---

IAM users, groups, and applications are principals in Khulnasoft Organizations. A principal is an entity that can be attached to policy.
...
<Message type="note">
  Applications cannot by definition have access to the Khulnasoft console, as they have only an API key and no account themselves (they are not human account root users).
</Message>
