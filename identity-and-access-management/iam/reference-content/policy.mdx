...
meta:
  title: IAM Policies
  description: Detailed additional content for policies within Khulnasoft IAM.
content:
  h1: Policies
  paragraph: Detailed additional content for policies within Khulnasoft IAM.
tags: iam
dates:
...
IAM Policies are statements that define the permissions of users, groups, and applications in Khulnasoft Organizations.
...
<Message type="note">
  You can find a detailed list of all permission sets available at Khulnasoft in the permission sets [reference page](/identity-and-access-management/iam/reference-content/permission-sets/).
</Message>
