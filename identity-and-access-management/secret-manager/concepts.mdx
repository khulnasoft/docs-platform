...
meta:
  ...
  description: Discover essential concepts of Khulnasoft Secret Manager, including secret versioning, ephemeral policies, and path management.
content:
  h1: Concepts
  paragraph: Discover essential concepts of Khulnasoft Secret Manager, including secret versioning, ephemeral policies, and path management.
