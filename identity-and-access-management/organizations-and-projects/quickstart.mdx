...
meta:
  ...
  description: This page shows you how to get started with Khulnasoft Organizations and Projects.
content:
  h1: Organizations and Projects - Quickstart
  paragraph: This page shows you how to get started with Khulnasoft Organizations and Projects.
...
When you [create a Khulnasoft account](/console/account/how-to/create-an-account/), an Organization, of which you are the [Owner](/identity-and-access-management/iam/concepts/#owner), is created for you.
...
1. Open the terminal application by clicking on the corresponding icon.
    <Lightbox src="khulnasoft-terminal-icon.webp" alt="Terminal Icon"/>
...
1. Download and install [PuTTY](https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html) on your local computer. The **PuTTYgen** application is automatically installed along with the main PuTTY application.
    <Lightbox src="khulnasoft-puttygen-app.webp" alt="PuTTYgen App"/>
...
3. Select **EdDSA** and click the **Generate** button. You can also add a passphrase before generating the key to increase security.
    <Lightbox src="khulnasoft-puttygen-01.webp" alt="PuTTYgen Generate Key"/>
4. Move the mouse around the blank area as instructed to generate randomness.
    <Lightbox src="khulnasoft-puttygen-02.webp" alt="PuTTYgen Randomness"/>

    The public and private key are generated, and the following screen will display:
    <Lightbox src="khulnasoft-puttygen-03.webp" alt="PuTTYgen Keys Generated"/>
...
### How to upload the public SSH key to your Khulnasoft Project

You must upload the content of the public part of the SSH key pair you just created to the Khulnasoft interface. This is then associated with your Project and can be transferred to your Instances during the boot process.

1. From the [Khulnasoft console](https://console.khulnasoft.com), navigate to the [Credentials](/identity-and-access-management/organizations-and-projects/concepts/#ssh-key) tab of your Project Dashboard.
...
1. Click **Project Dashboard** in the [Khulnasoft console](https://console.khulnasoft.com) side menu to check if you are logged in the correct Project.
