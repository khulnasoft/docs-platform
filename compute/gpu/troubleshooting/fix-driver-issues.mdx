...
meta:
  ...
  description: Resolve GPU issues on Khulnasoft GPU Instances after installing Nvidia drivers with our troubleshooting guide.
content:
  h1: Fixing GPU issues after installing nvidia-driver packages
  paragraph: Resolve GPU issues on Khulnasoft GPU Instances after installing Nvidia drivers with our troubleshooting guide.
...
All Khulnasoft [GPU Instances](/compute/gpu/quickstart/) come with a Nvidia driver preinstalled. This means you do not have to install them by yourself.
