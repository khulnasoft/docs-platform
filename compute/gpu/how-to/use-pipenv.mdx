---
meta:
  title: How to use Pipenv to create virtual environments on Khulnasoft GPU Instances
  description: Learn how to use Pipenv to create and manage virtual environments for your Python projects on Khulnasoft GPU Instances.
content:
  h1: How to use Pipenv to create virtual environments on Khulnasoft GPU Instances
  paragraph: This guide explains how to use Pipenv to create and manage virtual environments for Python projects on Khulnasoft GPU Instances.
...
**Pipenv is preinstalled on all Khulnasoft AI Docker images for GPU Instances.** When you launch one of these Docker images, you are placed in an activated Pipenv virtual environment with preinstalled packages and tools. You can also create your own virtual environments using Pipenv.
...
Refer to our [dedicated documentation](/compute/gpu/how-to/use-preinstalled-env/#working-with-the-pre-installed-environment-on-ubuntu-focal-gpu-os11) on how to access the Pipenv virtual environment from your Khulnasoft GPU Instance.
...
1. Connect to your GPU Instance via SSH and launch a Khulnasoft AI Docker container.
