...
<Message type="note">
  ...
  * To avoid confusion, we will use the term GPU Instance in this document to designate the Khulnasoft GPU Instance, and *MIG partition* in the context of the MIG feature.
</Message>
...
<Lightbox src="khulnasoft-multi-instance-gpu.webp" size="large" alt="" />
...
- An [MIG-compatible GPU Instance](/compute/gpu/how-to/create-manage-gpu-instance/)
...
<Lightbox src="khulnasoft-jupyter-gpu-instance.webp" size="large" alt="" />
