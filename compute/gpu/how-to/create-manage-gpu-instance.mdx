...
Khulnasoft GPU Instances feature dedicated high-end Nvidia GPUs, making them optimal for tasks such as data processing, artificial intelligence, rendering, and video encoding.
...
When you have completed your calculations using the GPU Instance, [deletion can be done through the Khulnasoft console](/compute/instances/how-to/delete-instance/), API, or our CLI tools.
