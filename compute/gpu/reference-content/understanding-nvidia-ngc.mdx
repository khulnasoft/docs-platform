...
meta:
  ...
  description: This section provides information about NVIDIA NGC (NVIDIA GPU Cloud) on Khulnasoft
content:
  h1: Understanding NVIDIA GPU Cloud (NGC)
  paragraph: This section provides information about NVIDIA NGC (NVIDIA GPU Cloud) on Khulnasoft
...
NVIDIA provides access to NVIDIA GPU Cloud (NGC) through providers including Khulnasoft. NGC is a cloud-based platform that offers a comprehensive set of GPU-optimized software and tools for various deep learning, machine learning, and AI (Artificial Intelligence) tasks. It is designed to simplify deploying, managing, and utilizing AI and data science frameworks on NVIDIA GPUs.

Unleash the power of your applications' deployment with Khulnasoft and NGC, where seamless deployment is as effortless as following these three simple steps:
1. Deploy your Khulnasoft GPU Instance from the [Khulnasoft console](https://console.khulnasoft.com/instance/servers/create?imageKey=7bdc1afb-231f-486a-9b85-1b0478bc0e4a&offerName=RENDER-S&zone=fr-par-2), the [CLI tools](https://github.com/khulnasoft/khulnasoft-cli), or the [Khulnasoft API](https://www.khulnasoft.com/en/developers/api/instance/).<sup>1</sup>
    <sup>1</sup> You need [GPU Instance quotas](/identity-and-access-management/organizations-and-projects/additional-content/organization-quotas/#gpu-instances) to be able to deploy GPU Instances.
