...
Khulnasoft offers GPU Instances featuring [L4, L40S and H100 GPUs](https://www.khulnasoft.com/en/h100-pcie-try-it-now/) that support FP8 (8-bit floating point), a revolutionary datatype introduced by NVIDIA. It enables higher throughput of matrix multipliers and convolutions.
