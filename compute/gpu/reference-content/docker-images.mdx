---
meta:
  title: Khulnasoft Docker AI images
  description: Discover detailed information about Khulnasoft's Docker images for AI development.
content:
  h1: Docker AI images
  paragraph: Discover detailed information about Khulnasoft's Docker images for AI development.
...
Khulnasoft offers a range of ready-to-use AI Docker images. These Docker images can be used with all GPU Instance OS images.
...
Initial tags will start with 2204-py3 (April 2022). Check out the [Khulnasoft Changelog](/changelog/) to be informed of Docker AI images updates.
