...
meta:
  ...
  description: This page shows you how to get started with Khulnasoft Instances.
content:
  h1: Instances - Quickstart
  paragraph: This page shows you how to get started with Khulnasoft Instances.
