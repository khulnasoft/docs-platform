...
The newest Ubuntu 24.04 Noble Numbat Instances created before June 19, 2024, may have their Khulnasoft PPA pointing to the staging PPA.
...
```
rm -f /etc/apt/sources.list.d/khulnasoft-ubuntu-staging-noble.sources
