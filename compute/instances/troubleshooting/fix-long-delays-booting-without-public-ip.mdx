...
meta:
  ...
  description: This page explains how to avoid long delays when booting a Khulnasoft Instance without a public IP
content:
  h1: Fix long delays when booting without a public IP
  paragraph: This page explains how to avoid long delays when booting a Khulnasoft Instance without a public IP
