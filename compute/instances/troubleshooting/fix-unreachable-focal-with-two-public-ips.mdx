...
A modified `cloud-init` package named `cloud-init_24.2-0ubuntu1~20.04.1+khulnasoft` has been added to Khulnasoft's stable PPA to work around this situation.
