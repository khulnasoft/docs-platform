---
meta:
  title: Routing public IPs to Instances using the Khulnasoft CLI/API
  description: This page explains how to route public IPs to Instances using the Khulnasoft CLI/API
content:
  h1: Routing public IPs to Instances using the Khulnasoft CLI/API
  paragraph: This page explains how to route public IPs to Instances using the Khulnasoft CLI/API
tags: routed ip cloud khulnasoft-api transition
dates:
...
<Message type="note">
    This guide is part of Khulnasoft's [IP Mobility project](https://www.khulnasoft.com/en/blog/ip-mobility-removing-nat/) and will evolve over time.
</Message>
...
## How to use routed IPs with the Khulnasoft CLI

Since version 2.20.0, the [Khulnasoft CLI tool](https://github.com/khulnasoft/khulnasoft-cli) has native support for the routed IP feature.
 ...
 * The `API_URL` variable contains the following value: `https://api.khulnasoft.com/instance/v1/zones/<zone>`
...
You can request routed IPs using the Khulnasoft API. Available IP types are IPv4 and IPv6.
    ...
    <TabsTab label="Response">
        ```json
        {
            "server": {
                ...
                "bootscript": {
                    "architecture": "x86_64",
                    "bootcmdargs": "LINUX_COMMON khulnasoft boot=local nbd.max_part=16",
                    "default": true,
                    "dtb": "",
