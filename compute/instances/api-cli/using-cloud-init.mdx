---
meta:
  title: Using cloud-init with Khulnasoft API and CLI
  description: Learn how to effectively use cloud-init with Khulnasoft API and CLI for seamless cloud infrastructure deployment.
content:
  h1: Using cloud-init with Khulnasoft API and CLI
  paragraph: Learn how to effectively use cloud-init with Khulnasoft API and CLI for seamless cloud infrastructure deployment.
tags: cloud-init cloud init khulnasoft-api cli
dates:
...
- Downloaded the [latest version of the Khulnasoft CLI](https://github.com/khulnasoft/khulnasoft-cli)
...
1. Create your Instance by specifying the path to your cloud-init configuration file.
    ...
    ```
    <Message type="note">
      `@/path/to/cloud-config-file` is the path of your [Cloud-Init](/compute/instances/how-to/use-boot-modes/#how-to-use-cloud-init) configuration file. Edit it as you wish.
    </Message>
2. Start your Instance
    ...
    Since [version 2.3.1](https://github.com/khulnasoft/khulnasoft-cli/releases/tag/v2.3.1) of the Khulnasoft CLI a shorter command is available:
