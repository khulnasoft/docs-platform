...
meta:
  ...
  description: This page shows you how to use placement groups on Instances using the Khulnasoft API
content:
  h1: Using placement groups with the API
  paragraph: This page shows you how to use placement groups on Instances using the Khulnasoft API
categories:
  - compute
...
If you prefer a visual environment, discover [how to manage placement groups from the Khulnasoft console](/compute/instances/how-to/use-placement-groups/).
...
curl -q \
	...
	https://api.khulnasoft.com/instance/v1/zones/fr-par-1/placement_groups/
```
...
curl -q \
	-H "X-Auth-Token: $SCW_SECRET_KEY" \
	-H 'Content-Type: application/json'  \
	https://api.khulnasoft.com/instance/v1/zones/fr-par-1/placement_groups/ae5c1189-f421-4285-988b-80d29267ddc4
{
  "placement_group": {
    "name": "cc-test",
...
curl -q \
	-H "X-Auth-Token: $SCW_SECRET_KEY" \
	-H 'Content-Type: application/json' \
	https://api.khulnasoft.com/instance/v1/zones/fr-par-1/placement_groups/ae5c1189-f421-4285-988b-80d29267ddc4/servers
{
  "servers": []
}
```
...
curl -q \
	...
	\
	https://api.khulnasoft.com/instance/v1/zones/fr-par-1/servers/a3505194-b875-4bda-87c0-058466a6ea6d
```
...
curl -q \
	...
	https://api.khulnasoft.com/instance/v1/zones/fr-par-1/servers/dab279bc-aa4d-4ba1-841c-ba04cc23eb00
```
...
We hope that placement groups will help you build more performant and more reliable systems with Khulnasoft's products.

For more information and to see the full capabilities of placement groups, refer to the [full API documentation](https://www.khulnasoft.com/en/developers/api/instance/#path-placement-groups).
