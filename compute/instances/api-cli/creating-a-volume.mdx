...
meta:
  ...
  description: This page explains how to create a Block Storage volume using the Khulnasoft API.
content:
  h1: Creating a Block Storage volume via the Instance API
  paragraph: This page explains how to create a Block Storage volume using the Khulnasoft API.
...
1. Create a block volume from the API by launching the following command:
    ...
    curl -q \
      ...
      https://api.khulnasoft.com/instance/v1/zones/fr-par-1/volumes
    ```
