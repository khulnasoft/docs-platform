...
meta:
  ...
  description: Discover Khulnasoft's learning range of Instances, including options like the Stardust Instance, ideal for educational purposes.
content:
  h1: The right Instance for learning purposes
  paragraph: Discover Khulnasoft's learning range of Instances, including options like the Stardust Instance, ideal for educational purposes.
dates:
...
Khulnasoft's **Learning** range includes our Stardust Instances. Stardust Instances are the perfect Instances for small workloads and simple applications. They are built to host small internal applications, staging environments or low-traffic web servers.
...
Try Khulnasoft Stardust Instances with the following tutorials:
