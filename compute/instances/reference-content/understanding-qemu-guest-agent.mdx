---
meta:
  title: Understanding the QEMU Guest Agent in Khulnasoft Instances
  description: Discover how the QEMU Guest Agent works with Khulnasoft Instances.
content:
  h1: Understanding the QEMU Guest Agent in Khulnasoft Instances
  paragraph: Discover how the QEMU Guest Agent works with Khulnasoft Instances.
...
Some features of the Instances product require Khulnasoft's infrastructure to query or exchange information with your Instance. To enable this communication, a software component must run on the guest operating system: the QEMU Guest Agent (QGA).
...
Since March 1st, 2024, all Khulnasoft-provided GNU/Linux and InstantApp images for Instances come with QGA pre-installed and enabled by default.
...
Follow these steps to disable QGA and the associated Khulnasoft features.

### Deactivation

<Message type="important">
  Disabling QGA is not recommended, as doing so also disables all the [Khulnasoft features](#what-are-the-features-provided-by-qga) it provides.
</Message>
