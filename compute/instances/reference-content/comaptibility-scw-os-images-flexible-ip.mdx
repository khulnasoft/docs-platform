...
meta:
  ...
  description: This page shows the currently known state of compatibility between Khulnasoft Instance OS Images and the different combinations of Flexible IPs types.
content:
  h1: Compatibility between OS Images and different Flexible IP type combinations
  paragraph: This page shows the currently known state of compatibility between Khulnasoft Instance OS Images and the different combinations of Flexible IPs types.
...
This page presents the currently known state of compatibility between Khulnasoft Instance OS Images and the different combinations of Flexible IPs types.
...
| **fedora_41**             | `202410311306`           | `67e3f2fd`              |       ✅        |       ✅        |       ⚠️<sup>4</sup>        |       ⚠️<sup>4</sup>        |       ✅<sup>6</sup>       |       ✅<sup>6</sup>        |
