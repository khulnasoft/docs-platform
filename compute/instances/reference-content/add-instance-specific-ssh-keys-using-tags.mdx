...
meta:
  ...
  description: Find out how to use tags to add Instance-specific SSH keys on Khulnasoft.
content:
  h1: Using tags to add Instance-specific SSH keys
  paragraph: Find out how to use tags to add Instance-specific SSH keys on Khulnasoft.
categories:
  - compute
dates:
...
#   -- Add keys on your Khulnasoft account https://cloud.khulnasoft.com/#/credentials
#   -- Add keys using server tags - https://cloud.khulnasoft.com/#/servers/<INSTANCE_ID>
...
1. Click **Instances** in the **Compute** section of the side menu. The [Instances overview](https://console.khulnasoft.com/Instance/servers) displays.
...
4. Once you have added the SSH key tag(s), they will be saved automatically in the Khulnasoft console.
...
You now have configured an Instance-specific SSH key through the Khulnasoft console.
