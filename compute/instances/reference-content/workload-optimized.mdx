...
meta:
  ...
  description: Find out more about Instances from Khulnasoft's Workload-Optimized range, such as POP2-HC, POP2-HN, and POP2-HM.
content:
  h1: The right Instance for workload purposes
  paragraph: Find out more about Instances from Khulnasoft's Workload-Optimized range.
dates:
...
Khulnasoft's **Workload-Optimized** range includes POP2-HM (High Memory), POP2-HN (High Network) and POP2-HC (High CPU). Equipped with dedicated vCPUs, these Instances are optimized for workload-intensive applications.
...
## Matching use cases
Try Khulnasoft Workload-Optimized Instances with the following tutorials:
