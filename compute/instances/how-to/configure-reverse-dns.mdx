...
meta:
  ...
  description: This page explains how to configure the reverse DNS record of a Khulnasoft Instance.
content:
  h1: How to configure reverse DNS of an Instance
  paragraph: This page explains how to configure the reverse DNS record of a Khulnasoft Instance.
