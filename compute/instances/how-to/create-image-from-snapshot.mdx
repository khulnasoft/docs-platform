...
meta:
  ...
  description: This page explains how to create an image from a snapshot of a Khulnasoft Instance.
content:
  h1: How to create an image from a snapshot
  paragraph: This page explains how to create an image from a snapshot of a Khulnasoft Instance.
...
## Creating an image from a snapshot via the Khulnasoft console
...
## Creating an image via the Khulnasoft CLI

You can also create an image using the [Khulnasoft CLI](/developer-tools/khulnasoft-cli/quickstart/). Use the following command:
...
## Creating an image via the Khulnasoft API

You can also create an image using the [Khulnasoft API](https://www.khulnasoft.com/en/developers/api/instance/#path-images-create-an-instance-image). Use the following `curl` command:

```bash
curl --location "https://api.khulnasoft.com/instance/v1/zones/$SCW_AVAILABILITY_ZONE/images" \
