...
meta:
  ...
  description: Learn how to create a volume snapshot for your Instance with this easy-to-follow guide.
content:
  h1: How to create a snapshot
  paragraph: Learn how to create a volume snapshot for your Instance with this easy-to-follow guide.
...
2. Click the **Snapshots** tab.
    <Lightbox src="khulnasoft-create-a-snapshot.webp" alt="" />
...
4. Click **Volume from snapshot**. A pop-up displays.
    <Lightbox src="khulnasoft-volume-from-snapshot.webp" alt="" />
5. Enter a name for the volume (or use the default suggested name), select the volume type, and click **Create volume from Snapshot**.
    ...
    The volume is created, and can be viewed in the [Volumes tab](https://console.khulnasoft.com/instance/volumes). Check out our documentation on [attaching volumes](/storage/block/how-to/attach-a-volume/) and [mounting volumes](/storage/block/api-cli/managing-a-volume/#mounting-the-block-volume) to learn how to use the volume with your Instances.
...
<Lightbox src="khulnasoft-create-from-snapshot.webp" alt="" />
