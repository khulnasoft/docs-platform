...
meta:
  ...
  description: This page explains how to use Private Networks for Khulnasoft Instances
content:
  h1: How to use Private Networks with your Instances
  paragraph: This page explains how to use Private Networks for Khulnasoft Instances
...
If you want to create a Private Network without immediately attaching any resources or create it in a specific VPC or with a custom CIDR block, follow [this procedure instead](/network/vpc/how-to/create-private-network/).
...
<Message type="note">
  Before deleting a Private Network, you must [detach](/compute/instances/how-to/use-private-networks/#how-to-detach-instances-from-a-private-network) all Instances attached to it.
</Message>
