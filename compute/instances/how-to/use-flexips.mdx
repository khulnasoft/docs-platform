...
meta:
  ...
  description: This page explains how to use flexible IP addresses with Khulnasoft Instances.
content:
  h1: How to use flexible IP addresses with Instances
  paragraph: This page explains how to use flexible IP addresses with Khulnasoft Instances.
...
This page provides guidance on using [flexible IP addresses](/compute/instances/concepts/#flexible-ip) with your Khulnasoft Instances.
