---
meta:
  title: Using the snapshot import/export feature from the Khulnasoft console
  description: This page explains how to import/export snapshots of Instances using the Khulnasoft console.
content:
  h1: Using the snapshot import/export feature from the Khulnasoft console
  paragraph: This page explains how to import/export snapshots of Instances using the Khulnasoft console.
...
The snapshot transfer feature allows you to export or import Instance snapshots. Snapshots are created using the QCOW2 format and stored in a Khulnasoft Object Storage Bucket.

A snapshot stored in a Khulnasoft Object Storage bucket can be imported into any Availability Zone (AZ), as long as it is in the same region as the bucket. This allows you to create Instances in different AZs within the same region. For example, you can deploy Instances in `fr-par-2` based on the snapshot exported from an Instance in `fr-par-1`.
...
1. Click the [Instances section](https://console.khulnasoft.com/instance/servers) of the Khulnasoft console, then click the **Snapshots** tab.
...
1. Click the [Object Storage section](https://console.khulnasoft.com/object-storage/buckets) of the Khulnasoft console, then click the bucket to which you have exported the snapshot. The snapshot copy should display in the list of your objects.
    <Message type="note">
...
1. Click the [Instances section](https://console.khulnasoft.com/instance/servers) of the Khulnasoft console, then click **+Create Instance**.
