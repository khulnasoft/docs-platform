...
More information on the migration steps is provided in [our reference documentation](https://www.khulnasoft.com/en/docs/containers/kubernetes/reference-content/secure-cluster-with-private-network/).
