...
The feature is now available in Khulnasoft console (new node pools), Khulnasoft API, CLI and [Terraform](https://registry.terraform.io/providers/khulnasoft/khulnasoft/latest/docs/resources/k8s_pool#public_ip_disabled) (public_ip_disabled)

Find more details on our [reference documentation](https://www.khulnasoft.com/en/docs/containers/kubernetes/reference-content/secure-cluster-with-private-network/).
