...
Dedicated control planes are available in the [Khulnasoft console](https://console.khulnasoft.com/), the CLI, and Terraform. Refer to [our documentation](/containers/kubernetes/reference-content/kubernetes-control-plane-offers/) for more information.
