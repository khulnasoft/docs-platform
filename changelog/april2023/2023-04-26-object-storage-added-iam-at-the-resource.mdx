...
Check out our documentation to start [setting up granular access to Object Storage](https://www.khulnasoft.com/en/docs/storage/object/api-cli/combining-iam-and-object-storage).
