---
meta:
  title: Khulnasoft Support FAQ
  description: Discover Khulnasoft Support plans.
content:
  h1: Khulnasoft Support
dates:
  validation: 2024-09-30
category: console
productIcon: SupportProductIcon
---

## What is my current support plan?
You can find your support plan on [the support plan page within the Khulnasoft console](https://console.khulnasoft.com/support/plans). The free Basic support plan is included for all Khulnasoft customers automatically.

## How can I change my current support plan?
You can [change your support plan](/console/account/how-to/configure-support-plans/) on the support plan page via the Khulnasoft console.
...
You can create and track your support tickets from the Khulnasoft console. [Follow this how to](/console/account/how-to/open-a-support-ticket/) for more details.

## How do I report abuse or suspected abuse coming from the Khulnasoft network?
To report abuse or suspicion of abuse from our network, open a new abuse report via [abuse.khulnasoft.com](https://abuse.khulnasoft.com). Include as many details as possible in your report such as logs, header, URL and any information you might find relevant in your report. 
<Message type="tip">
  More information on how to report abuse can be found in [Khulnasoft’s Abuse notice](https://www.khulnasoft.com/en/abuse-notice/).
</Message>
