...
* [Khulnasoft IoT Hub Overview](/managed-services/iot-hub/quickstart/)
...
Each IoT Hub can be fully configured both from the management console, and a powerful [REST-API](https://www.khulnasoft.com/en/developers/api/iot/).

## How secure is Khulnasoft IoT?
Khulnasoft IoT was designed with security in mind. Therefore, we implemented mutual authenticated TLS as the default authentication method. Each device needs its certificate+key pair to connect to the hub.
