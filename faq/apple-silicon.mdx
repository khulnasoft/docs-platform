...
To reinstall your Mac mini, navigate to the [Khulnasoft console](https://console.khulnasoft.com/), then go to the **Apple Silicon** page.
...
- `scw-agent`, a daemon maintained by Khulnasoft to provide essential integration services such as updating your ssh keys.
