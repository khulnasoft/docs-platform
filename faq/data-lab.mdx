...
meta:
  ...
  description: Discover Khulnasoft Distributed Data Lab powered by Apache Spark, and how to use it.
content:
...
You can request access to the Distributed Data Lab private beta by email via the [Khulnasoft betas](https://www.khulnasoft.com/fr/betas/#distributed-data-lab) page.
...
During the private beta, Khulnasoft Distributed Data Lab is free.
