...
<Lightbox src={["khulnasoft-Billing-FaaS-1-DEF.webp", "khulnasoft-Billing-FaaS-2-DEF.webp"]} size={"medium"}  alt={["Functions Billing", "Functions Billing"]} />
...
Build errors are sent to the Observability platform on Khulnasoft Cockpit.
...
Serverless Functions does not yet support Private Networks. However, you can use the Khulnasoft IP ranges defined  at [https://www.khulnasoft.com/en/peering/](https://www.khulnasoft.com/en/peering/) on Managed Databases and other products that allow IP filtering.
...
## How can I test my functions locally?
 ...
 Khulnasoft provides libraries to run your functions locally, for debugging, profiling, and testing purposes. Refer to the [dedicated documentation](/serverless/functions/reference-content/local-testing/) for more information.

## Where can I find some advanced code examples for functions?

Check out our [serverless-examples repository](https://github.com/khulnasoft/serverless-examples) for real world projects.
...
Khulnasoft Serverless Functions does not currently support Khulnasoft VPC or Private Networks, though this feature is under development.

To add network restrictions on your resource, consult the [list of prefixes used at Khulnasoft](https://www.khulnasoft.com/en/peering/). Note that Serverless resources do not have dedicated or predictable IP addresses.

## How can I attach Block Storage to a Serverless Function?

Khulnasoft Serverless Functions do not currently support attaching Block Storage. These functions are designed to be
