...
meta:
  title: Cockpit FAQ
  description: Discover Khulnasoft's Cockpit
content:
  h1: Cockpit
dates:
...
## How does Cockpit integrate with other Khulnasoft products?

Cockpit integrates seamlessly with Khulnasoft’s ecosystem. It provides pre-built dashboards in Grafana, and alerts to monitor other Khulnasoft resources' performance.

Refer to the [dedicated documentation page](/observability/cockpit/reference-content/cockpit-limitations/#product-integration-into-cockpit) for the whole list of Khulnasoft resources integrated with Cockpit.

## How am I billed for using Cockpit with my Khulnasoft data?

Cockpit is billed based on [pricing plans](https://console.khulnasoft.com/cockpit/plans).

Pricing plans specify:

- Retention time for your data:
    * includes data from [Khulnasoft resources integrated with Cockpit](/observability/cockpit/reference-content/cockpit-limitations/#product-integration-into-cockpit) and your custom data
- Monitoring and alerting for your Khulnasoft data:
    * includes data from [Khulnasoft resources integrated with Cockpit only](/observability/cockpit/reference-content/cockpit-limitations/#product-integration-into-cockpit)

Additional costs apply for sending custom data to Cockpit. This means that you will be billed for sending **data from Khulnasoft resources that are not integrated with Cockpit**, or data from any other external resources.
...
Custom data is any data that is external to Khulnasoft, or **data from Khulnasoft resources not integrated with Cockpit**. Refer to the [dedicated documentation page](/observability/cockpit/reference-content/cockpit-limitations/#product-integration-into-cockpit) to find out which resources are integrated with Cockpit.

The retention time for your custom data depends on the [pricing plan](https://console.khulnasoft.com/cockpit/plans) you have selected.
...
**Starting April 2024, Khulnasoft will apply volume discounts to bill custom metrics**. This means that the monthly pricing for custom metrics will be calculated in levels. **Khulnasoft applies six levels of volume discounts.**
...
If you have not set up an agent, check out our [documentation](/observability/cockpit/how-to/send-metrics-with-grafana-alloy/) to find out how to
configure the Grafana Alloy agent, push your data, and visualize it in Grafana.

## Which Khulnasoft products are integrated into Cockpit?

Find out which Khulnasoft products are integrated into Cockpit in our [capabilities and limits documentation page](/observability/cockpit/reference-content/cockpit-limitations/#product-integration-into-cockpit).
...
<Message type="important">
 Sending metrics and logs for Khulnasoft resources or personal data using an external path is a billable feature. In addition, any data that you push yourself is billed, even if you send data from Khulnasoft products. Refer to the [product pricing](https://www.khulnasoft.com/en/pricing/?tags=available,managedservices-observability-cockpit) for more information.
</Message>
...
If you have created customized dashboards with data for your Khulnasoft resources before April 2024, you will need to update your queries in Grafana, with the new regionalized data sources.
