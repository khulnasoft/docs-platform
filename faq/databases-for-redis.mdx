...
meta:
  ...
  description: Discover Khulnasoft Managed Databases and how to access it for Redis™.
content:
...
## What is Khulnasoft Managed Database for Redis™
...
Based on the **Re**mote **Di**ctionary **S**erver technology,  Khulnasoft Managed Database for Redis™ stores your data in the RAM of the underlying machine rather than on a disk (SSD/HDD).
...
The combination of powerful in-memory data storage such as Redis™ and managing the resources set-up, securitization, scaling, and maintenance makes Khulnasoft Managed Database for Redis™ a handy solution to improve the usability of your application.
...
<Lightbox src="khulnasoft-schema-redis.webp" alt="" />
...
<Lightbox src="khulnasoft-endpoints-redis.webp" alt="" />
...
Currently, you can connect one Private Network to each Redis™ Database Instance in the Khulnasoft console. For standalone Instances, you can attach multiple Private Networks via the CLI or the API only.
...
<Lightbox src="khulnasoft-redis-node-types.webp" alt="Development: RED1-S, RED1-XS, RED1-2XS, RED1-micro and Production: RED1-XL, RED1-L, RED1-M" />
...
<Lightbox src="khulnasoft-redis-cluster.webp" alt="" />
...
Yes. You can change the default username and password anytime via the Khulnasoft API or the CLI.
...
<br/>
<sup>*</sup> <small>Redis is a trademark of Redis Labs Ltd. Any rights therein are reserved to Redis Labs Ltd. Any use by Khulnasoft is for referential purposes only and does not indicate any sponsorship, endorsement or affiliation between Redis and Khulnasoft. </small>