...
meta:
  title: Billing FAQ
  description: Discover billing methods, plans, and pricing for Khulnasoft products. Learn about invoicing details, billing events, pro-rata billing, invoice statuses, payment methods, and managing your billing efficiently.
content:
  h1: Billing
dates:
...
## How am I billed for Khulnasoft services?
...
For more information, refer to our dedicated [pricing page](https://www.khulnasoft.com/en/pricing/).
...
You can manage your billing from the [billing section](https://console.khulnasoft.com/billing/overview) of the Khulnasoft console. Your recent invoices as well as the consumption report for the current month are available for download.
Alternatively, you can retrieve your consumption information and download your invoices using the [API](https://www.khulnasoft.com/en/developers/api/billing/).
...
## Which payment methods does Khulnasoft accept?
...
You can add a billing contact directly from the User Account section of your Khulnasoft console.

1. Log into your Khulnasoft console.
...
4. Click **Save**.
    <Message type="important">
      The billing contact is only an administrative contact. It can not be used to connect to the Khulnasoft console.
    </Message>
...
If your validation code expires, please [contact our support team](https://console.khulnasoft.com/support/tickets/create) to request a new code.

## I tried to add a credit card but received the message 'Card already registered'

A credit card can only be registered once across all Organizations. If you receive this message, make sure you do not have the same card already registered to another Khulnasoft account.

If you only have one payment method and need to use it on more than one account, [contact our support team](https://console.khulnasoft.com/support/tickets/create) to request an individual verification.

## I've added a physical credit card, but it was declined. Why?

If your credit card complies with the payment requirements but still was declined, please [contact our support team](https://console.khulnasoft.com/support/tickets/create) for assistance.
...
If after that period you still do not receive it, contact your bank or credit card provider for assistance or [contact our support team](https://console.khulnasoft.com/support/tickets/create) to request a new code.
...
If your case does not match the situations above and you still cannot remove your credit card, [contact our support team](https://console.khulnasoft.com/support/tickets/create) for a manual verification.

## How can I change the country or region registered to my account?

It is not possible to edit your country and region directly from the Khulnasoft console. Please [contact our support team](https://console.khulnasoft.com/support/tickets/create) if you need to change this information.
...
If you were billed for resources that have been correctly stopped, please [contact our support team](https://console.khulnasoft.com/support/tickets/create), providing the name of the product and resource, and the date of deactivation.
...
Refer to the [Understanding Savings Plan](/console/billing/additional-content/understanding-savings-plans/) documentation page for more information.
...
Khulnasoft invoices are calculated at the end of each month, so you may receive a final invoice the month after closing your account. That corresponds to your outstanding consumption for your final month of activity.