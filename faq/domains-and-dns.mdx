...
If a domain name is unavailable, you can test a light variation of the desired name. You can also add a letter or a number. If you still encounter any issues, you can contact the [support team](https://console.khulnasoft.com/support/tickets).
...
All domains registered through [BookMyName](https://www.bookmyname.com/) or [Online](https://console.online.net/en/login) cannot yet be transferred to Khulnasoft Domains and DNS.
...
Due to a significant increase in domain pricing across various registrars, Khulnasoft domains will also experience a price increase.
...
Learn more on the Khulnasoft [API Documentation](https://www.khulnasoft.com/en/developers/api/domains-and-dns/) page.

## Is the DNS service IPv6 compatible?

Yes, the DNS service allows IPv6 addressing.

## What are Khulnasoft's DNS name servers?
