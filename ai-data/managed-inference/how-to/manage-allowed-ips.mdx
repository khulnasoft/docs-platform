...
content:
  h1: How to manage allowed IP addresses for Managed Inference deployments
  paragraph: This page explains how to configure allowed IP addresses for Managed Inference deployments
