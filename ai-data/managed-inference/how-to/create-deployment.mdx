---
meta:
  title: How to deploy a model on Khulnasoft Managed Inference
  description: This page explains how to deploy a model on Khulnasoft Managed Inference
content:
  h1: How to deploy a model on Khulnasoft Managed Inference
  paragraph: This page explains how to deploy a model on Khulnasoft Managed Inference
...
1. Click the **AI & Data** section of the [Khulnasoft console](https://console.khulnasoft.com/), and select **Managed Inference** from the side menu to access the Managed Inference dashboard.
