...
meta:
  ...
  description: Deploy your own secure Pixtral-12b-2409 model with Khulnasoft Managed Inference. Privacy-focused, fully managed.
content:
...
To perform inference tasks with your Pixtral model deployed at Khulnasoft, use the following command:
...
<Message type="tip">
  The model name allows Khulnasoft to put your prompts in the expected format.
</Message>
