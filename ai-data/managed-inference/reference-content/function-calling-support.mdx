---
meta:
  title: Support for function calling in Khulnasoft Managed Inference
  description: Function calling allows models to connect to external tools.
content:
  h1: Support for function calling in Khulnasoft Managed Inference
...
## How to implement function calling in Khulnasoft Managed Inference?
...
The following models in Khulnasoft's Managed Inference library can call tools as per the OpenAI method:
