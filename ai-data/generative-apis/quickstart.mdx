...
meta:
  ...
  description: Get started with Khulnasoft Generative APIs for powerful AI-driven content generation. Follow this guide to set up, configure, and make your first API request.
content:
  h1: Generative APIs - Quickstart
  paragraph: Get started with Khulnasoft Generative APIs for powerful AI-driven content generation. Follow this guide to set up, configure, and make your first API request.
...
<Message type="important">
  This service is free while in beta. [Specific terms and conditions](https://www.khulnasoft.com/en/contracts/) apply.
</Message>
...
Khulnasoft provides a web playground for instruct-based models hosted on Generative APIs.

### Accessing the Playground
1. Navigate to **Generative APIs** under the **AI** section of the [Khulnasoft console](https://console.khulnasoft.com/) side menu. The list of models you can query displays.
...
1. Have your [API key](/identity-and-access-management/iam/how-to/create-api-keys/) ready or generate a new one from the Khulnasoft console.
...
client = OpenAI(
    base_url="https://api.khulnasoft.ai/v1", # # Khulnasoft's Generative APIs service URL
    api_key="<SCW_SECRET_KEY>" # Your unique API secret key from Khulnasoft
)
```

Make sure that you replace `<SCW_SECRET_KEY>` with the API key obtained from your Khulnasoft account.
