...
Khulnasoft Generative APIs are designed as drop-in replacement for the OpenAI APIs.
The Models API allows you to easily list the various AI models available at Khulnasoft.
...
```
curl -s \
     --url "https://api.khulnasoft.ai/v1/models" \
