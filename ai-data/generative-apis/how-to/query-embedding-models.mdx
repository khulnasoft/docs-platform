...
meta:
  ...
  description: Learn how to interact with embedding models using Khulnasoft's Generative APIs service.
content:
  h1: How to query embedding models
  paragraph: Learn how to interact with embedding models using Khulnasoft's Generative APIs service.
...
Khulnasoft's Generative APIs service allows users to interact with embedding models hosted on the platform.
