---
meta:
  title: What are Rate limits with Khulnasoft Generative APIs
...
Any model served through Khulnasoft Generative APIs gets limited by:
- Tokens per minute
- Queries per minute
...
These limits safeguard against abuse or misuse of Khulnasoft Generative APIs, helping to ensure fair access to the API with consistent performance.
