...
meta:
  ...
  description: This page lists which open-source chat or embedding models Khulnasoft is currently hosting
content:
  h1: Supported models
  paragraph: Generative APIs offer serverless AI models hosted at Khulnasoft - no need to configure hardware or deploy your own models
...
Our [Chat API](/ai-data/generative-apis/how-to/query-language-models) has built-in support for the most popular instruct models.
...
<Message type="note">
  Missing a model? [Tell us what you would like to see here](https://feature-request.khulnasoft.com/?tags=ai-services), and we might add it shortly.
</Message>

## Embedding models

Our [Embeddings API](/ai-data/generative-apis/how-to/query-embedding-models) provides built-in support for the following models, hosted in Khulnasoft data centers, available via serverless endpoints.
...
**Do not see a model you want to use?** [Tell us or vote for what you would like to add here.](https://feature-request.khulnasoft.com/?tags=ai-services)
