...
meta:
  ...
  description: Find out how to create a Private Network in a Khulnasoft VPC, and start building optimized, secure cloud infrastructures away from the public internet
content:
  h1: How to create a Private Network
  paragraph: Find out how to create a Private Network in a Khulnasoft VPC, and start building optimized, secure cloud infrastructures away from the public internet
...
1. Click **VPC** in the **Network** section of the side menu. The list of your VPCs displays:
    ...
    Each Private Network must be created within a VPC. A default VPC is created for you in each Khulnasoft region.
...
3. Click **+ Create Private Network**. The creation screen displays.
    ...
    <Lightbox src="khulnasoft-create-a-pn.webp" alt="A screen of the Khulnasoft console, showing the steps to create a Private Network: Enter a name, check the region, enter tags and (optionally) expand the Advanced Settings section"/>
...
1. Follow the steps [above](#how-to-create-a-private-network) to create a Private Network, and at step 5, click **Advanced Settings**.
    ...
    <Lightbox src="khulnasoft-pn-advanced-settings.webp" alt="The Advanced Settings section of the Create a Private Network screen in the Khulnasoft console. It shows the options to automatically generate a CIDR block for the subnet, or define your own." />

2. Click **Define custom**. The following screen displays:

    <Lightbox src="khulnasoft-pn-define-custom.webp" alt="The Advanced Settings section of the Create a Private Network screen in the Khulnasoft console. The user is prompted to enter a prefix and a network size." />
