...
meta:
  ...
  description: Learn how to configure effective health checks for your services with Khulnasoft Load Balancer. Ensure optimal performance and reliability with expert guidance.
content:
  h1: Configuring health checks
  paragraph: Learn how to configure effective health checks for your services with Khulnasoft Load Balancer. Ensure optimal performance and reliability with expert guidance.
