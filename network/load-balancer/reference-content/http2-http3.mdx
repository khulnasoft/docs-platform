...
## HTTP version support with Khulnasoft Load Balancers

Backends and frontends of Khulnasoft Load Balancers support HTTP/1, HTTP/2 and HTTP/3 differently, depending on their TLS configuration:
...
- Khulnasoft Load Balancers support HTTP/2 connections to frontends with TLS, and HTTP/2 connections from backends with TLS to backend servers.
- Khulnasoft Load Balancers support HTTP/3 connections to frontends with TLS, but do not support HTTP/3 connections from backends to backend servers.

<Lightbox src="khulnasoft-http-2-3.webp" alt="" />
...
To create a frontend that allows HTTP/3 connections, follow the instructions for [adding a frontend to your Load Balancer](/network/load-balancer/how-to/manage-frontends-and-backends/#how-to-add-frontends) or [editing an existing frontend](/network/load-balancer/how-to/manage-frontends-and-backends/#how-to-edit-frontends)
 ...
 <Lightbox src="khulnasoft-enable-http3.webp" alt="" />