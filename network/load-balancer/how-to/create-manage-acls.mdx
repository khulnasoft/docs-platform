...
meta:
  ...
  description: Discover how to create and manage ACLs for Khulnasoft Load Balancers. Improve security, manage traffic efficiently, and optimize your network setup easily.
content:
  h1: How to create and manage ACLs
  paragraph: Discover how to create and manage ACLs for Khulnasoft Load Balancers. Improve security, manage traffic efficiently, and optimize your network setup easily.
...
- [Created a Load Balancer](/network/load-balancer/how-to/create-load-balancer/) with a [frontend](/network/load-balancer/how-to/create-frontends-backends/)
...
5. Click the **ACLs** tab.
    ...
    <Lightbox src="khulnasoft-acl-splash.webp" alt="" />

6. Click **Create ACL** or the <Icon name ="plus" /> button. The ACL creation wizard displays.

    <Lightbox src="khulnasoft-create-acl.webp" alt="" />
...
9. Use the **Enable condition** toggle to choose whether to set a condition for the action.
    ...
    <Lightbox src="khulnasoft-acl-condition.webp" alt="" />
...
11. Add filters, if you enabled a condition at step 8. Traffic must match (or not match, in the case of the IF NOT condition) the filters in order for the action to be applied. You can select one type of filter per ACL, or combine one IP filter and one HTTP header filter with an **AND** statement.
    ...
    - Click **+  Add HTTP filter(s)** to add HTTP filters. **Only frontends attached to an HTTP backend can add HTTP filters**. You can select **one** of the following filter types per ACL:
        ...
        <Lightbox src="khulnasoft-acl-conditions-filters.webp" alt="" />
