...
1. Click [Load Balancers](https://console.khulnasoft.com/load-balancer/lbs) in the **Network** section of the Khulnasoft console side menu. The Load Balancer dashboard displays.
...
4. Click **Attach to a Private Network**. A pop-up displays.
    ...
    <Lightbox src="khulnasoft-lb-pn-attach.webp" alt="" />
...
1. Click [Load Balancers](https://console.khulnasoft.com/load-balancer/lbs) in the **Network** section of the Khulnasoft console side menu. The Load Balancer overview page displays.
...
4. Click the <Icon name="unlink" /> button next to the Private Network that you want to detach from the Load Balancer, then click **Detach resource** when prompted.
    <Lightbox src="khulnasoft-load-balancer-detach-private-network.webp" alt="" />
