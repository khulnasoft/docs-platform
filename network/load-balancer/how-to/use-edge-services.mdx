...
3. Click **Create Edge Services pipeline**. The pipeline creation wizard displays.
    ...
    <Lightbox src="khulnasoft-create-es-pipeline-lb.webp" alt="A screenshot of the Create Edge Services Pipeline wizard in the Khulnasoft console. The steps shown are 1: Configure Origin, 2: Define protocol and origin host, and 3: Choose a name" />
