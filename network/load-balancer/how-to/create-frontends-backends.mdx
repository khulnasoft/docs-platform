...
meta:
  ...
  description: Learn how to set up frontends and backends with Khulnasoft Load Balancer. Step-by-step guide for configuring efficient network routing and load distribution.
content:
  h1: How to create frontends and backends
  paragraph: Learn how to set up frontends and backends with Khulnasoft Load Balancer. Step-by-step guide for configuring efficient network routing and load distribution.
...
4. Click the **+ Add frontend** button. The frontend creation wizard displays.
    ...
    <Lightbox src="khulnasoft-create-frontend-after.webp" alt="" />
