...
meta:
  ...
  description: This page explains how to create and manage flexible IP addresses for your Khulnasoft Load Balancer
content:
  h1: How to create and manage Load Balancer flexible IPs
  paragraph: This page explains how to create and manage flexible IP addresses for your Khulnasoft Load Balancer
...
6. Optionally, select a Load Balancer if you want to attach the flexible IP to it directly.
