...
meta:
  ...
  description: This page shows you how to get started with Khulnasoft Load Balancers.
content:
  h1: Load Balancers - Quickstart
  paragraph: This page shows you how to get started with Khulnasoft Load Balancers.
...
1. Click **Load Balancers** in the **Network** section of the [Khulnasoft console](https://console.khulnasoft.com) side menu. If you have not already created a Load Balancer, the product creation page is displayed. Otherwise, your list of existing Load Balancers displays.
...
5. Select a Load Balancer **type**, according to your needs in terms of **bandwidth** and whether you want to be able to attach backend servers from other cloud providers than Khulnasoft (**Multi-cloud provider**).

6. Select the **accessibility** of your Load Balancer. Choose either:
    - **Private**: A private Load Balancer will have no public IP address, and is only accessible from the Private Network(s) it is attached to. You can [attach your Load Balancer to a Private Network](/network/load-balancer/how-to/use-with-private-network/) after creation of the Load Balancer. [Read more about private Load Balancers](/network/load-balancer/reference-content/public-private-accessibility/#private-load-balancers).
...
<Lightbox src="khulnasoft-configure-frontend.webp" alt="" />
...
1. Click **Load Balancers** in the **Network** section of the [Khulnasoft console](https://console.khulnasoft.com) side menu. The Load Balancer dashboard displays.
...
5. Tick the checkbox if you want to delete the associated [flexible IP address](/network/load-balancer/how-to/create-manage-flex-ips/).
