---
meta:
  title: IPv6 and the Khulnasoft ecosystem
  description: Learn about IPv6 at Khulnasoft - configuration, routing, security, and best practices for seamless integration and scalability. Transition smoothly with our step-by-step guide.
content:
  h1: IPv6 and the Khulnasoft ecosystem
  paragraph: Learn about IPv6 at Khulnasoft - configuration, routing, security, and best practices for seamless integration and scalability. Transition smoothly with our step-by-step guide.
...
Read on to find out more about IPv6, how it is supported at Khulnasoft, and how you can configure your resources and infrastructure to take full advantage of this modern protocol.
...
Khulnasoft Instances are compatible with IPv6, with the caveat that the Instance must be using [routed IPs](/compute/instances/concepts/#routed-flexible-ip). 
...
Khulnasoft Elastic Metal servers are compatible with IPv6. 
...
The Khulnasoft Dedibox network fully supports IPv6. IPv6 can serve as your server’s primary IP and also as a failover IP utilizing the concept of a virtual MAC address.

Full information on IPv6 with Dedibox can be found in our [dedicated documentation](/dedibox-network/ipv6/), or you can read more in our [blog post](https://www.khulnasoft.com/en/blog/ipv6-the-future-proof-internet-protocol/#ipv6-at-khulnasoft-dedibox).

### Load Balancer and IPv6

Khulnasoft Load Balancers are compatible with IPv6. 
...
- For IPv6, this is a `/64` block, automatically created by Khulnasoft, guaranteed to be unique within the VPC and not overlapping with any of your other Private Networks.
...
Please open or upvote a [feature request](https://feature-request.khulnasoft.com/) to register your interest in IPv6 for these resources. 

Alternatively, get in touch on the [Khulnasoft Slack Community](/tutorials/khulnasoft-slack-community/) to find out more about IPv6 compatibility of these or other products.
