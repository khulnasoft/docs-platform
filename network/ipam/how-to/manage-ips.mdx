...
meta:
  ...
  description: This page explains how to manage your private IP addresses with Khulnasoft's IPAM
content:
  h1: How to manage your private IP addresses
  paragraph: This page explains how to manage your private IP addresses with Khulnasoft's IPAM
...
IPAM acts as a single source of truth for the IP addresses of your Khulnasoft resources. You can use IPAM in the console Khulnasoft console to manage [private IP addresses](/network/ipam/concepts/#private-ip-address) that are either attached to one of your resources on a Private Network, or [reserved via the IPAM API](https://www.khulnasoft.com/en/developers/api/ipam/#path-ips-book-a-new-ip).
...
Learn [how to reserve a private IP address](/network/ipam/how-to/reserve-ip/).
