...
content:
  h1: I attached the Public Gateway to my Private Network, but the services provided by the gateway are not working (NAT etc)
...
It may also be useful to try the steps outlined in [this troubleshooting](/network/vpc/troubleshooting/autoconfig-not-working/).

If the problem persists, do not hesitate to [contact us on the #public-gateway channel on the Khulnasoft Community Slack](https://khulnasoft-community.slack.com/archives/C01NTFET64D).