...
meta:
  ...
  description: This page shows you how to get started with Khulnasoft Public Gateways.
content:
  h1: Public Gateways - Quickstart
  paragraph: This page shows you how to get started with Khulnasoft Public Gateways.
