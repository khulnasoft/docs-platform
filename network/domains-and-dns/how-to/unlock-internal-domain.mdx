...
Domain names are locked by default to avoid any unsolicited outgoing transfer. If you want to transfer your domain name to another registrar, you can unlock it from your Khulnasoft console.
...
- A domain name registered with Khulnasoft Domains and DNS
...
3. Click **Unlock** under **Transfer** in the **Domain Information** section. A pop-up displays.
    <Lightbox src="khulnasoft-domain-unlock.webp" alt="" />
