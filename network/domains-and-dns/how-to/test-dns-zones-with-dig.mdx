...
This page shows you how to use the `dig` command to perform some common DNS tests. You do not need to have registered domains with Khulnasoft Domains and DNS to use this documentation page, but if you are using Khulnasoft Domains and DNS, refer to the **Before you start** section.

<Macro id="requirements" />

  - A Khulnasoft account logged into the [console](https://console.khulnasoft.com)
  - [Added](/network/domains-and-dns/how-to/add-external-domain/) **external domains** with Khulnasoft Domains and DNS or not
