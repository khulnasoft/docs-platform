...
meta:
  ...
  description: Learn how to transfer an external domain to Khulnasoft with our comprehensive guide. Discover step-by-step instructions, from verifying domain availability to initiating the transfer, and managing authorizations.
content:
  h1: How to transfer an external domain
  paragraph: Learn how to transfer an external domain to Khulnasoft with our comprehensive guide. Discover step-by-step instructions, from verifying domain availability to initiating the transfer, and managing authorizations.
...
2. Click ** + Register new domain**.
    <Lightbox src="khulnasoft-register_new_domain.webp" alt="" />
