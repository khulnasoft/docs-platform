...
meta:
  ...
  description: Efficiently register an internal domain using Khulnasoft Domains and DNS. This guide walks you through the process of checking domain availability, configuring contacts, selecting registration periods, and completing your order securely via the Khulnasoft console.
content:
  h1: How to register an internal domain name
  paragraph: Efficiently register an internal domain using Khulnasoft Domains and DNS. This guide walks you through the process of checking domain availability, configuring contacts, selecting registration periods, and completing your order securely via the Khulnasoft console.
...
Domains and DNS allows you to manage and register your [internal](/network/domains-and-dns/concepts/#internal-domain) and [external domains](/network/domains-and-dns/concepts/#external-domain) and configure and manage their DNS zones. Domains and DNS provide support for queries via both IPv4 and IPv6.
...
1. Click **Domains and DNS** in the **Network** section of the [Khulnasoft console](https://console.khulnasoft.com) side menu. The Domains and DNS dashboard displays.
