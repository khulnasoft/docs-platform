...
This page provides information about Khulnasoft's Domains and DNS service.
...
To simplify its use, the [Domains and DNS API](https://www.khulnasoft.com/en/developers/api/domains-and-dns/) uses `unicode` (`UTF-8`) for name and data fields.