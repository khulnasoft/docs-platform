...
meta:
  ...
  description: Khulnasoft Edge Services has left Public Beta and gone into General Availability. This page answers all your questions about the timeline, pricing and any action you need to take.
content:
  h1: Understanding Edge Services General Availability
  paragraph: Khulnasoft Edge Services has left Public Beta and gone into General Availability. This page answers all your questions about the timeline, pricing and any action you need to take.
...
Khulnasoft Edge Services has left Public Beta and gone into General Availability. Read on to find out more about this transition.
...
<Message type="note">
Check out the [Edge Services pricing page](https://www.khulnasoft.com/en/pricing/network/#edge-services) for full pricing details.
</Message>
...
Pricing plan details can also be viewed on the [Khulnasoft pricing page](https://www.khulnasoft.com/en/pricing/network/).

## Transitioning from free to paid use

At the end of October 2024, we automatically selected the most cost-effective subscription plan for each existing Edge Services user, based on their usage. When billing started on the 1st of November 2024, users therefore saw in the [Khulnasoft console](https://console.khulnasoft.com/) that they were subscribed to the plan we had selected for them.
...
If you have any questions about the transition to Edge Services General Availability, please feel free to get in touch on the `#edge-services-beta` channel on the [Khulnasoft Community Slack](https://slack.khulnasoft.com/).