...
Edge Services billing is based on [monthly subscription plans](https://www.khulnasoft.com/en/pricing/network/#edge-services). Three plans are available, with different prices and consumption limits:
...
For full details of the price and limits of each plan, refer to the [pricing page](https://www.khulnasoft.com/en/pricing/network/#edge-services). Subscription plans are scoped to a single Khulnasoft [Project](/identity-and-access-management/organizations-and-projects/concepts/#project).

## Keeping track of your Edge Services consumption

You can check the number of pipelines you have at any one time in the **Pipelines** tab of the Edge Services dashboard in the Khulnasoft console. [Khulnasoft Cockpit](/network/edge-services/how-to/monitor-cockpit/) can be used to monitor the data egressing from your Edge Services caches.
...
The example prices and limits used below are subject to change. You should always refer to the [pricing page](https://www.khulnasoft.com/en/pricing/network/#edge-services) for the most up to date information.
</Message>
