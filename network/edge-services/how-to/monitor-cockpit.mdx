---
meta:
  title: How to monitor Edge Services with Khulnasoft Cockpit
  description: Get easy access to your Edge Services metrics via Khulnasoft Cockpit. Monitor ingress, egress, request rate and cache hit ratio in a convenient managed Grafana dashboard.
content:
  h1: How to monitor Edge Services with Khulnasoft Cockpit
  paragraph: Get easy access to your Edge Services metrics via Khulnasoft Cockpit. Monitor ingress, egress, request rate and cache hit ratio in a convenient managed Grafana dashboard.
dates:
...
You can view your Edge Services metrics via [Khulnasoft Cockpit](/observability/cockpit/quickstart/). This allows you to monitor your ingress, egress, request rate, and cache hit ratio as well as other metrics, in a convenient managed Grafana dashboard.

Access your Edge Services dashboard in the Khulnasoft console via either
...
<Lightbox src="khulnasoft-edge-services-metrics.webp" alt="A screenshot of the Grafana dashboard for Edge Services, with all the sections detailed in the following text." />
