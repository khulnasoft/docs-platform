...
1. In the Khulnasoft console, navigate to the Edge Services dashboard for the Object Storage or Load Balancer pipeline on which you want to enable caching:
...
1. In the Khulnasoft console, navigate to the Edge Services dashboard for the Object Storage bucket or Load Balancer pipeline whose cache you want to purge:

    <Lightbox src="khulnasoft-edge-services-dashboard.webp" alt="A screenshot of the Edge Services dashboard in the Khulnasoft console. This is a dashboard for Edge Services on an Object Storage bucket, showing links to the documentation, Khulnasoft Cockpit, the endpoint, cache settings and a button to disable the pipeline." />

2. In the **Purge cache** panel, click **Purge all**.

    <Lightbox src="khulnasoft-edge-services-purge-cache.webp" />
...
2. In the **Purge cache** panel, click **Purge by object**.
    ...
    <Lightbox src="khulnasoft-edge-services-purge-object.webp" />
...
1. In the Khulnasoft console, navigate to the Edge Services dashboard for the Object Storage bucket or Load Balancer pipeline whose cache you want to disable:
