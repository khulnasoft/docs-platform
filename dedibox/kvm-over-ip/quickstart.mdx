...
- [Created](/dedibox/dedicated-servers/how-to/order-a-server/) and [installed](/dedibox/dedicated-servers/how-to/install-a-server/) a dedicated server with a dedicated KVM over IP device
