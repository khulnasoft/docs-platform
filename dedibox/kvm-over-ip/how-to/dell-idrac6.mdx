...
meta:
  ...
  description: This page explains how to use the KVM DELL iDRAC 6 on a Khulnasoft Dedibox
content:
  h1: How to use the KVM Dell iDRAC 6
  paragraph: This page explains how to use the KVM DELL iDRAC 6 on a Khulnasoft Dedibox
...
3. Click **iDRAC** in the menu on the right. A pop-up displays.
    <Lightbox src="khulnasoft_idrac.webp" alt="" />
...
2. Click **Console/Media** the top menu.
    <Lightbox src="khulnasoft_idrac_console.webp" alt="" />
3. Click **Launch Virtual Console**.
    <Lightbox src="khulnasoft_idrac_launch_console.webp"  alt="" />
4. Download and execute the Java web start file. The virtual console window displays.
    <Lightbox src="khulnasoft_idrac6_virtual_console.webp" width="" />
...
8. During the boot process, press **F11** to access the BIOS boot manager.
    <Lightbox src="khulnasoft_idrac6_boot_manager.webp" width="" />
9. Select **Virtual CD** to boot the server using the ISO file mounted in the virtual CD drive.
    <Lightbox src="khulnasoft_idrac6_virtual_cd.webp" width="" />
