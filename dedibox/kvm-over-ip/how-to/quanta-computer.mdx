...
meta:
  ...
  description: This page explains how to use the KVM device of Quanta Computer servers on Khulnasoft dedicated servers
content:
  h1: How to use the Quanta Computer KVM
  paragraph: This page explains how to use the KVM device of Quanta Computer servers on Khulnasoft dedicated servers
tags: kvm quanta qct
dates:
...
6. Select the boot device **AMI Virtual CDROM0** to boot from the ISO file:
    <Lightbox src="khulnasoft_qct_boot_device.webp" alt="" />
