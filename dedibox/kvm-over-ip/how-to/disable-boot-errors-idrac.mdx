...
meta:
  ...
  description: This page explains how to disable boot errors using iDRAC on a Khulnasoft Dedibox
content:
  h1: How to disable boot errors using iDRAC
  paragraph: This page explains how to disable boot errors using iDRAC on a Khulnasoft Dedibox
...
8. Press Enter to save your modifications.
    ...
    <Lightbox src="khulnasoft-bootstuck3.webp" alt=""/>
