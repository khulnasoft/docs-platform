...
content:
  ...
  paragraph: This page explains how to use the KVM HP iLO on a Khulnasoft Dedibox
...
3. Click **iLO** in the menu on the right. A pop-up displays.
    <Lightbox src="khulnasoft_ilo.webp" alt="" />
...
5. During reboot, press **F11** to launch the boot menu.
    <Lightbox src="khulnasoft_ilo_boot_menu.webp" alt="" />
6. Press **1** to boot from the virtual CD/DVD drive.
    <Lightbox src="khulnasoft_ilo_boot_options.webp" alt="" />
