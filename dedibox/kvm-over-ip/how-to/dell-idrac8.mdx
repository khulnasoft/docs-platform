...
meta:
  ...
  description: This page explains how to use the KVM DELL iDRAC 8 on a Khulnasoft Dedibox
content:
  h1: How to use the KVM DELL iDRAC 8
  paragraph: This page explains how to use the KVM DELL iDRAC 8 on a Khulnasoft Dedibox
...
2. Click **Launch** in the **Virtual Console Preview** section of the dashboard. A Java Web Start file is downloaded.
    <Lightbox src="khulnasoft_idrac8_dashboard.webp" alt="" />
