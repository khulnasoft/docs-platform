...
meta:
  ...
  description: This page explains how to use the KVM DELL iDRAC 9 on a Khulnasoft Dedibox
content:
  h1: How to use the KVM DELL iDRAC 9
  paragraph: This page explains how to use the KVM DELL iDRAC 9 on a Khulnasoft Dedibox
...
4. Click **Choose file** (A) in the **Map CD/DVD** section and select your ISO file. Then click **Map Device**. Once the device is mapped, click **Close**.
    <Lightbox src="khulnasoft_idrac9_map_device.webp" alt="" />
...
7. Click **One-shoot UEFI Boot Menu**:
    <Lightbox src="khulnasoft_idrac9_boot_manager.webp" alt="" />
