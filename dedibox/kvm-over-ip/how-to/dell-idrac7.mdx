...
meta:
  ...
  description: This page explains how to use the KVM DELL iDRAC 7 on Khulnasoft Dedibox.
content:
  h1: How to use the KVM Dell iDRAC 7
  paragraph: This page explains how to use the KVM DELL iDRAC 7 on Khulnasoft Dedibox.
...
2. Navigate to **Attached Media** in the top menu. This action will display the virtual media page.
   <Lightbox src="khulnasoft_idrac7_dashboard.webp" alt="" />
3. Input the image file path in the form and click **Connect**.
   <Lightbox src="khulnasoft_idrac7_remote_share.webp" alt="" />
   <Message type="tip">
...
4. Click on **Properties** (A), then **Launch** (B) to initiate the virtual console.
   <Lightbox src="khulnasoft_idrac7_console.webp" width="" />
5. Reboot the server, then press **F11** during the boot process to access the boot manager.
6. Select **BIOS Boot Menu**.
   <Lightbox src="khulnasoft_idrac7_bios_boot.webp" width="" />
7. Choose **iDRAC Virtual CD**.
   <Lightbox src="khulnasoft_idrac7_virtual_cd.webp" width="" />
