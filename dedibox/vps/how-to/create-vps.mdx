...
8. Optionally paste an [SSH key](/identity-and-access-management/organizations-and-projects/how-to/create-ssh-key/#how-to-upload-the-public-ssh-key-to-the-khulnasoft-interface) that can be used for authentication when connecting to the Dedibox VPS using SSH, then click **Order**. An order summary displays.
