---
meta:
  title: How to configure your Khulnasoft Dedibox hardware RAID from the console
  description: This page explains how to configure your Khulnasoft Dedibox hardware RAID from the console
content:
  h1: How to configure your Khulnasoft Dedibox hardware RAID from the console
  paragraph: This page explains how to configure your Khulnasoft Dedibox hardware RAID from the console
tags: dedibox raid 
dates:
...
1. Log in to the [Khulnasoft Dedibox console](https://console.online.net/en/login).
