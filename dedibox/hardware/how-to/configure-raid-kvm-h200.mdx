...
meta:
  ...
  description: This page explains how to configure the DELL PERC H200 RAID controller on a Khulnasoft Dedibox from the KVM
content:
  h1: How to configure the DELL PERC H200 RAID controller from the KVM
  paragraph: This page explains how to configure the DELL PERC H200 RAID controller on a Khulnasoft Dedibox from the KVM
...
8. Select the drives for the volume and save your settings:
    <Lightbox src="khulnasoft_h200_06.webp" alt="" />
