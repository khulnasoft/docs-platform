...
meta:
  ...
  description: This page explains how to configure the HP Smart Array P420 RAID controller on a Khulnasoft Dedibox from the KVM
content:
  h1: How to configure the HP Smart Array P420 RAID controller from the KVM
  paragraph: This page explains how to configure the HP Smart Array P420 RAID controller on a Khulnasoft Dedibox from the KVM
...
- A [Dedibox dedicated server](https://www.khulnasoft.com/en/dedibox/) with an HP Smart Array P420 RAID controller
