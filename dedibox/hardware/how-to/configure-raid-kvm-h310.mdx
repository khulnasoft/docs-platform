...
meta:
  ...
  description: This page explains how to configure the DELL PERC H310 / H710 / H730 RAID controller on a Khulnasoft Dedibox from the KVM
content:
  h1: How to configure the DELL PERC H310 / H710 / H730 RAID controller from the KVM
  paragraph: This page explains how to configure the DELL PERC H310 / H710 / H730 RAID controller on a Khulnasoft Dedibox from the KVM
...
- A [Dedibox dedicated server](https://www.khulnasoft.com/en/dedibox/) with a DELL PERC H310, H710, or H730 RAID controller
...
7. Create a new virtual disk by selecting **No configuration present**. The following screen displays, allowing you to configure a new virtual disk:
    <Lightbox src="khulnasoft_h310_04.webp" alt="" />
