...
If you notice any errors when running a SMART diagnosis on your disk, open a [support ticket](/console/account/how-to/open-a-support-ticket/) and ask for the disk to be replaced, indicating the serial number with the result of the `smartctl` command:
