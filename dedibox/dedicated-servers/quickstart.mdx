...
[Khulnasoft Dedibox](https://www.khulnasoft.com/en/dedibox/) are our high-quality dedicated servers. With over 15 years of experience, we provide dedicated servers that are recognized for their extreme reliability and best-in-class redundancy.
...
6. You may be asked to confirm that you want to connect. Click **Yes**.
    ...
    You are connected to the graphical interface of your Windows Server. If you need to change the language, refer to the [How to change the language of Windows Server](/dedibox/dedicated-servers/how-to/change-win-server-language/) page.