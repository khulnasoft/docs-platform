...
meta:
  ...
  description: This page explains how to change the root password on a Khulnasoft Dedibox server
content:
  h1: How to change the root password
  paragraph: This page explains how to change the root password on a Khulnasoft Dedibox server
