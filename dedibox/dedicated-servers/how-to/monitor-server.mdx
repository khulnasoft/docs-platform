...
<Message type="important">
  The monitoring feature is deprecated and **no longer available** from the Dedibox console. For advanced monitoring of your server, refer to Khulnasoft’s [Observability Cockpit](https://www.khulnasoft.com/en/cockpit/).
</Message>
...
3. Click **Monitoring** on the left-side menu. The monitoring page displays.
    ...
    <Lightbox src="khulnasoft-dedibox-monitoring.webp" />
...
3. Click **Logs** on the left-side menu. The logs page displays.
    <Lightbox src="khulnasoft-dedibox-logs.webp" />
