...
meta:
  ...
  description: Learn how to recover and download backups of your data from a Khulnasoft Dedibox server using rescue mode with SFTP or Dedibackup.
content:
  h1: How to rescue and recover your data using rescue mode
  paragraph: Learn how to recover and download backups of your data from a Khulnasoft Dedibox server using rescue mode with SFTP or Dedibackup.
...
You can recover your data by either transferring it to the [Dedibackup](https://www.khulnasoft.com/en/dedibox/storage/) storage space or downloading it directly to your local computer via SFTP.
...
<Message type="tip">
  If you encounter difficulties, consider contacting a [certified outsourcer](https://www.khulnasoft.com/en/dedibox/outsourcing/) for professional data recovery.
</Message>