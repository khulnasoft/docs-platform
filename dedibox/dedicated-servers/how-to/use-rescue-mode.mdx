...
meta:
  ...
  description: Learn how to use rescue mode on a Khulnasoft Dedibox server to troubleshoot and recover your system.
content:
  h1: How to Use Rescue Mode on a Dedibox Server
  paragraph: Learn how to use rescue mode on a Khulnasoft Dedibox server to troubleshoot and recover your system.
