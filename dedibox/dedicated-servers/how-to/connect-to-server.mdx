...
meta:
  ...
  description: This page explains how to connect to a Khulnasoft Dedibox server using SSH or RDP
content:
  h1: How to connect to a Dedibox server
  paragraph: This page explains how to connect to a Khulnasoft Dedibox server using SSH or RDP
...
This guide provides instructions on connecting to your Khulnasoft Dedibox server using SSH (for Linux, macOS, and Windows) or Remote Desktop (for Windows Server).
