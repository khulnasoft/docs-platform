...
meta:
  ...
  description: This page explains how to use the serial console on a Khulnasoft Dedibox server
content:
  h1: How to use the serial console
  paragraph: This page explains how to use the serial console on a Khulnasoft Dedibox server
...
3. Click **Serial Console**. The connection information displays.
    <Lightbox src="khulnasoft-serial-console.webp" />
4. Click **Access** to access the serial console of your server.
    <Lightbox src="khulnasoft-serial-console-2.webp" />
...
<Lightbox src="khulnasoft-serial-console-esxi.webp" />
...
5. Enter 9600 (2) as value:
    <Lightbox src="khulnasoft-serial-console-esxi2.webp" />
