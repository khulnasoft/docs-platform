...
meta:
  ...
  description: This page explains how to use IPMI on a Khulnasoft Dedibox server
content:
  h1: How to use IPMI on a Dedibox server
  paragraph: This page explains how to use IPMI on a Khulnasoft Dedibox server
...
- [Created](/dedibox/dedicated-servers/how-to/order-a-server/) and [installed](/dedibox/dedicated-servers/how-to/install-a-server/) a Dedibox server with a dedicated KVM over IP device
...
5. Enter the authorized IPv4 address for the iDRAC connection. The IP address of your internet connection is already pre-filled in the form. Then click **Create** to generate your credentials.
    ...
    <Lightbox src="khulnasoft-idrac.webp" alt="" />
...
5. Enter the authorized IPv4 address for the iDRAC connection. The IP address of your internet connection is already pre-filled in the form. Then click **Create** to generate your credentials.
    ...
    <Lightbox src="khulnasoft-ilo.webp" alt="" />
6. Use the interface to monitor and manage your server's hardware:
