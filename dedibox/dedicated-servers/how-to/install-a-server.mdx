...
meta:
  ...
  description: Learn how to install your Khulnasoft Dedibox dedicated server with step-by-step instructions for OS selection, partitioning, and configuration.
content:
  h1: How to install a server 
  paragraph: Learn how to install your Khulnasoft Dedibox dedicated server with step-by-step instructions for OS selection, partitioning, and configuration.
...
After your Khulnasoft Dedibox server has been delivered, you can proceed with the installation process by following these steps.
