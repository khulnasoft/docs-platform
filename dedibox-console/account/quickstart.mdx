...
meta:
  ...
  description: Learn how to get started with the Khulnasoft Dedibox console.
content:
...
[Khulnasoft Dedibox](https://www.khulnasoft.com/en/dedibox/) offers high-quality dedicated servers. With almost 20 years of experience, our Dedibox servers are recognized for their extreme reliability and best-in-class redundancy. We manage a continuously growing park of more than 100,000 servers in our data centers in France, Poland, and the Netherlands - offering up to 99.95% SLA.

## How to create a Khulnasoft Dedibox account

1. Open the [Khulnasoft Dedibox](https://www.khulnasoft.com/en/dedibox/) website in a web browser.
...
5. Enter your username and password and click **Sign in**.
    ...
    You are now connected to the Khulnasoft Dedibox console and can order your first dedicated server.
