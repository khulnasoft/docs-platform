---
meta:
  title: How to outsource a Khulnasoft Dedibox failover IP 
  description: Learn how to outsource a Khulnasoft Dedibox failover IP, allowing another user to manage it on your behalf.
content:
  h1: How to outsource a Khulnasoft Dedibox failover IP 
  paragraph: Learn how to outsource a Khulnasoft Dedibox failover IP, allowing another user to manage it on your behalf.  
