...
meta:
  ...
  description: Learn how to revoke an existing Khulnasoft Dedibox outsourcing agreement.
content:
  h1: How to revoke a Dedibox outsourcing agreement
  paragraph: This guide explains how to revoke an existing Khulnasoft Dedibox outsourcing agreement.
...
Outsourced services refer to services managed by a different technical contact than the owner of the service. This technical contact, who is another Khulnasoft Dedibox account holder, can manage these services without requiring full access to the owner's Khulnasoft Dedibox account.
...
3. On the outsourcing page, navigate to the **Outsourced** tab to view a list of your outsourced services. Select the checkbox next to each service you want to revoke the outsourcing for:
    <Lightbox src="khulnasoft-dedibox-console-outsourcing-revoke.webp" />
