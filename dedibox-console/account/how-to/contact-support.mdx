...
meta:
  ...
  description: This page shows you how to contact the Khulnasoft Dedibox support team.
content:
  h1: How to contact the Dedibox support team
  paragraph: This page shows you how to contact the Khulnasoft Dedibox support team.
...
<Message type="tip">
  Check the [Khulnasoft Status](https://status.khulnasoft.com/) page for real-time updates on the status of our services and maintenance information.
</Message>
