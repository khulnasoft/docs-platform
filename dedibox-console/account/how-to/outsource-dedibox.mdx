...
meta:
  ...
  description: Learn how to outsource your Khulnasoft Dedibox dedicated server.
content:
  h1: How to outsource your Dedibox
  paragraph: This guide explains how to outsource your Khulnasoft Dedibox dedicated server.
...
Outsourcing a Dedibox dedicated server means entrusting the technical management of your machines and services to another Khulnasoft Dedibox account while retaining control over your main account.
...
3. Click **Outsourcing** in the side menu of your server's status page:
    <Lightbox src="khulnasoft-dedibox-console-dedibox-outsourcing.webp" width="800" alt="Khulnasoft Dedibox console outsourcing" />
...
4. Enter the identifier of the new technical contact for your server. The identifier is the login of the other user's console account. Click **Send request** to validate the form.
    ...
    The other account holder will receive a notification to accept the outsourcing of your dedicated server into their Khulnasoft Dedibox account.
