...
meta:
  ...
  description: Learn how to upload and use an SSH key for Khulnasoft Dedibox servers.
content:
  h1: How to upload and use an SSH Key for Dedibox
  paragraph: This guide explains how to upload and use an SSH key for Khulnasoft Dedibox servers.
...
1. In the top right corner of the console, click on your username to open the pop-up menu. From there, select **SSH keys**.
    <Lightbox src="khulnasoft-dedibox-console-ssh-key-menu.webp" />
...
4. Click **Add SSH key** to upload the public key to your Khulnasoft Dedibox account.
