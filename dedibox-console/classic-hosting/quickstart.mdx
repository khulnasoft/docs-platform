...
meta:
  ...
  description: This page shows you how to get started with Khulnasoft Webhosting Classic.
content:
  h1: Webhosting Classic - Quickstart
  paragraph: This page shows you how to get started with Khulnasoft Webhosting Classic.
...
Khulnasoft Webhosting Classic is our historical Webhosting service. It allows you to host your personal website and create personalized email addresses using your domain name.

<Message type="important">
  * Webhosting Classic reached its end of life and is no longer available for new customers. We recommend our [Cloud Hosting](https://www.khulnasoft.com/en/web-hosting/) offers for new subscriptions.
...
4. Click **Add account**. A pop-up displays.
    <Lightbox src="khulnasoft_create_email.webp" alt="" />
...
<Message type="note">
  For MySQL databases, [size limitations apply](/dedibox-console/classic-hosting/how-to/create-mysql-database/#limitations).
</Message>