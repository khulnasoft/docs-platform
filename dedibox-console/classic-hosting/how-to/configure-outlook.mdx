...
meta:
  ...
  description: This page shows you how to Outlook to receive and send email on Khulnasoft Web Hosting Classic
content:
  h1: How to configure Outlook to receive and send email on Web Hosting Classic
  paragraph: This page shows you how to configure Outlook to receive and send emails on Khulnasoft Web Hosting Classic
