...
meta:
  ...
  description: Learn how to configure an .htaccess file on Khulnasoft Web Hosting Classic.
content:
  h1: How to configure an .htaccess file on Web Hosting Classic
  paragraph: This guide explains how to configure an .htaccess file on Khulnasoft Web Hosting Classic.
...
1. Create an `.htaccess` file with the following content:
    ```
    # Redirection to the site Khulnasoft.com
    RedirectPermanent / https://www.khulnasoft.com/en/
    ```
