---
meta:
  title: How to change the password of an FTP account for Khulnasoft Web Hosting Classic
  description: This page shows you how to change the password of an FTP account 
content:
  h1: How to change the password of an FTP account for Khulnasoft Web Hosting Classic
