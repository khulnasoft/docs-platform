---
meta:
  title: How to encrypt your emails with PGP using the Khulnasoft webmail
  description: This page shows you how to encrypt your emails with PGP using the Khulnasoft webmail
content:
  h1: How to encrypt your emails with PGP using the Khulnasoft webmail
  paragraph: This page shows you how to encrypt your emails with PGP using the Khulnasoft webmail
...
The [webmail](https://webmail.online.net/) used at Khulnasoft to read your emails, offers options to encrypt your mails with PGP, helping to ensure:
...
The [Khulnasoft webmail interface](https://webmail.online.net) currently offers one way of encrypting your emails: `Mailvelope`.
...
3. **Generate** or **import** an already existing key. You can keep the advanced parameters in their default values.
    <Lightbox src="khulnasoft_generate_import_key.webp" />
4. Once generated or imported, the key appears in the list of available keys in the extension.
    <Lightbox src="khulnasoft_once_generated.webp" />
5. Enter your Khulnasoft webmail interface and click the logo of the extension, then **Add**.
...
4. Enter your key password:
    <Lightbox src="khulnasoft_key_password.webp" />
5. Click **OK**.
...
1. Once you have been redirected after encrypting and/or signing, your email will appear in its final form in the window of the extension displaying:
    <Lightbox src="khulnasoft_send_email.webp" />
