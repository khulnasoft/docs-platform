...
meta:
  ...
  description: This page shows you how to create an FTP account on Khulnasoft Web Hosting Classic
content:
  h1: How to create an FTP account on Web Hosting Classic
  paragraph: This page shows you how to create an FTP account on Khulnasoft Web Hosting Classic
...
**F**ile **T**ransfer **P**rotocol is a standard way to transfer files between a client (such as your local computer) and a server (such as your Khulnasoft webhosting server) via the internet. In order to [use FTP](/dedibox-console/classic-hosting/how-to/connect-via-ftp/), you must first create an account.
