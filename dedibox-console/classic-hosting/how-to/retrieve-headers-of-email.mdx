...
meta:
  ...
  description: This guide shows you how to retrieve the header of an email on Khulnasoft Web Hosting using different email clients like Thunderbird, Gmail, Outlook, and Mail for Mac.  
content:
  h1: How to retrieve the header of an email
  paragraph: This guide shows you how to retrieve the header of an email on Khulnasoft Web Hosting using different email clients like Thunderbird, Gmail, Outlook, and Mail for Mac.  
