...
meta:
  ...
  description: This page shows you how to change the password of an email account on Khulnasoft Web Hosting Classic
content:
  h1: How to change the password of an email account on Web Hosting Classic
  paragraph: This page shows you how to change the password of an email account on Khulnasoft Web Hosting Classic
