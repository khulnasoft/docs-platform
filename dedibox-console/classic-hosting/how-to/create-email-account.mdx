...
meta:
  ...
  description: This page shows you how to create an email account on Khulnasoft Web Hosting Classic
content:
  h1: How to create an email account on Web Hosting Classic
  paragraph: This page shows you how to create an email account on Khulnasoft Web Hosting Classic
...
1. Click **Hosting**, then click **Manage**.
    <Lightbox src="khulnasoft_webhostingc_manage.webp" />
