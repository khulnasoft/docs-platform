...
1. Connect to your webhosting using your [FTP account](/dedibox-console/classic-hosting/concepts/#ftp-account). A listing of your remote files and folders displays in the right part of the FTP client:
    <Lightbox src="khulnasoft_subdomain_ftp.webp" width="" />
